...
def parse_to_module_def(module_def_txt: str) -> ModuleDef:
    try:
        ast, _ = verilog_parse([module_def_txt])
...
class FirstModuleDef:
    ...
    def create_module_inst_code(self) -> str:
        ...
        # print(get_module_parameters(def_code))
        # print("module_name:", def_code.name)
        # # print("module_parameter:", def_code.paramlist)
        # print("module_port:", get_module_ports(def_code))
        # ss = show(def_code.paramlist)
        # print(ss)
        ...
        codegen = ASTCodeGenerator()
        rslt = codegen.visit(self.portlist)
        # print(rslt)
