###########################################
#   Copyright (C) 2024 Alessandro Languasco (University of Padua)
#	developed for a joint work with Sherenaz Al-Haj Baddar (The University of Jordan) and M. Migliardi (University of Padua)
###########################################
...
###########################################
#   MAIN PROCEDURE
#	runs an experiment with a datasets described by their parameters
