...
class DDIMDLDataset(BaseDataset):
    def __init__(self, embedding_dict, ner_def, chemical_property_columns=['enzyme',
                                                   'target',
                                                   'pathway',
                                                   'smile'],
                 embedding_columns=[],
        ...
        super().__init__(embedding_dict,ner_def, chemical_property_columns, embedding_columns,
                         ner_columns, **kwargs)
