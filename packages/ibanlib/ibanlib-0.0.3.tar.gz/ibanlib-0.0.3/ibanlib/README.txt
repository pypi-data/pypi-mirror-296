...
These attributes are automatically checked, wrong values lead to an IBANError
 ...
 Traceback (most recent call last):
 ibanlib.iban.IBANError: Invalid value "123ABC" for account
 >>> a.account = '12234234234234324234'       # Too long
 Traceback (most recent call last):
 ibanlib.iban.IBANError: Invalid value "12234234234234324234" for account
...
If attributes are missing, no IBAN can be retrieved
 ...
 >>> IntAccount('AT').iban
 Traceback (most recent call last):
 ibanlib.iban.IBANError: Attribute bank is missing, no IBAN can be created
...
If the given IBAN is invalid, an error is raised:
 ...
 Traceback (most recent call last):
 ibanlib.iban.IBANError: IBAN has an invalid checksum
 
If the specified country for an IBAN is not known, an error is raised:

 >>> b=IntAccount(iban='XY141234500123456789')
 Traceback (most recent call last):
 ibanlib.iban.IBANError: Invalid IBAN: Country XY not implemented
 >>> IntAccount('ZX')
 Traceback (most recent call last):
 ibanlib.iban.IBANError: Invalid IBAN: Country ZX not implemented
 >>> b=IntAccount(iban='12141234500123456789')
 Traceback (most recent call last):
 ibanlib.iban.IBANError: Invalid IBAN: Invalid Country ISO Code (must be letters)
...
Andorra
 ...
 >>> ib = IntAccount(country='AD', bank='0001', branche='2030', 
 ...                 account='200359100100', check1=None, check2=None, 
 ...                 check3=None)
 >>> ib.iban
...
Hungary
 ...
 >>> ib = IntAccount(country='HU', bank='117', branche='7301', 
 ...                 account='111110180000000', check1=None, check2='6', 
 ...                 check3='0')
 >>> ib.iban
