...
if "egg_info" in sys.argv:
    ...
    print("@ egg_info @ ",is_package_installed( Var.name ) )
    if  is_package_installed( Var.name ):
        os.system(f"pip uninstall {Var.name} -y")
        print("@ egg_info @ ",is_package_installed( Var.name ) )
    ############################################################################# 
...
#
# 對外連結
# netstat -aon  | findstr  LISTENING | findstr  "TCP    0.0.0.0:"
...
# ========================= ======== ================ =========== ============
# python.exe                   15820 Console                    1     30,324 K



#############
## win-port:49664
# lsass.exe                     1304 Services                   0     24,996 K
## win-port:49665
# TCP    0.0.0.0:49665          0.0.0.0:0              LISTENING       1192
# wininit.exe 

## spoolsv.exe
# TCP    0.0.0.0:49672          0.0.0.0:0              LISTENING       6556
## services.exe
# TCP    0.0.0.0:49674          0.0.0.0:0              LISTENING       1268
###############
##############


#### 刪除 TCP    0.0.0.0:49667          0.0.0.0:0              LISTENING       4488
