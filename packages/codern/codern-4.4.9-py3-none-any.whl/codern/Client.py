...
class Tamasha:
    ...
    def _request_url(self):
        import random
        return f"https://shrubino{random.randint(1,2)}.iranlms.ir/"
    def get_link(self):
        return self._request_url()
    def _reuests_post(self,methode:str,data:dict):
        request = urllib3.PoolManager()
    ...
    def get_Profile_Highlights(self,target_profile_id:str,profile_id:str = None):
        return self._reuests_post(
            methode="getProfileHighlights",
            data={'target_profile_id': target_profile_id, 'profile_id': profile_id}
        )
    ...
    def set_block_page(
        ...
        return self._reuests_post(
            methode="setBlockProfile",
            data={'blocked_id': profile_id, 'action': "Block"}
        )
    def un_block_page(
        self,
        profile_id:str
        ...
        return self._reuests_post(
            methode="setBlockProfile",
            data={'blocked_id': profile_id, 'action': "Unblock"}
        )
    def get_page(self,profile_id):
        return self._reuests_post(
            methode="getProfileInfo",
    ...
    def get_posts_page(
        ...
        return self._reuests_post(
            methode="getProfileInfo",
            data={'limit': limit, 'sort': "FromMax", 'target_profile_id': profile_id}
        )
    def save_post(
            self,
            profile_id:str,
        ...
        return self._reuests_post(
            methode="postBookmarkAction",
            data={"post_id":post_id,"post_profile_id":profile_id,"action_type":"Bookmark"}
        )
    def un_save_post(
            self,
            profile_id:str,
        ...
        return self._reuests_post(
            methode="postBookmarkAction",
            data={"post_id":post_id,"post_profile_id":profile_id,"action_type":"Unbookmark"}
        )
    def like_post(
            self,
            post_id:str,
        ...
        return self._reuests_post(
            methode="likePostAction",
            data={"post_id":post_id,"post_profile_id":profile_id,"action_type":"Like"}
        )
    def un_like_post(
            self,
            post_id:str,
        ...
        return self._reuests_post(
            methode="likePostAction",
            data={"post_id":post_id,"post_profile_id":profile_id,"action_type":"Unlike"}
        )
    def get_comments_post(
        ...
        return self._reuests_post(
            methode="getComments",
            data={"profile_id":profile_id,"post_id":post_id,"post_profile_id":post_profile_id,"limit":limit,"sort":"FromMin","min_id":min_id}
        )
    def add_comment(self,
        ...
        return self._reuests_post(
            methode="addComment",
            data={"content":text,"post_id":post_id,"post_profile_id":post_profile_id,"profile_id":profile_id}
        )
    def follow(self,target_profile_id,profile_id:str=None):
        return self._reuests_post(
            methode='requestFollow',
            data={"followee_id":target_profile_id,"f_type":"Follow","profile_id":profile_id}
        )
    def un_follow(self,target_profile_id,profile_id:str=None):
        return self._reuests_post(
            methode='requestFollow',
            data={"followee_id":target_profile_id,"f_type":"Unfollow","profile_id":profile_id}
        )
    def search(self,text,limit:int=20,profile_id=None):
        return self._reuests_post(
            methode='searchProfile',
            data={"username":text,"limit":limit,"profile_id":profile_id}
        )
    def get_New_Events(self,profile_id,limit:int=20,max_id:str=None):
        return self._reuests_post(
            methode='getNewEvents',
            data={"profile_id":profile_id,"limit":limit,"sort":"FromMax","max_id":max_id}
        )
    
    def get_post(self,post_id,post_profile_id,profile_id:str=None,start_id=None):
        return self._reuests_post(
            data={"profile_id":profile_id,"post_id":post_id,"post_profile_id":post_profile_id,"start_id":start_id,"limit":5},
