...
class H2OEngineServiceApi(object):
    ...
    def h2_o_engine_service_delete_h2_o_engine(
        ...
        **kwargs
        ...
        >>> thread = api.h2_o_engine_service_delete_h2_o_engine(name_2, async_req=True)
        >>> result = thread.get()

        Args:
            name_2 (str): H2OEngine resource name. Format: workspaces/{workspace}/h2oEngines/{h2o_engine}
    ...
    def h2_o_engine_service_get_h2_o_engine(
        ...
        **kwargs
        ...
        >>> thread = api.h2_o_engine_service_get_h2_o_engine(name_8, async_req=True)
        >>> result = thread.get()

        Args:
            name_8 (str): H2OEngine resource name. Format: workspaces/{workspace}/h2oEngines/{h2o_engine}
    ...
    def h2_o_engine_service_terminate_h2_o_engine(
        ...
        **kwargs
        ...
        Args:
            name (str): H2OEngine resource name.
            body (bool, date, datetime, dict, float, int, list, str, none_type):
