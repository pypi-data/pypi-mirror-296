...
class EIPBaseClient:
    ...
    def update_assembly_info(self, connection_dict):
        ...
        try:
            ...
            print("No Configuration assembly instance provided")
    ...
    def list_identity(self):
        ...
        client.settimeout(5)
        client.sendto(send_data, ("<broadcast>", 44818))
        while True:
    ...
    def _shutdown_udp_server(self):
        try:
            ...
            print(f"Error closing UDP server socket: {e}")
