...
class ConnectionConfig(
    ...
    `To aggregate native Databrick arrays, UDAFs (User Defined Aggregation Functions) provided by ActiveViam must be registered on the cluster <https://docs.activeviam.com/products/atoti/server/6.1-next/docs/directquery/databases/databricks/#vectors-support>`__.
