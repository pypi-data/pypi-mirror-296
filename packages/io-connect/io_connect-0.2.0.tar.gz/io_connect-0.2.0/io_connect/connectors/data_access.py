...
class DataAccess:
    ...
    def consumption(
        ...
        - start_time (Union[str, int, datetime, np.int64], optional): Start time of the data retrieval period.
        - end_time (Union[str, int, datetime, np.int64], optional): End time of the data retrieval period.
