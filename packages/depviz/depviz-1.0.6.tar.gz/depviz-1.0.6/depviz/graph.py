from depviz.parsers.bazel_parser import parse_bazel_dependencies
...
class DependencyGraph:
    ...
    def find_internal_packages(self):
        ...
        for dirpath, dirnames, filenames in os.walk(self.packages_dir):
            if "BUILD" in filenames or any(file.endswith(".bzl") for file in filenames):
    ...
    def collect_bazel_dependencies(self):
        ...
        for service_name in os.listdir(self.services_dir):
            ...
            if os.path.isdir(service_path):
                ...
                # Parse both BUILD and .bzl files in the service path
                deps = parse_bazel_dependencies(service_path)
