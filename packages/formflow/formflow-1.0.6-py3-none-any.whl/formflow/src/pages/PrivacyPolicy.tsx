const PrivacyPolicy = () => {
    return (
        <>
            ...
            <p>Welcome to FormFlow (“we,” “our,” “us”). We are committed to protecting your
            ...
            protect any information that you provide when you use our form service.</p>
            <h3>2. Information We Collect</h3>
            <p>When your website visitors use the form service, they may submit various types
            of information depending on the fields you have included in the form. This
            information can include, but is not limited to:</p>
            <ul>
            <li>Name</li>
            <li>Email Address</li>
            <li>Message Content</li>
            <li>Attachments (e.g., documents, images, or other files)</li>
            <li>Any other fields you have configured on your form</li>
            </ul>
            <p>Please note that the specific data collected will vary based on how you
            customize your form.</p>
            <h3>3. How We Use the Information</h3>
            <p>The information collected through the form on your website is used solely to
            ...
            is deleted and is not stored on our servers.</p>
            <h3>4. Data Security</h3>
            <p>We take data security seriously. While the information is in our possession
            ...
            <p>We do not share, sell, or rent your website visitors’ personal information to
            ...
            <p>As a user of our service, it is your responsibility to ensure that your website
            ...
            to ensure transparency.</p>
            <h3>7. Contact Us</h3>
            <p>If you have any questions or concerns about this Privacy Policy or our
            practices, please contact us at contact@formflow.org.</p>
        </>
    );
};
