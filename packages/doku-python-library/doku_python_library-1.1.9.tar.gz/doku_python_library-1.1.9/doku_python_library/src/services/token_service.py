...
class TokenService:
    ...
    @staticmethod
    def compare_signature(public_key: str = None, client_id: str = None, x_timestamp: str = None) -> bool:
        # return request_signature == new_signature
        data = f"{client_id}|{x_timestamp}".encode('utf-8')
        public_key = load_pem_public_key(public_key.encode('utf-8'))
        decoded_signature = base64.b64decode(data)
