# Making a new release of bresourcemanager
...
Configure the following secrets in the [GitHub repository](https://github.com/b-scheduler/bresourcemanager/settings/secrets/actions/new):
