from yta_multimedia.video.edition.effect.moviepy.position_effects.utils import get_movement_factor, calculate_coord
...
def linear_movement(t, initial_position: tuple, final_position: tuple, duration: float):
    """
