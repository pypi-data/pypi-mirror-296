...
"""
def linear_movement(t, initial_position: tuple, final_position: tuple, duration: float, fps: int = 60):
    """
    ...
    """
    # TODO: Do checkings
    progress = __get_current_movement_progress_new(t, duration, fps)
...
def sinusoidal_movement(t, initial_position: tuple, final_position: tuple, duration):
    """
    Returns the (x, y) position tuple for the moviepy '.set_position()' method,
    ...
    """
    # TODO: Do checkings
    progress = __get_current_movement_progress(t, duration)
...
def wave_movement(t, initial_position: tuple, final_position: tuple, duration):
    """
...
def arc_movement(t, initial_position: tuple, final_position: tuple, duration, arc_is_bottom = False, max_height: int = 300):
    """
    Returns the (x, y) position tuple for the moviepy '.set_position()'
    method, for each 't' provided, that will make the element go to the
...
def __get_current_movement_progress(t, duration: float):
    """
    Returns the current movement progress measured by the division
    't / duration', that is the progress of the movement animation
    at the moment.
    """
    # TODO: Do checkings
    return t / duration

def __get_current_movement_progress_new(t, duration: float, fps: int = 60):
