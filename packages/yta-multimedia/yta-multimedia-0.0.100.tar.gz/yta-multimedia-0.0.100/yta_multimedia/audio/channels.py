from yta_general_utils.file_processor import file_is_audio_file, filename_is_type, FileType, replace_file_extension, get_file_extension
...
# TODO: Verify and move to a utils
...
# TODO: Remove this that is working with numpy, we have pydub and pan method
def isolate_channel(audio, channel: AudioChannel = AudioChannel.LEFT, output_filename: Union[str, None] = None):
    ...
    if output_filename:
        ...
        new_audio_segment.export(out_f = output_filename, format = get_file_extension(output_filename))
