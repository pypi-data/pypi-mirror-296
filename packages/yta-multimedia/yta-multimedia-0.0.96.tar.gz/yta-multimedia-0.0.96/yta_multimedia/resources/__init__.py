...
from yta_general_utils.file_processor import get_project_abspath, file_exists
from yta_general_utils.tmp_processor import create_tmp_filename
from yta_general_utils.file_processor import create_file_abspath
...
def get_resource(google_drive_url: str, output_filename: str = None):
    ...
    output_abspath = create_tmp_filename('tmp_resource.mp3')
    ...
    return download_file_from_google_drive(google_drive_url, output_abspath)