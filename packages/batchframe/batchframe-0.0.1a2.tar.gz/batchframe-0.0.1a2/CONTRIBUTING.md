...
Welcome to `batchframe` contributor's guide.
...
If you experience bugs or general issues with `batchframe`, please have a look
...
You can help improve `batchframe` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`batchframe` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `batchframe`'s files. While this mechanism can
...
```
conda create -n batchframe python=3 six virtualenv pytest pytest-cov
conda activate batchframe
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/batchframe.git
   cd batchframe
   ```
...
5. Install [pre-commit]:
   ...
   `batchframe` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/batchframe
[issue tracker]: https://github.com/<USERNAME>/batchframe/issues
