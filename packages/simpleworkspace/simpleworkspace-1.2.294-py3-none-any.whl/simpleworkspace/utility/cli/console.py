...
class UIComponents:
    class View(_abc.ABC):
        def __init__(self, parent:'UIComponents.View'=None):
            self.name = self.__class__.__name__
            '''The title displayed in namespaces and parent menus'''
            self.views:list[UIComponents.View] = []
        ...
        def InitView(self):
            ...
            choices:dict[str, UIComponents.View] = {}
            if not self.views:
                return True
            i = 1
    ...
    class SettingsView(View):
        def __init__(self, settingsManager: _SettingsManager_BasicConfig, parent:'UIComponents.View'=None):
            class AddNewSettingView(UIComponents.View):
                def __init__(self, parent: UIComponents.View = None):
            ...
            class RemoveASettingView(UIComponents.View):
                def __init__(self, parent: UIComponents.View = None):
                    super().__init__(parent)
            ...
            class ChangeASettingView(UIComponents.View):
                def __init__(self, settingName:str, parent: UIComponents.View = None):
                    super().__init__(parent)
            ...
            class ChangeView(UIComponents.View):
                def __init__(self, parent: UIComponents.View = None):
                    super().__init__(parent)
                    self.name = "Change"
                    self.RefreshViews()
            ...
            class ResetSettingsAction(UIComponents.View):
                def __init__(self, parent: UIComponents.View = None):
                    super().__init__(parent)
                    self.name = "Reset"
                def Start(self):
            ...
            class SaveSettingsAction(UIComponents.View):
                def __init__(self, parent: UIComponents.View = None):
                    super().__init__(parent)
                    self.name = 'Save'
            ...
            self.view_header = self.settingsManager._settingsPath
            self.views = [
