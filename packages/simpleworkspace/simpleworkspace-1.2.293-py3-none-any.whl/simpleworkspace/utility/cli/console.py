...
class ConsoleApp:
    ...
    class SettingsView(View):
        def __init__(self, settingsManager: _SettingsManager_BasicConfig, parent:'ConsoleApp.View'=None):
            ...
            class ChangeASettingView(ConsoleApp.View):
                def __init__(self, settingName:str, parent: ConsoleApp.View = None):
                    super().__init__(parent)
