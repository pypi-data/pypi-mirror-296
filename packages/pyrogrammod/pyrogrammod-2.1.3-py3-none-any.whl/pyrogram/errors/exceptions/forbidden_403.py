...
class ChatSendAudiosForbidden(Forbidden):
    """You cannot send audio messages in this chat"""
...
class ChatSendDocsForbidden(Forbidden):
    """You cannot send document messages in this chat"""
...
class ChatSendMediaForbidden(Forbidden):
    """You cannot send media messages in this chat"""
...
class ChatSendPhotosForbidden(Forbidden):
    """You cannot send photos in this chat"""
...
class ChatSendPlainForbidden(Forbidden):
    """You cannot send text messages in this chat"""
...
class ChatSendVideosForbidden(Forbidden):
    """You cannot send videos in this chat"""
