...
class ThreatInsightSettings(
    ...
    def __init__(
        ...
        *,
        ...
        :param action: Specifies how Okta responds to authentication requests from suspicious IPs. Valid values are ``none``, ``audit``, or ``block``. A value of ``none`` indicates that ThreatInsight is disabled. A value of ``audit`` indicates that Okta logs suspicious requests in the System Log. A value of ``block`` indicates that Okta logs suspicious requests in the System Log and blocks the requests. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/threat_insight_settings#action ThreatInsightSettings#action}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ThreatInsightSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/threat_insight_settings#import import section} in the documentation of this resource for the id to use
