...
Refer to the Terraform Registry for docs: [`okta_user_admin_roles`](https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/user_admin_roles).
'''
...
class UserAdminRoles(
    ...
    def __init__(
        ...
        *,
        ...
        :param admin_roles: The list of Okta user admin roles, e.g. ``['APP_ADMIN', 'USER_ADMIN']`` See `API Docs <https://developer.okta.com/docs/reference/api/roles/#role-types>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/user_admin_roles#admin_roles UserAdminRoles#admin_roles}
        :param user_id: ID of a Okta User. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/user_admin_roles#user_id UserAdminRoles#user_id}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing UserAdminRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/user_admin_roles#import import section} in the documentation of this resource for the id to use
