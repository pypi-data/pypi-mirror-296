...
Refer to the Terraform Registry for docs: [`okta_security_notification_emails`](https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/security_notification_emails).
'''
...
class SecurityNotificationEmails(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SecurityNotificationEmails that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.11.0/docs/resources/security_notification_emails#import import section} in the documentation of this resource for the id to use
