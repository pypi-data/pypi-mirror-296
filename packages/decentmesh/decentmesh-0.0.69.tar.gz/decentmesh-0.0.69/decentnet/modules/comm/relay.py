...
class Relay:
    ...
    def relay_request(self, request, t: Timer):
        ...
        skip_verify = self.skip_verification if self.check_if_verification_skippable() else False
        verified, data, verified_csig = Packager.unpack(request, skip_verify)
        ...
        asyncio.to_thread(asyncio.run, self.update_beacon_connection(beacon_pub_key))
