...
`extensions.synthetic_data.make_partially_linear_dataset_simple(n_obs=1000, n_confounders=5, dim_heterogeneity=2, binary_treatment=True, seed=None)`
...
| `n_confounders`     | int         | The number of confounders $\mathbf{X_i}$.                                    | `5`       |
| `dim_heterogeneity` | int         | The dimension of the heterogeneity $x_0$ or $(x_0,x_1)$. Can only be 1 or 2. | `2`       |
| `binary_treatment`  | bool        | Whether the treatment $d_i$ is binary or continuous.                         | `True`    |
...
| Type             | Description                                                                                                                                    |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| pandas.DataFrame | The generated dataset where y is the outcome, d is the treatment, and X are the confounders with a 1d or 2d subset utilized for heterogeneity. |
