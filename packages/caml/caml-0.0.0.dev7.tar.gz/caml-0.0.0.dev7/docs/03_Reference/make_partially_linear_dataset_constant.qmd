...
| Type             | Description                                                                                  |
|------------------|----------------------------------------------------------------------------------------------|
| pandas.DataFrame | The generated dataset where y is the outcome, d is the treatment, and W are the confounders. |
| numpy.ndarray    | The true conditional average treatment effects, which are all equal to the ATE here.         |
