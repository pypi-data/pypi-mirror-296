...
MAVEN_REPOSITORY = os.environ.get('MAVEN_REPOSITORY', 'https://search.maven.org')
DIRECT_DOWNLOAD = os.environ.get('DIRECT_DOWNLOAD', '')
...
if __name__ == '__main__':
    ...
    setup(
        name=PACKAGE_NAME + "_securingsam",
