...
extern "C" {
    ...
    #pragma omp declare variant (MKL_SPBLAS_VARIANT_NAME(set_sm_hint)) match(construct={dispatch}, device={arch(gen)}) \
        ...
        //adjust_args(nothing)
#endif
    #pragma omp declare variant (MKL_SPBLAS_VARIANT_NAME(set_sm_hint)) match(construct={target variant dispatch}, device={arch(gen)})
    ...
    #pragma omp declare variant (MKL_SPBLAS_VARIANT_NAME(s_trsm)) match(construct={dispatch}, device={arch(gen)}) \
        ...
        adjust_args(need_device_ptr:x, y)
#endif
    #pragma omp declare variant (MKL_SPBLAS_VARIANT_NAME(s_trsm)) match(construct={target variant dispatch}, device={arch(gen)})
    ...
    #pragma omp declare variant (MKL_SPBLAS_VARIANT_NAME(d_trsm)) match(construct={dispatch}, device={arch(gen)}) \
        ...
        adjust_args(need_device_ptr:x, y)
#endif
    #pragma omp declare variant (MKL_SPBLAS_VARIANT_NAME(d_trsm)) match(construct={target variant dispatch}, device={arch(gen)})
