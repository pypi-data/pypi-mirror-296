...
class Medialoopster:
    ...
    def get_videoasset_sequences(self, asset_id) -> List[Sequence]:
        ...
        return [Sequence.model_validate(sequence) for sequence in response.json()]
    ...
    def get_videoasset_shots(self, asset_id) -> List[Shot]:
        ...
        return [Shot.model_validate(shot) for shot in response.json()]
    ...
    def archiv_asset(self, content_type_id, asset_id, archive_type, archive_connector):
        url = f"{self.url}archiveactivities/"
    ...
    def productions(self) -> List[Production]:
        ...
        return [Production.model_validate(production) for production in response.json()]
