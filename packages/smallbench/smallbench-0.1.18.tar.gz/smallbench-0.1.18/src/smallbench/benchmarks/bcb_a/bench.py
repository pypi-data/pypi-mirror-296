...
"""
    ...
    async def score_agent_async(
    ...
    ) -> Tuple[float, float, List[Type[Agent]]]:
        ...
        successes = [s for s, d, _ in successes_with_dollars]
        dollars = sum([d for s, d, _ in successes_with_dollars])
        agents = [a for _, _, a in successes_with_dollars]
        return sum(successes) / len(successes), dollars, agents
    ...
    def score_agent_sync(
        ...
        successes = [s for s, d, a in successes_with_dollars]
        dollars = sum([d for s, d, a in successes_with_dollars])
        agents = [a for _, _, a in successes_with_dollars]
        return sum(successes) / len(successes), dollars, agents
