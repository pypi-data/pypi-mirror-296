...
from apropos import CostMonitor
...
class GuidedSimpleReActLanguageAgent(Agent):
    ...
    def __init__(self, plan: str, lm: LLM, contexts: List[Dict], multi_threaded: bool = False):
        self.lm = lm
...
# Plan
## Plan Guidance
You have been assigned the following plan. It must be followed exactly, with no exceptions - if the correct application of the plan is unclear in any given situation, use your best judgement to act in the spirit of the plan / to enable downstream steps in the plan to be taken.
