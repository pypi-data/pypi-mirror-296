...
class delta:
    ...
    def query_delta_to_spark_dataframe(self, query: str):
        return self.app.sql(query)
    ...
    def el_delta(self, query: str, location: str = '', table_full_name: str = '', mode = 'append' , chunk_size: int = 0):
        t1 = time()
        print('Reading the data ...')
        try:
            df = self.query_delta_to_spark_dataframe(query)
        except:
