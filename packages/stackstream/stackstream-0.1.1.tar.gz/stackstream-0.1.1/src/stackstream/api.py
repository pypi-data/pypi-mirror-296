...
def hoist_branch() -> None:
    branch_name = get_current_branch()
    
    creation_commit = get_creation_commit(branch_name=branch_name)
    ...
    rebase_onto(f'origin/{trunk_name}', creation_commit)
    print(f"Hoisted branch {branch_name} onto origin/{trunk_name}")
...
def propagate_commits(push: bool = False) -> None:
    current_branch = get_current_branch()
    ...
    if push:
        print("Pushing all rebased branches...")
