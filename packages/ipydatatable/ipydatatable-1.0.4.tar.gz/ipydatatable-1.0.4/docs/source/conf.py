...
# -*- coding: utf-8 -*-
#
# ipydatatable documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipydatatable', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipydatatabledoc'
...
latex_documents = [
    (master_doc, 'ipydatatable.tex', 'ipydatatable Documentation',
     'David Fernandez', 'manual'),
]
