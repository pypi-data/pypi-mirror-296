...
class data_generation:
    def __init__(self,
                 od_target_path=None,
                 ue_pathflows_path=None,
                 ue_linkflows_path=None,
                 link_target_path=None):

        # load input data
        od_target = pd.read_csv(od_target_path)
        ue_pathflows = pd.read_csv(ue_pathflows_path)
        ue_linkflows = pd.read_csv(ue_linkflows_path)
        link_target = pd.read_csv(link_target_path)
