...
VERSION = "0.0.4.7"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
# Dépendances
INSTALL_REQUIRES = ["torch==2.3.1", "sentence-transformers", "gpt4all", "sacremoses", "transformers", "sentencepiece", "ftfy", "optuna"]
