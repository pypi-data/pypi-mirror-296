...
class Robot_mailer:
    ...
    def _form_email(self):
        ...
        email_data = {
            "message": {
                ...
                "body": {
                    "contentType": "HTML",
                    "content": self._create_email_body(self.files_handled),
                },
                "toRecipients": [
    ...
    def _create_email_body(self, files_handled: list = None):
        ...
        file_list = self._create_file_list(files_handled) if files_handled else ""
    ...
    def send_report_email(
        self, recipients, process_name, status: int | Status, files_handled=None
    ) -> None:
        """
