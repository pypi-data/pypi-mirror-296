...
class Job(BaseModel):
    ...
    def prepare_start(self, resolve_access_rights: bool = True, cache_remote_files: bool = True, set_credentials: bool = True):
        ...
        if cache_remote_files:
            self.io.set_cache_root(str(self.temp_path))
    ...
    def complete(self, tmp_package_path=None, package_path=None, output_args=''):
        ...
        if package_path is None:
            ...
            artifact_path = AnyPath(package_path).relative_to(self.job_dir)
            assert ".." not in str(artifact_path), "Illegal package path. It should be an artifact of the model"
            complete_url_args = quote(str(artifact_path))
