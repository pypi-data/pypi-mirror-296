...
process_and_project_data <- function(output_prefix, ref_file) {
  ...
  SaveH5Seurat(query_projected, file.path(output_prefix, "query_projected.h5seurat"), assay="integrated")
  Convert(file.path(output_prefix, "query_projected.h5seurat"), dest = "h5ad")
