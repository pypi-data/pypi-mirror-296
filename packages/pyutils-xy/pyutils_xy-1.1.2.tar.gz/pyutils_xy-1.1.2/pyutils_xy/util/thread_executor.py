...
from pyutils_xy.util.set import Set, HashSet
...
class ThreadExecutor:
    ...
    def __init__(self, executor_count: int = 0, timeout=2, task_queue_capacity: int = 10):
    ...
    class __Executor(Thread):
        ...
        def __init__(self, task: callable, task_queue: Queue[callable], lock: ReentryLock, executors: Set[Thread]):
            super().__init__()
            self.__task = task
