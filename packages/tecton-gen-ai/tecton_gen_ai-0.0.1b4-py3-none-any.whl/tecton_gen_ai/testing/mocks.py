...
from .._utils import get_mock_source_attrs, set_mock_source_attrs, set_serialization
...
def mock_source(
    ...
    **source_kwargs: Any,
    ...
    set_mock_source_attrs(src, mock_params)
    return src
...
def mock_batch_feature_view(
    ...
    **fv_kwargs: Any,
    ...
    timestamp_field = get_mock_source_attrs(source)["timestamp_field"]
    start = get_mock_source_attrs(source)["start_time"]
