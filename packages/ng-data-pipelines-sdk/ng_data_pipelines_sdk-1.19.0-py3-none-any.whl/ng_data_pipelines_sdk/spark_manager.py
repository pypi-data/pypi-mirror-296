...
class SparkManager:
    ...
    def read(
        ...
        if file_type_str == FileType.JSON:
            file_type_str = "s3selectJSON"
        elif file_type_str == FileType.CSV:
            file_type_str = "s3selectCSV"

        reader = self.spark.read.format(file_type_str)
        if schema:
