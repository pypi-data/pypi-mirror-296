...
class XDG:
    ...
    def __init__(self):
        ...
        self._base_dir = pathlib.Path("~").expanduser()
    ...
    def XDG_DATA_HOME(self):
        ...
        """
        return os.getenv("XDG_DATA_HOME", xdgenvpy._defaults.XDG_DATA_HOME())
    ...
    def XDG_CONFIG_HOME(self):
        ...
        """
        return os.getenv("XDG_CONFIG_HOME", xdgenvpy._defaults.XDG_CONFIG_HOME())
    ...
    def XDG_CACHE_HOME(self):
        ...
        """
        return os.getenv("XDG_CACHE_HOME", xdgenvpy._defaults.XDG_CACHE_HOME())
    ...
    def XDG_RUNTIME_DIR(self):
        ...
        """
        return os.getenv("XDG_RUNTIME_DIR", xdgenvpy._defaults.XDG_RUNTIME_DIR())
    ...
    def XDG_DATA_DIRS(self):
        ...
        """
        data_home = os.getenv("XDG_DATA_HOME", xdgenvpy._defaults.XDG_DATA_HOME())
        data_dirs = os.getenv("XDG_DATA_DIRS", xdgenvpy._defaults.XDG_DATA_DIRS())
        return data_home + xdgenvpy._defaults.system_path_separator() + data_dirs
    ...
    def XDG_CONFIG_DIRS(self):
        ...
        """
        config_home = os.getenv("XDG_CONFIG_HOME", xdgenvpy._defaults.XDG_CONFIG_HOME())
        config_dirs = os.getenv("XDG_CONFIG_DIRS", xdgenvpy._defaults.XDG_CONFIG_DIRS())
        return config_home + xdgenvpy._defaults.system_path_separator() + config_dirs
...
class XDGPackage(XDG):
    ...
    def XDG_DATA_HOME(self):
        ...
        return pathlib.Path().joinpath(base, self._package_name)
