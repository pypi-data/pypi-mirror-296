...
class SymFuncBase( ABC ):
  ...
  def __init__( self ):
    ...
    # self._complexvalue = False # support _funcionToComplexValue()
  ...
  # @property
  # def complexValueConvert(self):
  #   """
  #   Support conversie to complex values
  #   """
  ...
  # @abstractmethod
  # def getValue( self, elem, dDict = None ):
  #   return None
  ...
  # def funcionToComplexValue( self, elem ):
  #  # pylint: disable=unused-argument
  #  """
  #  Convert a given function into a complex value
  #  Return None if it cannot convert
  #  """
  #  return None
  ...
  def _getValueMultiple( self, listOrValue, listOrValue2 = None ):
    # get value from multie elements
    ...
    # if isinstance( listOrValue, list ):
    #  dValue = []
    #  # for iCnt in range( 0, len( listOrValue )):
    #  # for iCnt in enumerate( listOrValue ):
    #  for iCnt, dVal1 in enumerate( listOrValue ):
    #    if listOrValue2 != None :
    #      # TO DO dit klopt niet, list1 en list2 lopen niet synchroon
    #      if isinstance( listOrValue2, list ):
    #        dHelp = self._getValueSingle( dVal1, listOrValue2[ iCnt ] )
    #        dValue.append( dHelp )
    #      else:
    #        dHelp = self._getValueSingle( dVal1, listOrValue2 )
    #        dValue.append( dHelp )
    #    else:
    #      dValue.append( self._getValueSingle( dVal1 ))
    # else:
    #  if listOrValue2 != None :
    #    dValue = self._getValueSingle( listOrValue, listOrValue2 )
    #  else:
    #    dValue = self._getValueSingle( listOrValue )
  ...
  def getValue( self, elemFunc, dDict = None ):
    ...
    if numElem > 2:
      raise NameError( 'function {elemFunc.name} more as 2 parameters no autmatic supported at the moment' )
