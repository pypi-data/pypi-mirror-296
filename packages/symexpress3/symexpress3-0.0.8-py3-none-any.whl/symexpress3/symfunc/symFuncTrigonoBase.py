...
class SymFuncTrigonoBase( symFuncBase.SymFuncBase ):
  ...
  def _getSinCos( self, cType, iCounter, iDenominator ):
    ...
    def _createSinCosHalf( iDenom ):
      ...
      # it always in  first quater, no sign needed
      ...
      # this give recussion
      # oFormulaSin.optimizeSpecial()
      # oFormulaCos.optimizeSpecial()
    ...
    # othernumber will give complex radicals
    baseNumber = 1
    ...
    # baseFormula = getBaseFormula( cType, iCounter, baseNumber )
    if baseFormula == None:
      iCount //= 2
      while baseFormula == None and iCount <= iCounter:
        # add one
