...
"""
    ...
    This is a python only implemenation. Not that fast but it is python only
...
import sympy   # use it for prime factorisation and divisors
...
#
# factor all positive numbers
# give back dictioanry  { number: count }
def FactorizationDict(n):
  """
  Factorization given number, give dictionary back ( nummer: count )
  """
...
# Give back a dictotionary { number: count }
#
def factorint(n):  # pylint: disable=invalid-name
  """
  Factorization of given number, give a dictorionary back ( number: count )
