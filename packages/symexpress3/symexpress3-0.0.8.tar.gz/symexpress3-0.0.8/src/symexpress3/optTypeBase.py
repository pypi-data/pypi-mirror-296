...
"""
    Abstract class for optimze type` implementation symexpress3
...
class OptTypeBase( ABC ):
  ...
  def __init__( self ):
    ...
    self._symtype      = None  # symexpress type class, example symexpress3.SymNumber, symexpress3.SymVariable, symexpress3.SymFunction
  ...
  def optimize( self, elem, action ):
    """
    Optimization method, give the optimze elem back, do not change the elem
    """
    return None
