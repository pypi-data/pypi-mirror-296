...
class OptSymFunctionNumberToDivisors( optFunctionBase.OptFunctionBase ):
  """
  Convert a given number into all his divisors as an add serie
  """
  def __init__( self ):
    super().__init__()
    self._name         = "numberToDivisors"
    self._desc         = "Convert a given number to all his divisors as an add serie"
  ...
  def optimize( self, elem, action ):
    ...
    # if elemParam.power != 1 and elemParam.power != -1:
