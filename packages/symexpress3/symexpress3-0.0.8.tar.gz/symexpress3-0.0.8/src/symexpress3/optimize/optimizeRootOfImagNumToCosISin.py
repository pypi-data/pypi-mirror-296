...
class OptimizeRootOfImagNumToCosISin( optimizeBase.OptimizeBase ):
  ...
  def optimize( self, symExpr, action ):
    ...
    # print( "Start optimzeRootOfImageNumToCosISin" )
    ...
    if symExpr.symType == '*':
      ...
      for elemplus in symExpr.elements:
        ...
        if isinstance( elemplus, symexpress3.SymVariable ):
          # if elemplus.name == 'e' or elemplus.name == 'pi':
    ...
    # no imag part then nothing to do
    # if len( symImag ) == 0:
    #   # TO DO check of negative number, yes -> it's a imag number
    #   return result
