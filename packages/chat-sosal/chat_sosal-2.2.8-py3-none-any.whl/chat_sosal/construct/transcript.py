...
from chat_sosal.construct.attachment_handler import AttachmentHandler
from chat_sosal.ext.discord_import import discord

from chat_sosal.construct.message import gather_messages
from chat_sosal.construct.assets.component import Component

from chat_sosal.ext.cache import clear_cache
from chat_sosal.parse.mention import pass_bot
from chat_sosal.ext.discord_utils import DiscordUtils
from chat_sosal.ext.html_generator import (
...
class TranscriptDAO:
    ...
    def __init__(
        ...
        self.pytz_timezone = pytz_timezone or "Europe/Moscow"
    ...
    async def export_transcript(self, message_html: str, meta_data: str):
        ...
        sd = (
            ...
            '    <a href="https://ko-fi.com/mahtoid"></a>'
            '</div>'
