...
class Command(BaseCommand):
    ...
    def handle(self, options: argparse.Namespace) -> None:
        ...
        # Asegurarte de que app/app.zip exista
        ...
        # Descomprimir el archivo app.zip en el directorio app
        app_dir = self.flutter_dir.joinpath("app", "app")
        with zipfile.ZipFile(app_zip_path, 'r') as zip_ref:
            zip_ref.extractall(app_dir)

        print(f"Descomprimido {app_zip_path} en {app_dir}")
        ...
        # Copiar los resultados del build a `out_dir`
        print(f"Copying build to [cyan]{rel_out_dir}[/cyan] directory...", end="")
        ...
        # Si el objetivo es "web", copiar el contenido de `assets` al directorio de salida
