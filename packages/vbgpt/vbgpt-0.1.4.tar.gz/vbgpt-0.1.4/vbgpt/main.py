...
@click.option(
    ...
    default=1,
    cls=ChoiceOption,
    choices=click.Choice(['o1-mini', 'o1-preview', 'gpt-4o', 'gpt-4o-mini', 'gpt-4-turbo', 'gpt-4-turbo-preview', 'gpt-4-1106-preview',
                          'gpt-4-vision-preview']),
    prompt=True,
    show_default=True,
    help='Model to use'
)
def main(question, read, extension, post, q_symbol, q_color, a_symbol, a_color, bgcolor, rendering, minted_code, language, minted_style, model):
    question = question
    answer = get_ans_gpt(question, model)
