...
setup(
    ...
    install_requires=['nbconvert==7.16.4', 'attrs>=22.2.0', 'click==8.1.7', 'uvicorn', 'fastapi', 'pandas==2.1.1', 'packaging', 'requests', 'nbformat', 'mkdocs==1.6.0', 'pyyaml', 'stdlib-list', 'numpy==1.26.0', 'pip_audit==2.7.3'],
