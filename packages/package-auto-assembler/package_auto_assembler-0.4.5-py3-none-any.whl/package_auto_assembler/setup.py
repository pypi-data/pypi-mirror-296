...
setup(
    ...
    install_requires=['pandas==2.1.1', 'nbformat', 'numpy==1.26.0', 'mkdocs==1.6.0', 'stdlib-list', 'click==8.1.7', 'nbconvert==7.16.4', 'pyyaml', 'pip_audit==2.7.3', 'nbconvert', 'requests', 'packaging', 'attrs>=22.2.0'],
