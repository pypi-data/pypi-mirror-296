...
setup(
    ...
    install_requires=['pyyaml', 'mkdocs==1.6.0', 'packaging', 'numpy==1.26.0', 'fastapi', 'attrs>=22.2.0', 'pandas==2.1.1', 'click==8.1.7', 'requests', 'stdlib-list', 'pip_audit==2.7.3', 'nbformat', 'uvicorn', 'nbconvert==7.16.4'],
