...
class nameddestinations_NamedDestinationCollection(Assist.BaseJavaClass):
    ...
    java_class_name = "com.aspose.python.pdf.nameddestinations.NamedDestinationCollection"
