...
class FitBVExplicitDestination(Assist.BaseJavaClass):
    """!Represents explicit destination that displays the page with the horizontal coordinate left
     ...
     fit the entire height of its bounding box within the window. A null value for left specifies that
     the current value of that parameter is to be retained unchanged."""

    java_class_name = "com.aspose.python.pdf.FitBVExplicitDestination"
