...
class FitHExplicitDestination(Assist.BaseJavaClass):
    """!Represents explicit destination that displays the page with the vertical coordinate top
     ...
     fit the entire width of the page within the window. A null value for top specifies that the
     current value of that parameter is to be retained unchanged."""

    java_class_name = "com.aspose.python.pdf.FitHExplicitDestination"
