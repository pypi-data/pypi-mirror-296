...
from pycamps.modules.short_line import ShortLine
from pycamps.modules.long_line import LongLine
from pycamps.modules.sm_one_axis import SMOneAxis
from pycamps.modules.pq_load import PQLoad
...
class PowerSystem:
    ...
    Attributes:
        ...
        Refer to Module class for more information on the following attributes:
        StateVariableDerivatives (Matrix), StateSpaceEquations (Matrix), DesiredStateVariableDerivatives (Matrix),
        DesiredStateSpace (Matrix), ControllableInputs (Matrix), InternalInputs (Matrix), ControlInputEquations (Matrix),
        SetPointOutputs (Matrix), SetPointOutputEquations (Matrix), StateVariables (Matrix), DesiredStateVariables (Matrix),
        InternalEquations (Matrix), Parameters (Matrix), SetPoints (Matrix), ControllerGains (Matrix).
