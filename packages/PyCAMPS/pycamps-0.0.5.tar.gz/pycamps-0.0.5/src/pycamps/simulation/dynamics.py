...
class Dynamics:
    def __init__(self, power_system, params_directory=None, custom_module_files=None, params_dictionary=None):
        self.PS = power_system
        self.params = {}
        self.input_states = []
        self.input_equations = []
        self.module_to_params = self.get_required_parameters()
        self.load_new_params(params_directory, custom_module_files, params_dictionary)
