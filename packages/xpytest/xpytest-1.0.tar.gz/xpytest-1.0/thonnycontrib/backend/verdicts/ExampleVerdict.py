...
class ExampleVerdict(ABC):
    def __init__(self, filename:str, lineno:int, tested_line:str, expected_result:str, details:str=""):
        """
        This is an abstract type to describe an example verdict.
        Each verdict is described by its filename, line number, tested line, expected result and
        the some other details.

        All the subclasses should give an implementation of get_color(), isSuccess(), _verdict_message()
