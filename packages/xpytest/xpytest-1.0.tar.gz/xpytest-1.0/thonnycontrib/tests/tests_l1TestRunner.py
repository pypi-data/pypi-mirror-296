from thonnycontrib.frontend.gui.l1test_gui_runner import AbstractL1TestRunner
from thonnycontrib.frontend.gui.views.l1test_reporter import L1TestTreeView, L1TestErrorView
...
class TestTestRunner(ut.TestCase):
    ...
    def test_restart_backend_event_when_complete_restart(self, mock_get_workbench: MagicMock):
        self.__add_views()
        l1test_runner = AbstractL1TestRunner()
