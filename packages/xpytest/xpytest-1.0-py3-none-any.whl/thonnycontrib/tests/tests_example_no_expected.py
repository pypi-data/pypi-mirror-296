...
class TestEvaluator(ut.TestCase):
    ...
    le flag EMPTY. On assure aussi que le verdict associé à l'example est PassedSetupVerdict
    """
...
""" 
    ...
    un verdict `ExceptionTest` sera renvoyé. Le flag associé au l1doctest sera alors FAILED
    """
