...
class ChatManager {
  ...
  handleWsMessage(event, wsType) {
    ...
    if (wsType === "text") {
      ...
      } else if (parsedEvent.event === "attachment") {
      ...
      } else if (parsedEvent.event === "audio") {
      ...
      if (parsedEvent.event === "pong") {
        ...
        console.error(`Error from audio stream: ${parsedEvent.data.error}`);
      }
    }
  }
