...
class FilterIntent:
    ...
    def from_str(cls, value: str):
        ...
        return cls(field=field, condition=parse_filter_condition(condition))
...
class TimeRestriction:
    ...
    def from_str(cls, value: str):
        ...
        try:
            ...
            raise ValueError("Time restrictions need at least the time scale and age.")
        ...
        if age in ["latest", "last"]:
            age = RestrictionAge.LATEST
        elif age in ["oldest", "earliest"]:
        ...
        return cls(level, age, constraint)
...
class GrowthIntent:
    ...
    def from_str(cls, value: str):
        ...
        time, measure, *params = value.split(".")
        ...
        return cls(time=time, measure=measure, method=method)
