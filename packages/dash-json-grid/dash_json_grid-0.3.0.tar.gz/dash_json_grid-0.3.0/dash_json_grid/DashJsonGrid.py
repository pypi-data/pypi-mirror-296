...
- theme (dict; default 'default'):
    ...
    _type = 'DashJsonGrid'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, class_name=Component.UNDEFINED, data=Component.REQUIRED, default_expand_depth=Component.UNDEFINED, default_expand_key_tree=Component.UNDEFINED, selected_path=Component.UNDEFINED, highlight_selected=Component.UNDEFINED, search_text=Component.UNDEFINED, theme=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'class_name', 'data', 'default_expand_depth', 'default_expand_key_tree', 'highlight_selected', 'loading_state', 'search_text', 'selected_path', 'theme']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'class_name', 'data', 'default_expand_depth', 'default_expand_key_tree', 'highlight_selected', 'loading_state', 'search_text', 'selected_path', 'theme']
