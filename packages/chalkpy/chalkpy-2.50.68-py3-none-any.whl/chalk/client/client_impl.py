...
"""
    ...
    def _do_request_inner(
        ...
        *,
        ...
        if not env_var_bool("CHALK_SKIP_BRANCH_SERVER_STATUS_CHECK") and headers.get("X-Chalk-Branch-Id") and headers.get("X-Chalk-Env-Id") and self._api_server is not None:
