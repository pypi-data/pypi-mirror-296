...
def get_metadata(args : Union[argparse.Namespace,None] ) -> Metadata:
    ...
    if "CI_MERGE_REQUEST_ID" in os.environ:
        metadata.git_commit = os.environ.get("CI_COMMIT_SHA",UNKNOWN_METADATA.git_commit)
        metadata.git_branch = os.environ.get("CI_MERGE_REQUEST_SOURCE_BRANCH_NAME",UNKNOWN_METADATA.git_branch)
        metadata.default_git_branch = os.environ.get("CI_DEFAULT_BRANCH",UNKNOWN_METADATA.default_git_branch)
    ...
    if "CI_COMMIT_SHA" in os.environ:
        metadata.git_commit = os.environ.get("CI_COMMIT_SHA",UNKNOWN_METADATA.git_commit)
        metadata.git_branch = os.environ.get("CI_COMMIT_BRANCH",UNKNOWN_METADATA.git_branch)
    ...
    if "GITHUB_HEAD_REF" in os.environ:
        ...
        metadata.git_branch = os.environ.get("GITHUB_HEAD_REF",UNKNOWN_METADATA.git_branch)
    ...
    if "GITHUB_REF_NAME" in os.environ:
        metadata.git_commit = os.environ.get("GITHUB_SHA",UNKNOWN_METADATA.git_commit)
        metadata.git_branch = os.environ.get("GITHUB_REF_NAME",UNKNOWN_METADATA.git_branch)
        metadata.default_git_branch = "GitHub doenst expose the default branch via ENV"
        metadata.is_merge_request = False  
