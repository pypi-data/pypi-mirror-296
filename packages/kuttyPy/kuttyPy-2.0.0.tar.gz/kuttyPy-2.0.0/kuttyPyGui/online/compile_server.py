...
class FlaskThread(QThread):
	...
	def open_browser(self):
		if len(server_ip)>0:
			webbrowser.open(f"http://{server_ip}:5000/visual")  # Adjust the URL as needed
		else:
			webbrowser.open(f"http://localhost:5000/visual")  # Adjust the URL as needed
