...
def model_(data,
    ...
    filename2 = f"{p_name}_test_data_prediction.xlsx"
...
def optuna_(data,
    ...
    def objective(trial):
        ...
        n_estimators = trial.suggest_int("n_estimators", 75, 250, step=1)
...
def optim_(data,
    ...
    if param_search not in search_methods:
        error_message = "Please suggest a search parameter from the Optuna, Grid, and Predefined"
