...
from .utils import (hvf, select_from_rf, min_max, standardize_dataframe,
                    recursive_feature_elimination, seq_feat_sel,
...
def preprocessing(data,
    ...
    data_for_feature_selection = data
    ...
    def apply_(feature, df1, df2, fs_name):
        ...
        if feature == 'Suggested':
            selected_features = data.columns.values.ravel().tolist()
    ...
    if normalization == 'min_max':
        ...
        # Normalize data using min-max normalization between 0 and 1.
        sel_labeled_data4 = standardize_dataframe(df_labeled)
        sel_unlabeled_data4 = standardize_dataframe(df_unlabeled)
    ...
    sel_labeled_data4.to_csv(f'{result_path}{column_name}_{features}_{normalization}_labeled_data.csv')
