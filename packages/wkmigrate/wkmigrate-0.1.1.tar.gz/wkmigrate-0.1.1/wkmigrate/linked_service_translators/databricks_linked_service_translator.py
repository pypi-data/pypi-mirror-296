""" This module defines methods for translating Databricks compute from data pipelines."""
...
mapping = {
    ...
    'cluster_log_conf': {'key': 'new_cluster_log_definition', 'parser': parse_log_conf},
