...
class InstanceGroup(_message.Message):
    __slots__ = ["aws_instance_group", "capacity", "container_image", "environment_variables", "google_cloud_instance_group", "grpc_port", "health_check_config", "health_check_name", "host", "http_port", "name", "prometheus_port", "tags"]
