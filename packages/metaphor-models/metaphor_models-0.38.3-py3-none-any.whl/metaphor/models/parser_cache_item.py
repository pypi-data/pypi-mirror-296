...
class Species17884___ToStringTag8377(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_17884: Optional['SharedArrayBuffer'] = None
    to_string_tag_8377: Optional[Species17884___ToStringTag8377] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_17884 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@17884"))
        to_string_tag_8377 = from_union([Species17884___ToStringTag8377, from_none], obj.get("__@toStringTag@8377"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_17884, to_string_tag_8377, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_17884 is not None:
            result["__@species@17884"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_17884)
        if self.to_string_tag_8377 is not None:
            result["__@toStringTag@8377"] = from_union([lambda x: to_enum(Species17884___ToStringTag8377, x), from_none], self.to_string_tag_8377)
...
class ArrayBufferLike:
    to_string_tag_8377: Optional[str] = None
    byte_length: Optional[float] = None
    species_17884: Optional[SharedArrayBuffer] = None
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        assert isinstance(obj, dict)
        to_string_tag_8377 = from_union([from_str, from_none], obj.get("__@toStringTag@8377"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_17884 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@17884"))
        return ArrayBufferLike(to_string_tag_8377, byte_length, species_17884)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_8377 is not None:
            result["__@toStringTag@8377"] = from_union([from_str, from_none], self.to_string_tag_8377)
        if self.byte_length is not None:
            result["byteLength"] = from_union([to_float, from_none], self.byte_length)
        if self.species_17884 is not None:
            result["__@species@17884"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_17884)
...
class ID:
    ...
    to_string_tag_8377: Optional[IDToStringTag8377] = None
    ...
    def from_dict(obj: Any) -> 'ID':
        assert isinstance(obj, dict)
        to_string_tag_8377 = from_union([IDToStringTag8377, from_none], obj.get("__@toStringTag@8377"))
        ...
        return ID(to_string_tag_8377, buffer, byte_length, byte_offset, bytes_per_element, length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_8377 is not None:
            result["__@toStringTag@8377"] = from_union([lambda x: to_enum(IDToStringTag8377, x), from_none], self.to_string_tag_8377)
...
class MapStringString:
    ...
    def from_dict(obj: Any) -> 'MapStringString':
        ...
        to_string_tag_8377 = from_union([from_str, from_none], obj.get("__@toStringTag@8377"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_8377, size)
