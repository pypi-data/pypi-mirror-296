...
class DatazoneRunExecutionOperatorExtraLink(BaseOperatorLink):
...
class DatazoneRunExecutionOperator(BaseOperator):
    ...
    operator_extra_links = (DatazoneRunExecutionOperatorExtraLink(),)
    ...
    def execute(self, context: Context) -> Any:
        hook = DatazoneHook(self.method, datazone_conn_id=self.datazone_conn_id)
