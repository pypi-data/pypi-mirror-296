...
def config_views(config):
    ...
    for module in MoOGLi_MANDATORY_MODULES:
...
def config_services(config):
    ...
    settings = config.registry.settings
    for service_name, default, interface, contexts, params in MoOGLi_SERVICES:
    ...
    for service_name, default, interface, contexts in MoOGLi_SERVICE_FACTORIES:
