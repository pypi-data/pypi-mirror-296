...
def add_help_menu(result):
    ...
    if egg_name == "endi":
        result.add(HtmlAppMenuItem(html=MoOGLi_FORUM_LINK), "help")
        result.add(HtmlAppMenuItem(html=MoOGLi_DOC_LINK), "help")
