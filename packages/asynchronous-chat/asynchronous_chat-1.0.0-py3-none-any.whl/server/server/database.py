...
class ServerStorage:
    ...
    def __init__(self, path):
        ...
        # Создаём отображения
        mapp = registry()
        mapp.map_imperatively(self.AllUsers, users_table)
        mapp.map_imperatively(self.ActiveUsers, active_users_table)
        mapp.map_imperatively(self.LoginHistory, user_login_history)
        mapp.map_imperatively(self.UsersContacts, contacts)
        mapp.map_imperatively(self.UsersHistory, users_history_table)
