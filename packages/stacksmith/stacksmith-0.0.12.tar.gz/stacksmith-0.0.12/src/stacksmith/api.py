...
def hoist_stack(trunk_name: str) -> None:
    recursive_rebase(f"origin/{trunk_name}")
    print("Hoisted stack successfully")
    
def propagate_commits() -> None:
    recursive_rebase(get_current_branch())
    print("Propagated commits successfully")
