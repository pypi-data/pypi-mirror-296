...
from stacksmith.api import create_branch, hoist_branch, create_pr, propagate_commits

class TestApi(unittest.TestCase):

    @patch('stacksmith.api.get_current_branch')
    @patch('stacksmith.api.create_new_branch')
    @patch('stacksmith.api.create_empty_commit')
    ...
    @patch('stacksmith.api.get_current_branch')
    @patch('stacksmith.api.get_creation_commit')
    @patch('stacksmith.api.rebase_onto')
    ...
    @patch('stacksmith.api.get_current_branch')
    @patch('stacksmith.api.get_creation_commit')
    @patch('stacksmith.api.get_commit_message')
    @patch('stacksmith.api.update_remote_refs')
    @patch('stacksmith.api.does_remote_branch_exist')
    @patch('stacksmith.api.get_trunk_name')
    @patch('stacksmith.api.get_pr_output')
    @patch('stacksmith.api.run_command')
    ...
    @patch('stacksmith.api.get_current_branch')
    @patch('stacksmith.api.build_branch_structure')
    @patch('stacksmith.api.rebase_and_update_refs')
    @patch('stacksmith.api.does_remote_branch_exist')
    @patch('stacksmith.api.push_with_lease')
    @patch('stacksmith.api.push_and_set_upstream')
