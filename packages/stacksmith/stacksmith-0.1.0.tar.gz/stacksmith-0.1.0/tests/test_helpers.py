...
class TestHelpers(unittest.TestCase):
    ...
    @patch('stacksmith.helpers.run_command')
    ...
    @patch('stacksmith.helpers.get_commit_with_message')
    ...
    @patch('stacksmith.helpers.get_trunk_name')
    @patch('stacksmith.helpers.get_local_branches')
    @patch('stacksmith.helpers.get_merged_branches')
    @patch('stacksmith.helpers.get_creation_commit')
    @patch('stacksmith.helpers.get_commit_message')
