...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int = 0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.9.0 fwBuild=30/07/2024-12:43:40 fwHash=0x80063CC5 fwDirty=0 kmodVersion=0.9.1 kmodBuild=12/09/2024-14:05:21 kmodHash=0x642F5389 kmodDirty=0 swVersion=0.9.1 swBuild=12/09/2024-14:05:21 swHash=0x642F5389 swDirty=0 cfgManVersion=0.3.0 cfgManBuild=12/09/2024-14:05:21 cfgManHash=0x642F5389 cfgManDirty=0"
            if build != build_ref:
