...
package_name = os.environ.get('MOSAIC_PACKAGE_NAME', 'zgl-streaming')

if package_name != 'zgl-streaming':
    print(f'Building zgl-streaming as {package_name}')
...
setup(
    ...
    url='https://github.com/0glabs/zgl-streaming',
