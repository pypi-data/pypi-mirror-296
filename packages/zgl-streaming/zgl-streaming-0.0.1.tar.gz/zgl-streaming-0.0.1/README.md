<br />
<p align="center">
    <a href="https://github.com/0glabs/zgl-streaming#gh-light-mode-only" class="only-light">
    ...
    <a href="https://github.com/0glabs/zgl-streaming#gh-dark-mode-only" class="only-dark">
...
<p align="center">
    <a href="https://pypi.org/project/zgl-streaming/">
        <img alt="PyPi Version" src="https://img.shields.io/pypi/pyversions/zgl-streaming">
    </a>
    <a href="https://pypi.org/project/zgl-streaming/">
        <img alt="PyPi Package Version" src="https://img.shields.io/pypi/v/zgl-streaming">
    </a>
    <a href="https://github.com/0glabs/zgl-streaming/actions?query=workflow%3ATest">
        <img alt="Unit test" src="https://github.com/0glabs/zgl-streaming/actions/workflows/pytest.yaml/badge.svg">
    </a>
    <a href="https://pepy.tech/project/zgl-streaming/">
        <img alt="PyPi Downloads" src="https://static.pepy.tech/personalized-badge/zgl-streaming?period=month&units=international_system&left_color=grey&right_color=blue&left_text=Downloads/month">
    </a>
    ...
    <a href="https://github.com/0glabs/zgl-streaming/blob/main/LICENSE">
...
We also have starter code for the following popular datasets, which can be found in the `streaming` [directory](https://github.com/0glabs/zgl-streaming/tree/main/streaming):

| Dataset | Task | Read | Write |
| --- | --- | --- | --- |
| LAION-400M | Text and image | [Read](https://github.com/mosaicml/diffusion-benchmark/blob/main/data.py) | [Write](https://github.com/0glabs/zgl-streaming/tree/main/streaming/multimodal/convert/laion/laion400m) |
| WebVid | Text and video | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/multimodal/webvid.py) | [Write](https://github.com/0glabs/zgl-streaming/blob/main/streaming/multimodal/convert/webvid.py) |
| C4 | Text | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/text/c4.py) | [Write](https://github.com/0glabs/zgl-streaming/blob/main/streaming/text/convert/c4.py) |
| EnWiki | Text | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/text/enwiki.py) | [Write](https://github.com/0glabs/zgl-streaming/tree/main/streaming/text/convert/enwiki) |
| Pile | Text | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/text/pile.py) | [Write](https://github.com/0glabs/zgl-streaming/blob/main/streaming/text/convert/pile.py)
| ADE20K | Image segmentation | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/ade20k.py) | [Write](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/convert/ade20k.py)
| CIFAR10 | Image classification | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/cifar10.py) | [Write](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/convert/cifar10.py) |
| COCO | Image classification | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/coco.py) | [Write](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/convert/coco.py) |
| ImageNet | Image classification | [Read](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/imagenet.py) | [Write](https://github.com/0glabs/zgl-streaming/blob/main/streaming/vision/convert/imagenet.py) |
...
To start contributing, see our [Contributing](https://github.com/0glabs/zgl-streaming/blob/main/CONTRIBUTING.md) page.
