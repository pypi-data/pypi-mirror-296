...
class PreparePayOnchainRequest:
    amount: "PayOnchainAmount";sat_per_vbyte: "typing.Optional[int]";

    @typing.no_type_check
    def __init__(self, amount: "PayOnchainAmount", sat_per_vbyte: "typing.Optional[int]" = _DEFAULT):
        self.amount = amount
    ...
    def __str__(self):
        return "PreparePayOnchainRequest(amount={}, sat_per_vbyte={})".format(self.amount, self.sat_per_vbyte)
