        ...
        with tracer.start_as_current_span("QuestionTestCase.run") as span:
            ...
            try:
                ...
                return TestCaseOutcome(
                    ...
                    costs=ModelCosts(
                        input_tokens=engineered_test_prompt.completion.input_tokens,
                        output_tokens=engineered_test_prompt.completion.output_tokens,
                        costs=engineered_test_prompt.completion.cost,
                    ),
                    input_sample=self.input_sample,
                    messages=self.messages,
                )
