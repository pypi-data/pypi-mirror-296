...
### Dabarqus Service
**Important**: This SDK requires [Dabarqus](https://dabarqus.com/) to be installed and running on your machine.
Before using this SDK, please ensure that you have:

- Downloaded and installed [Dabarqus](https://dabarqus.com/)
