...
async def handle_mem_pack(bot, chat_id, tid, lz, username, title, desc, photo, IMGFLIP_UN, IMGFLIP_PS, PROJECT_USERNAME, MEDIA_D, EXTRA_D, mem_type):
    file_photo = None
    try:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            async with aiofiles.open(file_photo, 'wb') as file:
                await file.write(img_content)
        await create_neuro_pack(bot, chat_id, lz, tid, username, title, desc, file_photo, IMGFLIP_UN, IMGFLIP_PS, PROJECT_USERNAME, MEDIA_D, EXTRA_D, mem_type)
