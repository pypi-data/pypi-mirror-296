...
async def handle_mem_pack(bot, chat_id, tid, lz, username, title, desc, file_photo, IMGFLIP_UN, IMGFLIP_PS, PROJECT_USERNAME, MEDIA_D, EXTRA_D, BASE_D, mem_type):
    try:
        print(f"{file_photo=}")
        print(f"{os.path.exists(file_photo)=}")
