...
results.summary(rf_df=rf_df, rf="rf", show_t=True, show_stars=True, layout="default", raw_ret=False, pct_sign=True,
               alpha_models=[ff3], output_path="Single_out_true_strategy_excess_alpha_pct.docx")
...
#                alpha_models=[ff3], output_path="double_strategy_for_strategy_reverse_no_pct.docx")