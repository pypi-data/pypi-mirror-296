...
class LayerNextClient:
    ...
    def query_documents_with_structure(
        ...
        document_element_dict = self.find_elements(
            unique_name_list=unique_names, original_question=original_question, user_question=user_question, chat_id=chat_id
        )
    ...
    def find_elements(
        ...
        response = _datalake_client.find_elements_from_docs(
            unique_name_list, original_question, user_question, is_target_documents_available, chat_id
        )
