...
class Auth:
    ...
    def __init__(self,
        ...
        match self.auth_type:
            ...
            case "3":
                self.basic_auth()
            case "4":
                utils.check_connection(url=auth_url, endpoint=auth_endpoint)
    ...
    def login_pass_auth(self):
        ...
        try:
            response = requests.post(self.auth_url, headers=utils.default_headers, json=auth_creds, verify=False)
