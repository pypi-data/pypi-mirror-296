...
if __name__ == "__main__":
    ...
    LOGSHEET_ID = "1mXwqEiG2LKngwFaIb6AepGNUbUSmYngjYnh1nzl3iLU"

    ## Instantiate the logger
    sheet_logger = SheetLogger(LOGSHEET_ID, SCOPES, subfolder="auth", token_file_name="token.json")

    ## Example usage with dynamic tabs
    ERROR_LOGS = "Logs"
    EXECUTION_LOGS = "Execution_logs"
    OTHER_LOGS = "test"

    sheet_logger.write_to_sheet(ERROR_LOGS, "This message will be written to Logs sheet.")
    time.sleep(1)
    sheet_logger.write_to_sheet(ERROR_LOGS, "This message will be written to Logs sheet2.")
    time.sleep(1)
    sheet_logger.write_to_sheet(ERROR_LOGS, "This message will be written to Logs sheet3.")
    sheet_logger.write_to_sheet(ERROR_LOGS, "This message will be written to Logs sheet4.")
    time.sleep(1)
    sheet_logger.write_to_sheet(ERROR_LOGS, "This message will be written to Logs sheet5.")

    sheet_logger.write_to_sheet(EXECUTION_LOGS, "This message will be written to Execution_logs sheet.")
    sheet_logger.write_to_sheet(OTHER_LOGS, "This message will be written to a new tab called Other_logs.")