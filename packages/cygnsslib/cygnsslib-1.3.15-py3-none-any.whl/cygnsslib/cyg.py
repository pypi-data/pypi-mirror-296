        ...
        if out_flag != 2:
            for flag in lvl_1_flags:
                if flag in flag_msg:
                    ...
                    break
    return out_flag
def check_cyg_quality_flags(qf1, qf2, snr, sp_rx_gain, inc_angle_deg, pekel_sp_water_flag, pekel_sp_water_percentage_5km):
    ...
    land_q1_bits = [2, 4, 5, 6, 8, 9, 15, 16, 17, 22, 23, 25, 26, 27, 29, 30, 31]
