...
def place_bets(
    ...
    Parameters:
        list_matches : List[Tuple[Dict[str, Any], Dict[str, Any]]] : List of matches with their corresponding odds
            Example: [{'id': 1595460299, 'starts': '2024-08-23T18:45:00Z', 'home': 'Paris Saint-Germain', 'away': 'Montpellier HSC', 'league': 2036, 'line_id': 2650184231, 'odds': {'home': 1.309, 'draw': 6.14, 'away': 8.47}, 'prediction': 1, 'amount': 5}}, ...]
    ...
    for match in list_matches:
        try : 
            ...
            if is_already_bet(bet, match):
                ...
                continue
            # Place the bet depending on the "prediction" parameter
