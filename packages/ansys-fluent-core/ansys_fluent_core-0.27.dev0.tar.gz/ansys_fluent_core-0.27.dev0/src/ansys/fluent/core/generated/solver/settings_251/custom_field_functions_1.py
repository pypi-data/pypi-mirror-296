...
class custom_field_functions(NamedObject[custom_field_functions_child], _NonCreatableNamedObjectMixin[custom_field_functions_child]):
    """
    ...
    command_names = \
        ['delete', 'rename', 'list', 'list_properties', 'make_a_copy', 'save',
         'load']
