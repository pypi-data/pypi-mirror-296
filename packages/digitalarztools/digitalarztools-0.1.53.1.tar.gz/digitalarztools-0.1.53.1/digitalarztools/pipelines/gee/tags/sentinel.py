...
class GEESentinelData:
    ...
    @staticmethod
    def get_sentinel1_image_collection(region: GEERegion, tag: GEESentinelTag) -> GEEImageCollection:
        return GEEImageCollection(ee.ImageCollection(tag.value)
    ...
    def get_latest_dates(cls, dataset_tag: GEESentinelTag , region: GEERegion, delta_in_days=10 ) -> (
        ...
        if dataset_tag is None:
            ...
            ee_img_coll = cls.get_sentinel1_image_collection(region, dataset_tag )
    ...
    def sentinel1_water_mask(region: GEERegion, date_range: tuple, water_masked_s2=None):
        ...
        if water_masked_s2 is not None:
            ...
            s1_water_threshold = -16  # Adjust threshold for Pakistan conditions
        # print("")
        # s1_water_threshold = -10
