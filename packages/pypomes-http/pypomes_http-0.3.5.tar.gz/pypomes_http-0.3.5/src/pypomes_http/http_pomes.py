    ...
    try:
        ...
        if jwt_data:
            ...
            if jwt_data.pop("scheme", None) == "bearer":
                ...
                # request token to a registered or to a foreign issuer (defaults to registered)
                if jwt_data.pop("is_foreign", False):
                    # token issuer is foreign
