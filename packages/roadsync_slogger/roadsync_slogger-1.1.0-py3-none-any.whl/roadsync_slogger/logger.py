...
class SLogger:
    ...
    def log(self, level: str, msg: str, **extra_fields):
        """
        ...
        if self.config.format == "json":
            log_message = self._format_as_json(level, current_time, msg, log_context)
            self.config.log_std(log_message) if level != "ERROR" else self.config.log_err(log_message)
        else:
            log_message = self._format_as_plain(level, current_time, msg, log_context)
            self.config.log_std(log_message) if level != "ERROR" else self.config.log_err(log_message)
    ...
    def warning(self, msg: str, **extra_fields):
        ...
        Args:
            ...
            **extra_fields: Additional context to include in the log entry.
        """
        self.log("WARNING", msg, **extra_fields)
    ...
    def error(self, msg: str, **extra_fields):
        ...
        Args:
            ...
            **extra_fields: Additional context to include in the log entry.
        """
        self.log("ERROR", msg, **extra_fields)
    ...
    def critical(self, msg: str, **extra_fields):
        ...
        Args:
            ...
            **extra_fields: Additional context to include in the log entry.
        """
        self.log("CRITICAL", msg, **extra_fields)
