...
# source: iamanager/v3/iamanagercommon.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='iamanager/v3/iamanagercommon.proto',
  package='iamanager.v3',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\"iamanager/v3/iamanagercommon.proto\x12\x0ciamanager.v3\"\x82\x01\n\x0bPermissions\x12?\n\x0bpermissions\x18\x01 \x03(\x0b\x32*.iamanager.v3.Permissions.PermissionsEntry\x1a\x32\n\x10PermissionsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t:\x02\x38\x01\"\x16\n\x05Users\x12\r\n\x05users\x18\x01 \x03(\tb\x06proto3'
)
...
_PERMISSIONS_PERMISSIONSENTRY = _descriptor.Descriptor(
  ...
  full_name='iamanager.v3.Permissions.PermissionsEntry',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='iamanager.v3.Permissions.PermissionsEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='iamanager.v3.Permissions.PermissionsEntry.value', index=1,
...
_PERMISSIONS = _descriptor.Descriptor(
  name='Permissions',
  full_name='iamanager.v3.Permissions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='permissions', full_name='iamanager.v3.Permissions.permissions', index=0,
...
_USERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='users', full_name='iamanager.v3.Users.users', index=0,
...
Permissions = _reflection.GeneratedProtocolMessageType('Permissions', (_message.Message,), {
  ...
  'PermissionsEntry' : _reflection.GeneratedProtocolMessageType('PermissionsEntry', (_message.Message,), {
    ...
    '__module__' : 'iamanager.v3.iamanagercommon_pb2'
    # @@protoc_insertion_point(class_scope:iamanager.v3.Permissions.PermissionsEntry)
    })
  ,
  'DESCRIPTOR' : _PERMISSIONS,
  '__module__' : 'iamanager.v3.iamanagercommon_pb2'
  # @@protoc_insertion_point(class_scope:iamanager.v3.Permissions)
  })
...
Users = _reflection.GeneratedProtocolMessageType('Users', (_message.Message,), {
  'DESCRIPTOR' : _USERS,
  '__module__' : 'iamanager.v3.iamanagercommon_pb2'
  # @@protoc_insertion_point(class_scope:iamanager.v3.Users)
  })
