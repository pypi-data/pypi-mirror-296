...
class TransfersFeeMetadataTypedDict(TypedDict):
...
class TransfersFeeMetadata(BaseModel):
    r"""Additional metadata relating to the transfer state. Included data depends on the state, e.g.:
    - Rejection reasons are included when the `state` is `REJECTED`
    - Reason and comment are included when `state` is `CANCELED`
    """
...
class TransfersFeeStateTypedDict(TypedDict):
    ...
    metadata: NotRequired[Nullable[TransfersFeeMetadataTypedDict]]
    r"""Additional metadata relating to the transfer state. Included data depends on the state, e.g.:
    - Rejection reasons are included when the `state` is `REJECTED`
    - Reason and comment are included when `state` is `CANCELED`
    """
...
class TransfersFeeState(BaseModel):
    ...
    r"""Additional description of the transfer state."""
    metadata: OptionalNullable[TransfersFeeMetadata] = UNSET
    r"""Additional metadata relating to the transfer state. Included data depends on the state, e.g.:
    - Rejection reasons are included when the `state` is `REJECTED`
    - Reason and comment are included when `state` is `CANCELED`
    """
