...
class AchDepositMetadataTypedDict(TypedDict):
...
class AchDepositMetadata(BaseModel):
    r"""Additional metadata relating to the transfer state. Included data depends on the state, e.g.:
    - Rejection reasons are included when the `state` is `REJECTED`
    - Reason and comment are included when `state` is `CANCELED`
    """
...
class AchDepositStateTypedDict(TypedDict):
    ...
    metadata: NotRequired[Nullable[AchDepositMetadataTypedDict]]
    r"""Additional metadata relating to the transfer state. Included data depends on the state, e.g.:
    - Rejection reasons are included when the `state` is `REJECTED`
    - Reason and comment are included when `state` is `CANCELED`
    """
...
class AchDepositState(BaseModel):
    ...
    r"""Additional description of the transfer state."""
    metadata: OptionalNullable[AchDepositMetadata] = UNSET
    r"""Additional metadata relating to the transfer state. Included data depends on the state, e.g.:
    - Rejection reasons are included when the `state` is `REJECTED`
    - Reason and comment are included when `state` is `CANCELED`
    """
