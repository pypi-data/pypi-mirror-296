...
class BasePIUnitTest(TestCase):
    ...
    def assertPrint(self, test_func: Callable, prints: SupportsIndex,
    ...
    def assertInput(self, test_func: Callable, inputs: SupportsIndex,
                   all_: bool = False, *args, **kwargs) -> None:
        """
    ...
    def assertPrintInput(self, test_func: Callable,
