...
from app.schemes.basic_type_hints import BaseSchemaType
from app.lib_service_transport.services.rabbit.base_queue_agent import BaseQueueAgent
...
class BasePublisherRabbit(BaseQueueAgent):
    ...
    @abstractmethod
    def publish_message(self, **kwargs: str | int | BaseSchemaType) -> Any:
