...
#this is if even a single node has gone up by at least 1% over the total number of epochs to switch.
...
pEpochsToSwitch = 10  #and to do gf.these
#pPatience = 1
capAtN = False #Makes sure subsequent rounds last max as long as first round
