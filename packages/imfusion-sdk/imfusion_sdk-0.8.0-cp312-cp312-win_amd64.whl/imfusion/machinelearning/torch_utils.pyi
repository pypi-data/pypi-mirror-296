...
__all__ = ['DataElement', 'imfusion', 'ml', 'to_torch']
def __SIS_from_torch(cls: type, tensor: torch.Tensor, get_metadata_from: typing.Optional[imfusion._bindings.SharedImageSet] = None) -> imfusion._bindings.SharedImageSet:
    ...
    """
def to_torch(self: typing.Union[imfusion._bindings.machinelearning.DataElement, imfusion._bindings.SharedImageSet, imfusion._bindings.SharedImage], device: torch.device = None, dtype: torch.dtype = None, same_as: torch.Tensor = None) -> torch.Tensor:
    """
