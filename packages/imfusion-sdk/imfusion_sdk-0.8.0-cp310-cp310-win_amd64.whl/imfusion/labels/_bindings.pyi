...
import numpy
import typing
__all__ = ['BoundingBox', 'BoundingBoxAccessor', 'BoundingBoxLayer', 'BoundingBoxLayersAccessor', 'BoxSet', 'DataType', 'Descriptor', 'Label', 'LabelMapLayer', 'LabelMapsAccessor', 'LabelsAccessor', 'Landmark', 'LandmarkLayer', 'LandmarkLayersAccessor', 'LandmarkSet', 'LandmarksAccessor', 'LockToken', 'Project', 'Tag', 'TagKind', 'TagsAccessor']
class BoundingBox:
...
class LockToken:
    """
    				...
    				Only the holder of the token can modify the layers of a locked DataDescriptor.
    				Locking is only supported in remote projects. Local projects ignore the locking mechanism.
    				A LockToken can be acquired through meth:`~imfusion.label.DataDescriptor.lock`.
