...
class ImageClassificationModel(Enum):
    ...
    clip_vit_base_patch32 = "https://image-class-openai-clip-vit.ai-sandbox.ch"
    # vissl = ""
    # classy_vision = ""
    # resnet50_1 = ""
    # efficientnet_b1 = ""
...
class TextClassifyModel(Enum):
    ...
    bart_large_mnli = "https://text-classification.livelysmoke-9b213881.switzerlandnorth.azurecontainerapps.io"
    # bart = ""
    # disbart_mnli_12_1 = ""
    # mnli_yahoo = ""
    # distilbert_base = ""
...
class TextComparisonModel(Enum):
    ...
    AllMiniLM = "https://text-comparison-minilm.calmflower-186525cd.switzerlandnorth.azurecontainerapps.io"
