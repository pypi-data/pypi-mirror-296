...
class UmlPackageElements(BaseModel):    
...
class UmlPackage(UmlNamedElement):
    elements: UmlPackageElements = Field(default_factory=UmlPackageElements)


class UmlModelElements(UmlElements):
...
class UmlModel(UmlNamedElement):
    elements: UmlModelElements = Field(default_factory=UmlModelElements)
    diagrams: UmlDiagrams = Field(default_factory=UmlDiagrams)
