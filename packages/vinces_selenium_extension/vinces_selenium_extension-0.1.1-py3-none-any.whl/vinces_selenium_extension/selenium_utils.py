...
class WaitUtils:
    ...
    def wait_for_element(
        ...
        Returns:
            Optional[WebElement]: The located WebElement if found, None otherwise.
        """
        locator = (by, value) if exact_match else (by, f"contains(@{value})")
        try:
    ...
    def wait_for_clickable(
        ...
        try:
            ...
            print(
                f"Clickable element with locator {by} and value '{value}' not found: {e}"
            )
            return None
...
class SeleniumUtils:
    ...
    def move_to_element(self, element: WebElement) -> None:
        ...
        if element.is_displayed():
            ...
            print("Element is not visible and cannot be moved to.")
