...
class KnowledgeBaseSpec(_message.Message):
    __slots__ = ("owner", "description", "refreshSchedule", "artifactBucketName", "labName", "resources", "metadataDatabaseConnectionName", "documentStoreConnectionName", "indexes", "documents", "maxConcurrentReaders", "nodeParsers", "defaultNodeParser")
    OWNER_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, owner: _Optional[str] = ..., description: _Optional[str] = ..., refreshSchedule: _Optional[_Union[_generated_pb2.RunSchedule, _Mapping]] = ..., artifactBucketName: _Optional[str] = ..., labName: _Optional[str] = ..., resources: _Optional[_Union[_generated_pb2.ResourceSpec, _Mapping]] = ..., metadataDatabaseConnectionName: _Optional[str] = ..., documentStoreConnectionName: _Optional[str] = ..., indexes: _Optional[_Iterable[_Union[IndexSpec, _Mapping]]] = ..., documents: _Optional[_Iterable[_Union[DocumentSpec, _Mapping]]] = ..., maxConcurrentReaders: _Optional[int] = ..., nodeParsers: _Optional[_Iterable[_Union[NodeParserSpec, _Mapping]]] = ..., defaultNodeParser: _Optional[str] = ...) -> None: ...
