...
from ultralytics_trt import yolo  # noqa
from ultralytics_trt.nn.tasks import (
    ClassificationModel,
    DetectionModel,
    PoseModel,
    SegmentationModel,
...
from ultralytics_trt.yolo.engine.exporter import Exporter
...
from ultralytics_trt.yolo.utils.downloads import GITHUB_ASSET_STEMS
from ultralytics_trt.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[ultralytics_trt.yolo.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(ultralytics_trt.yolo.engine.results.Results): The prediction results.
    """
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        Returns:
            (List[ultralytics_trt.yolo.engine.results.Results]): The tracking results.
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_trt.yolo.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        try:
            from ultralytics_trt.yolo.utils.tuner import (
                ASHAScheduler,
                RunConfig,
                WandbLoggerCallback,
                default_space,
