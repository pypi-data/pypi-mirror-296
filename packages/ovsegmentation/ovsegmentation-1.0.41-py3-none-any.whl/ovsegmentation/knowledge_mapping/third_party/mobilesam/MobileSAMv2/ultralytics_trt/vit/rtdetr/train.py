...
from ultralytics_trt.nn.tasks import RTDETRDetectionModel
from ultralytics_trt.yolo.utils import DEFAULT_CFG, RANK, colorstr
from ultralytics_trt.yolo.v8.detect import DetectionTrainer
