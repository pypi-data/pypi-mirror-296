...
from efficientvit_module.apps.trainer import Trainer
from efficientvit_module.apps.utils import AverageMeter, sync_tensor
from efficientvit_module.clscore.trainer.utils import (
    accuracy,
    apply_mixup,
    label_smooth,
)
from efficientvit_module.models.utils import list_join, list_mean, torch_random_choices
