    ...
    try:
        ...
        try:
            ...
            if items:
                ...
                file_id = items[0]['id']
                console.print(f'Certificado {certificado_file} encontrado. Iniciando download...\n')
        ...
        async with async_playwright() as p:
            ...
            if not element_popup_certificate:
                ...
                async with page.expect_popup() as page1_info:
                    await page.get_by_role("link", name="Certificado Digital", exact=True).click()
                    await page.keyboard.press("Enter")
                
                page1 = await page1_info.value
                await page1.goto("https://dte.sefaz.go.gov.br/dte/web/https/painelControle.jsf")
