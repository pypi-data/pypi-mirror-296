...
async def check_and_execute_tasks():
    console.print(f"\nProcesso check_and_execute_tasks iniciado com PID: {os.getpid()}\n", style="yellow")
...
async def notify_alive():
    console.print(f"\nProcesso notify_alive iniciado com PID: {os.getpid()}\n", style="yellow")
...
def run_async_last_alive():
    console.print("0 - Chamando a func notify_alive")
