...
def construct_minimum_spanning_tree_on_terminals(terminals, node_coords, metric_closure, use_gpu):
    """
...
def approximate_steiner_minimal_tree(graph, distance_func, use_gpu):
    ...
    mst, node_coords, edges, conduit_types, required_flow_rates = construct_minimum_spanning_tree(graph, distance_func, use_gpu)
...
def construct_minimum_spanning_tree(graph, distance_func, use_gpu):
    ...
    mst = construct_minimum_spanning_tree_on_terminals(terminals, node_coords, metric_closure, use_gpu)

    return mst, nodes, edges, conduit_types, required_flow_rates
