...
class SentenceAligner:
    ...
    def visualize_alignment(self, list1, list2, plot_only_index=False):
        """
        ...
        plot_only_index : bool, optional
            If True, only plot indices instead of actual words on the axes (default is False).
