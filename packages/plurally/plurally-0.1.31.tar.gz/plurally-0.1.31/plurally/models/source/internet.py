...
class ScrapePagesDynamic(ScrapePageBase):
    ...
    class InitSchema(Node.InitSchema):
        """Scrape the content of multiple webpages. Each row in the input table should contain a URL and a selector. Columns should be named 'url' and 'selector'. The output will be a table with the content of the pages, with one column named 'content'."""
