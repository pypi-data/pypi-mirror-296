...
class InstagramSendDm(MetaAuth):
    ...
    def _send_message(self, page_access_token, node_input, message):
        url = f"https://graph.facebook.com/v12.0/me/messages?access_token={page_access_token}"
        data = {
            "recipient": {"user_id": node_input.recipient_id},
    ...
    def forward(self, node_input: "InputSchema"):
        ...
        while len(node_input.message) > 1000:
            message = node_input.message[:1000]
            node_input.message = node_input.message[1000:]
            self._send_message(page_access_token, node_input, message)
        self._send_message(page_access_token, node_input, node_input.message)
