...
if __name__ == "__main__":
    data = [
        {'object': 'instagram', 'entry': [{'time': 1725785006797, 'id': '17841448359242263', 'messaging': [{'sender': {'id': '473277262230299'}, 'recipient': {'id': '17841448359242263'}, 'timestamp': 1725785006609, 'message': {'mid': 'aWdfZAG1faXRlbToxOklHTWVzc2FnZAUlEOjE3ODQxNDQ4MzU5MjQyMjYzOjM0MDI4MjM2Njg0MTcxMDMwMTI0NDI3NjIwMzIxMjM4OTMwNjM4NzozMTc4NDYwNTk3OTA5NDkxNDQ3MTMyOTQ1MTgwODM5MTE2OAZDZD', 'is_deleted': True}}]}]},
    ...
    for obj in data:
        print(classify_instagram_event(obj))