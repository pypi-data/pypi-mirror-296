...
from pydenticore.authentication import AuthenticationOptions, AuthenticationScheme, AuthenticationSchemeBuilder
from pydenticore.authentication.interfaces import IAuthenticationDataProtector
