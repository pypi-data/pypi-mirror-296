...
G: Final[float] = 6.67384e-11
RSOL: Final[float] = 6.955e8
RJUP: Final[float] = 7.1492e7
RJUP_POL: Final[float] = 6.9911e7  # Polar Radius
REARTH: Final[float] = 6.371e6
PI: Final[float] = 3.14159265359
MSOL: Final[float] = 1.98847542e+30
MJUP: Final[float] = 1.898e27
MEARTH: Final[float] = 5.97e24
LSOL: Final[float] = 3.839e26
AU: Final[float] = 1.49597871e+11
KBOLTZ: Final[float] = 1.380648813e-23
RGP: Final[float] = 8.31446
PLANCK: Final[float] = 6.62606957e-34
C_LUM: Final[float] = 299792458
SIG_SB: Final[float] = 5.670367e-08
N_A: Final[float] = 6.022140857e+23
PARSEC: Final[float] = 3.08568e16
DAY: Final[float] = 86400.  # s
YEAR: Final[float] = 31557600.
tiny: Final[float] = 1.e-13
OneMintiny: Final[float] = 1. - tiny

ktable_long_name_attributes: Final[Mapping[str, str]] = {
        'p'                    : 'Pressure grid',
        't'                    : 'Temperature grid',
        ...
        'temperature_grid_type': 'Whether the temperature grid is "regular" (same temperatures for all pressures) or '
                                 '"pressure-dependent"',
...
nemesis_hitran_id_numbers: Final[Mapping[str, int]] = {
        'H2O'  : 1,
        'CO'   : 5,
        'CO2'  : 2,
        'O2'   : 7,
