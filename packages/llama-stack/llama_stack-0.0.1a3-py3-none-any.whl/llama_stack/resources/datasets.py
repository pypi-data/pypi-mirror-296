...
from ..types import dataset_get_params, dataset_create_params, dataset_delete_params
...
class DatasetsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        request: dataset_create_params.Request,
        ...
        return self._post(
            "/datasets/create",
            body=maybe_transform({"request": request}, dataset_create_params.DatasetCreateParams),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/datasets/create",
            body=await async_maybe_transform({"request": request}, dataset_create_params.DatasetCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
