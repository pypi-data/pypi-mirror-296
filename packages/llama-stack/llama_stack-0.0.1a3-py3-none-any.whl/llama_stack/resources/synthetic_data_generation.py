...
class SyntheticDataGenerationResource(SyncAPIResource):
    ...
    def generate(
        self,
        *,
        request: synthetic_data_generation_generate_params.Request,
        ...
        return self._post(
            ...
            body=maybe_transform(
                {"request": request}, synthetic_data_generation_generate_params.SyntheticDataGenerationGenerateParams
            ),
