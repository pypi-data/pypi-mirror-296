...
class QuestionAnsweringResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        request: question_answering_create_params.Request,
        ...
        return self._post(
            ...
            body=maybe_transform({"request": request}, question_answering_create_params.QuestionAnsweringCreateParams),
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"request": request}, question_answering_create_params.QuestionAnsweringCreateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
