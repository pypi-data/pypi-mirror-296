...
class SafetyResource(SyncAPIResource):
    ...
    def run_shields(
        self,
        *,
        request: safety_run_shields_params.Request,
        ...
        return self._post(
            "/safety/run_shields",
            body=maybe_transform({"request": request}, safety_run_shields_params.SafetyRunShieldsParams),
    ...
    async def run_shields(
        ...
        *,
        ...
        return await self._post(
            "/safety/run_shields",
            body=await async_maybe_transform({"request": request}, safety_run_shields_params.SafetyRunShieldsParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SafetyRunShieldsResponse,
