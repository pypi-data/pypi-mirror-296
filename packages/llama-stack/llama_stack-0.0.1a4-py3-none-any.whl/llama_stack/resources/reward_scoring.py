...
class RewardScoringResource(SyncAPIResource):
    ...
    def score(
        self,
        *,
        request: reward_scoring_score_params.Request,
        ...
        return self._post(
            ...
            body=maybe_transform({"request": request}, reward_scoring_score_params.RewardScoringScoreParams),
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"request": request}, reward_scoring_score_params.RewardScoringScoreParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
