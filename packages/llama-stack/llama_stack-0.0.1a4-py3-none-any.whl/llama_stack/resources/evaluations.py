...
class EvaluationsResource(SyncAPIResource):
    ...
    def summarization(
        self,
        *,
        request: evaluation_summarization_params.Request,
        ...
        return self._post(
            ...
            body=maybe_transform({"request": request}, evaluation_summarization_params.EvaluationSummarizationParams),
    ...
    def text_generation(
        self,
        *,
        request: evaluation_text_generation_params.Request,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(
                {"request": request}, evaluation_text_generation_params.EvaluationTextGenerationParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"request": request}, evaluation_summarization_params.EvaluationSummarizationParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
