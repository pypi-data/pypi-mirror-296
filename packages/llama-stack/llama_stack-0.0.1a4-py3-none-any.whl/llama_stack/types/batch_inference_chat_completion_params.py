...
__all__ = ["BatchInferenceChatCompletionParams", "Request", "RequestMessagesBatch", "RequestLogprobs", "RequestTool"]
...
RequestMessagesBatch: TypeAlias = Union[UserMessage, SystemMessage, ToolResponseMessage, CompletionMessage]
...
class Request(TypedDict, total=False):
    messages_batch: Required[Iterable[Iterable[RequestMessagesBatch]]]
