...
class FilesClient:
    ...
    def file_create(
        ...
        *,
        ...
        -------
        FileResource
            Result of file's resource Create or Update or Restore.

        Examples
        --------
        from truvity_sdk import FileCreate, TruvityApi
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(FileResource, parse_obj_as(type_=FileResource, object_=_response.json()))  # type: ignore
    ...
    def file_search(
        ...
        *,
        ...
        Parameters
        ----------
        filter : typing.Optional[typing.Sequence[FileFilter]]
            Filter for the files' resources.

        sort : typing.Optional[typing.Sequence[FileSort]]
        ...
        -------
        FileList
            Result of search of the files' resources.
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(FileList, parse_obj_as(type_=FileList, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
    ...
    def file_upload(
        ...
        -------
        UploadResponse
            Result to upload blob and create or update the file's resource.
    ...
    def file_update(
        ...
        *,
        ...
        blob_id : typing.Optional[BlobId]
            Take a look to documentation about #/components/schemas/BlobID.
    ...
    def file_restore(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"files/{jsonable_encoder(id)}/restore",
            method="POST",
            headers={
                "Idempotency-Key": str(idempotency_key) if idempotency_key is not None else None,
                "If-Match": str(if_match) if if_match is not None else None,
    ...
    def file_history(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"files/{jsonable_encoder(id)}/revisions",
            method="GET",
            headers={"If-None-Match": str(if_none_match) if if_none_match is not None else None},
            request_options=request_options,
        )
    ...
    def file_download(
        ...
        *,
        ...
        ------
        typing.Iterator[bytes]
            Download blob associated with the file's resource.
...
class AsyncFilesClient:
    ...
    async def file_create(
        ...
        *,
        ...
        from truvity_sdk import AsyncTruvityApi, FileCreate
