...
from ..types.presentation_credential_i_ds import PresentationCredentialIDs
...
from ..types.presentation_verify import PresentationVerify
...
class PresentationsClient:
    ...
    def presentation_export(
        ...
        *,
        ...
        holder: typing.Optional[Uri] = OMIT,
        ...
        ------
        typing.Iterator[bytes]
            Result of a PresentationExport.
        ...
        client.presentations.presentation_export(
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            method="POST",
            json={"credentials_ids": credentials_ids, "holder": holder, "composition_type": "EMBED"},
    ...
    def presentation_import(
        ...
        *,
        ...
        -------
        PresentationResource
            Result of presentation's resource Create or Update or Restore.
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PresentationResource, parse_obj_as(type_=PresentationResource, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
    ...
    def presentation_issue(
        ...
        *,
        ...
        client.presentations.presentation_issue(
            credentials_ids=["credentials_ids"],
            key_id="key_id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
    ...
    def presentation_search(
        ...
        *,
        ...
        Parameters
        ----------
        filter : typing.Optional[typing.Sequence[PresentationFilter]]
            Filter for the presentations' resources.

        sort : typing.Optional[typing.Sequence[PresentationSort]]
        ...
        -------
        PresentationList
            Result of search of the presentations' resources.
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PresentationList, parse_obj_as(type_=PresentationList, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
    ...
    def presentation_upload(
        ...
        -------
        UploadResponse
            Result to upload blob and create or update the presentation's resource.
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UploadResponse, parse_obj_as(type_=UploadResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
    ...
    def presentation_latest(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"presentations/{jsonable_encoder(id)}",
            method="GET",
    ...
    def presentation_restore(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"presentations/{jsonable_encoder(id)}/restore",
            method="POST",
            headers={
                "Idempotency-Key": str(idempotency_key) if idempotency_key is not None else None,
                "If-Match": str(if_match) if if_match is not None else None,
    ...
    def presentation_history(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"presentations/{jsonable_encoder(id)}/revisions",
            method="GET",
            headers={"If-None-Match": str(if_none_match) if if_none_match is not None else None},
            request_options=request_options,
        )
    ...
    def presentation_download(
        ...
        *,
        ...
        ------
        typing.Iterator[bytes]
            Download blob associated with the presentation's resource.
    ...
    def presentation_verify(
        self, id: ResourceId, *, request_options: typing.Optional[RequestOptions] = None
    ) -> PresentationVerify:
        """
        ...
        -------
        PresentationVerify
            Result of a presentation verification.
        ...
        client.presentations.presentation_verify(
            id="id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"presentations/{jsonable_encoder(id)}/verify", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PresentationVerify, parse_obj_as(type_=PresentationVerify, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
...
class AsyncPresentationsClient:
    ...
    async def presentation_export(
        ...
        *,
        ...
        async def main() -> None:
            await client.presentations.presentation_export(
                credentials_ids=["string"],
                holder="string",
            )
    ...
    async def presentation_verify(
        ...
        async def main() -> None:
            await client.presentations.presentation_verify(
                id="id",
            )
