...
from ..types.credential_valid_from import CredentialValidFrom
from ..types.credential_valid_until import CredentialValidUntil
from ..types.did_method import DidMethod
from ..types.draft import Draft
from ..types.draft_filter import DraftFilter
from ..types.draft_list import DraftList
from ..types.draft_resource import DraftResource
from ..types.draft_sort import DraftSort
...
class DraftsClient:
    ...
    def draft_create(
        ...
        *,
        ...
        -------
        DraftResource
            Result of draft's resource Create or Update or Restore.

        Examples
        --------
        from truvity_sdk import Draft, TruvityApi

        client = TruvityApi(
            api_key="YOUR_API_KEY",
        )
        client.drafts.draft_create(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(DraftResource, parse_obj_as(type_=DraftResource, object_=_response.json()))  # type: ignore
    ...
    def draft_search(
        self,
        *,
        filter: typing.Optional[typing.Sequence[DraftFilter]] = OMIT,
        sort: typing.Optional[typing.Sequence[DraftSort]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> DraftList:
        """
        Take a look at [GET with body payload](https://opensource.zalando.com/restful-api-guidelines/#get-with-body)

        - no resources created: Returns all drafts matching the query passed as request input payload.

        Parameters
        ----------
        filter : typing.Optional[typing.Sequence[DraftFilter]]
            Filter for the drafts' resources.

        sort : typing.Optional[typing.Sequence[DraftSort]]
            Sort of the drafts' resources.
        ...
        -------
        DraftList
            Result of search of the drafts' resources.
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(DraftList, parse_obj_as(type_=DraftList, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
    ...
    def draft_latest(
        ...
        *,
        ...
        """
        Read the latest revision of the draft's resource.
        ...
        client.drafts.draft_latest(
            id="id",
            if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"drafts/{jsonable_encoder(id)}",
            method="GET",
    ...
    def draft_restore(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"drafts/{jsonable_encoder(id)}/restore",
            method="POST",
            headers={
                "Idempotency-Key": str(idempotency_key) if idempotency_key is not None else None,
                "If-Match": str(if_match) if if_match is not None else None,
    ...
    def draft_history(
        ...
        *,
        ...
        """
        History of the drafts' resources.
        ...
        client.drafts.draft_history(
            id="id",
            if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"drafts/{jsonable_encoder(id)}/revisions",
            method="GET",
            headers={"If-None-Match": str(if_none_match) if if_none_match is not None else None},
            request_options=request_options,
        )
    ...
    def draft_revision(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"drafts/{jsonable_encoder(id)}/revisions/{jsonable_encoder(revision)}",
            method="GET",
            headers={"If-None-Match": str(if_none_match) if if_none_match is not None else None},
            request_options=request_options,
        )
    ...
    def draft_export(
        ...
        revision: Revision,
        *,
        issuer: typing.Optional[Uri] = OMIT,
        valid_from: typing.Optional[CredentialValidFrom] = OMIT,
        valid_until: typing.Optional[CredentialValidUntil] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        issuer : typing.Optional[Uri]

        valid_from : typing.Optional[CredentialValidFrom]

        valid_until : typing.Optional[CredentialValidUntil]
        ...
        with self._client_wrapper.httpx_client.stream(
            f"drafts/{jsonable_encoder(id)}/revisions/{jsonable_encoder(revision)}/export",
            method="POST",
            json={"issuer": issuer, "valid_from": valid_from, "valid_until": valid_until},
            request_options=request_options,
            omit=OMIT,
        ) as _response:
            try:
    ...
    def draft_issue(
        ...
        *,
        key_id: ResourceId,
        did_method: typing.Optional[DidMethod] = OMIT,
        issuer: typing.Optional[Uri] = OMIT,
        valid_from: typing.Optional[CredentialValidFrom] = OMIT,
        valid_until: typing.Optional[CredentialValidUntil] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        -------
        CredentialResource
            Result of credential's resource Create or Update or Restore.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"drafts/{jsonable_encoder(id)}/revisions/{jsonable_encoder(revision)}/issue",
            method="PATCH",
            json={
                "key_id": key_id,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CredentialResource, parse_obj_as(type_=CredentialResource, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
...
class AsyncDraftsClient:
    ...
    async def draft_create(
        ...
        *,
        ...
        from truvity_sdk import AsyncTruvityApi, Draft
        ...
        async def main() -> None:
            await client.drafts.draft_create(
                idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
                data=Draft(),
            )
    ...
    async def draft_search(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_search()
    ...
    async def draft_latest(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_latest(
                id="id",
                if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def draft_delete(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_delete(
                id="id",
                idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
                if_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def draft_update(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_update(
                id="id",
                idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
                if_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
                data=Draft(),
    ...
    async def draft_restore(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_restore(
                id="id",
                idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
                if_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def draft_history(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_history(
                id="id",
                if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def draft_revision(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_revision(
                id="id",
                revision=1,
                if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def draft_export(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_export(
                id="string",
                revision=1,
                issuer="string",
                valid_from=datetime.datetime.fromisoformat(
    ...
    async def draft_issue(
        ...
        *,
        ...
        async def main() -> None:
            await client.drafts.draft_issue(
                id="string",
                revision=1,
                key_id="string",
                did_method="key",
