...
from ..types.credential_verify import CredentialVerify
...
class CredentialsClient:
    ...
    def credential_search(
        ...
        *,
        ...
        Parameters
        ----------
        filter : typing.Optional[typing.Sequence[CredentialFilter]]
            Filter for the credentials' resources.

        sort : typing.Optional[typing.Sequence[CredentialSort]]
        ...
        -------
        CredentialList
            Result of search of the credentials' resources.
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CredentialList, parse_obj_as(type_=CredentialList, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
    ...
    def credential_upload(
        ...
        -------
        UploadResponse
            Result to upload blob and create or update the credential's resource.
    ...
    def credential_latest(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"credentials/{jsonable_encoder(id)}",
            method="GET",
    ...
    def credential_restore(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"credentials/{jsonable_encoder(id)}/restore",
            method="POST",
            headers={
                "Idempotency-Key": str(idempotency_key) if idempotency_key is not None else None,
                "If-Match": str(if_match) if if_match is not None else None,
    ...
    def credential_history(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"credentials/{jsonable_encoder(id)}/revisions",
            method="GET",
            headers={"If-None-Match": str(if_none_match) if if_none_match is not None else None},
            request_options=request_options,
        )
    ...
    def credential_download(
        ...
        *,
        ...
        ------
        typing.Iterator[bytes]
            Download blob associated with the credential's resource.
    ...
    def credential_verify(
        ...
        client.credentials.credential_verify(
            id="id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"credentials/{jsonable_encoder(id)}/verify", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CredentialVerify, parse_obj_as(type_=CredentialVerify, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
...
class AsyncCredentialsClient:
    ...
    async def credential_verify(
        ...
        async def main() -> None:
            await client.credentials.credential_verify(
                id="id",
            )
