...
from ..types.didcomm_message_filter import DidcommMessageFilter
from ..types.didcomm_message_list import DidcommMessageList
from ..types.didcomm_message_resource import DidcommMessageResource
from ..types.didcomm_message_send import DidcommMessageSend
from ..types.didcomm_message_sort import DidcommMessageSort
...
class DidcommMessagesClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def didcomm_message_search(
        self,
        *,
        filter: typing.Optional[typing.Sequence[DidcommMessageFilter]] = OMIT,
        sort: typing.Optional[typing.Sequence[DidcommMessageSort]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> DidcommMessageList:
        """
        Take a look at [GET with body payload](https://opensource.zalando.com/restful-api-guidelines/#get-with-body)

        - no resources created: Returns all didcomm-messages matching the query passed as request input payload.

        Parameters
        ----------
        filter : typing.Optional[typing.Sequence[DidcommMessageFilter]]
            Filter for the didcomm-messages' resources.

        sort : typing.Optional[typing.Sequence[DidcommMessageSort]]
        ...
        -------
        DidcommMessageList
            Result of search of the didcomm-messages' resources.
        ...
        client.didcomm_messages.didcomm_message_search()
        """
        _response = self._client_wrapper.httpx_client.request(
            "didcomm-messages/search",
            method="POST",
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(DidcommMessageList, parse_obj_as(type_=DidcommMessageList, object_=_response.json()))  # type: ignore
    ...
    def didcomm_message_send(
        ...
        *,
        ...
        """
        Send didcomm-message's resource.
        ...
        -------
        DidcommMessageResource
            Result of didcomm-message's resource Create or Update or Restore.

        Examples
        --------
        from truvity_sdk import DidcommMessageSend, TruvityApi

        client = TruvityApi(
            api_key="YOUR_API_KEY",
        )
        client.didcomm_messages.didcomm_message_send(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(DidcommMessageResource, parse_obj_as(type_=DidcommMessageResource, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(BadRequestErrorBody, parse_obj_as(type_=BadRequestErrorBody, object_=_response.json()))  # type: ignore
                )
    ...
    def didcomm_message_latest(
        ...
        *,
        ...
        """
        Read the latest revision of the didcomm-message's resource.
        ...
        client.didcomm_messages.didcomm_message_latest(
            id="id",
            if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"didcomm-messages/{jsonable_encoder(id)}",
            method="GET",
    ...
    def didcomm_message_delete(
        ...
        *,
        ...
        client.didcomm_messages.didcomm_message_delete(
            id="id",
            idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
    ...
    def didcomm_message_restore(
        ...
        *,
        ...
        client.didcomm_messages.didcomm_message_restore(
            id="id",
            idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
            if_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"didcomm-messages/{jsonable_encoder(id)}/restore",
            method="POST",
            headers={
                "Idempotency-Key": str(idempotency_key) if idempotency_key is not None else None,
                "If-Match": str(if_match) if if_match is not None else None,
    ...
    def didcomm_message_history(
        ...
        *,
        ...
        """
        History of the didcomm-messages' resources.
        ...
        client.didcomm_messages.didcomm_message_history(
            id="id",
            if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"didcomm-messages/{jsonable_encoder(id)}/revisions",
            method="GET",
            headers={"If-None-Match": str(if_none_match) if if_none_match is not None else None},
            request_options=request_options,
        )
    ...
    def didcomm_message_revision(
        ...
        *,
        ...
        client.didcomm_messages.didcomm_message_revision(
            id="id",
            revision=1,
            if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            f"didcomm-messages/{jsonable_encoder(id)}/revisions/{jsonable_encoder(revision)}",
            method="GET",
            headers={"If-None-Match": str(if_none_match) if if_none_match is not None else None},
            request_options=request_options,
        )
...
class AsyncDidcommMessagesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def didcomm_message_search(
        self,
        *,
        filter: typing.Optional[typing.Sequence[DidcommMessageFilter]] = OMIT,
        sort: typing.Optional[typing.Sequence[DidcommMessageSort]] = OMIT,
        ...
        async def main() -> None:
            await client.didcomm_messages.didcomm_message_search()
    ...
    async def didcomm_message_send(
        self,
        *,
        data: DidcommMessageSend,
        idempotency_key: typing.Optional[str] = None,
        ...
        from truvity_sdk import AsyncTruvityApi, DidcommMessageSend
        ...
        async def main() -> None:
            await client.didcomm_messages.didcomm_message_send(
                idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
                data=DidcommMessageSend(
                    to="to",
                    key_id="key_id",
    ...
    async def didcomm_message_latest(
        self,
        id: ResourceId,
        *,
        if_none_match: typing.Optional[str] = None,
        ...
        async def main() -> None:
            await client.didcomm_messages.didcomm_message_latest(
                id="id",
                if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def didcomm_message_delete(
        self,
        id: ResourceId,
        *,
        if_match: str,
        ...
        async def main() -> None:
            await client.didcomm_messages.didcomm_message_delete(
                id="id",
                idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
                if_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def didcomm_message_restore(
        self,
        id: ResourceId,
        *,
        if_match: str,
        ...
        async def main() -> None:
            await client.didcomm_messages.didcomm_message_restore(
                id="id",
                idempotency_key="7da7a728-f910-11e6-942a-68f728c1ba70",
                if_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def didcomm_message_history(
        self,
        id: ResourceId,
        *,
        if_none_match: typing.Optional[str] = None,
        ...
        async def main() -> None:
            await client.didcomm_messages.didcomm_message_history(
                id="id",
                if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
    ...
    async def didcomm_message_revision(
        self,
        id: ResourceId,
        revision: Revision,
        *,
        ...
        async def main() -> None:
            await client.didcomm_messages.didcomm_message_revision(
                id="id",
                revision=1,
                if_none_match="5db68c06-1a68-11e9-8341-68f728c1ba70",
            )
