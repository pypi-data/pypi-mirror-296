...
class AtotiClient:
    ...
    def __init__(self, *, activeviam_client: ActiveViamClient) -> None:
        ...
        self._graphql_client: Final = (
            ...
            # Using the presence of the `atoti` namespace as a hint for the presence of the GraphQL service to avoid an extra HTTP request.
            if activeviam_client.has_atoti_python_api_service
            else None
        )
    ...
    def has_gaq_service(self) -> bool:
        return self.activeviam_client.has_atoti_python_api_service
