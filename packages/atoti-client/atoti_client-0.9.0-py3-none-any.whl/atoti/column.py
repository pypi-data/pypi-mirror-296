...
_GetColumnDefaultValue = Callable[[ColumnIdentifier], Constant | None]
_SetColumnDefaultValue = Callable[[ColumnIdentifier, Constant | None], None]
...
class Column(
    ...
    def __init__(
        ...
        *,
        ...
        self._get_column_data_type: Final = get_column_data_type
        self._get_column_default_value: Final = get_column_default_value
        self._set_column_default_value: Final = set_column_default_value
    ...
    def default_value(self) -> ConstantValue | None:
        ...
        None
        """
        default_value = self._get_column_default_value(self._identifier)
