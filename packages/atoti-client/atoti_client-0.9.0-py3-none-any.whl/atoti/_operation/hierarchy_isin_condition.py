...
from .._identification import HierarchyIdentifier, Identifier, LevelIdentifier
...
class HierarchyIsinCondition(
    ...
    member_paths: Annotated[
        AbstractSet[Annotated[tuple[Constant, ...], Field(min_length=1)]],
        Field(min_length=1),
    ]
    _: KW_ONLY
    level_names: Annotated[FrozenSequence[str], Field(min_length=1)]
