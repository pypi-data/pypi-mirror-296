from ._constant import Constant, ConstantJson
...
_AndDict = dict[str, dict[str, ConstantJson | list[ConstantJson]]]
        ...
        and_list.extend(
            {
                isin_condition.subject.column_name: {
                    "$in": [
                        element.json for element in sorted(isin_condition.elements)
                    ],
                },
            }
