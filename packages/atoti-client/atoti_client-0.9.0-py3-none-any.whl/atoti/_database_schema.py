...
from ._data_type import from_graphql
from ._graphql_client.enums import RelationshipOptionality
from ._graphql_client.get_database_schema import (
    GetDatabaseSchema,
...
def _column_to_attribute(
    column: GetDatabaseSchemaTablesColumns,
    /,
    *,
    is_key: bool,
) -> str:
    ...
    return " ".join(
        [
            ...
            _validate_attribute_word(from_graphql(column.data_type)),
...
def _get_relationship(join: GetDatabaseSchemaTablesJoins, /) -> str:
...
def _get_relationship_label(join: GetDatabaseSchemaTablesJoins, /) -> str:
...
def _generate_mermaid_diagram_code(schema: GetDatabaseSchema, /) -> str:
    indent = "  "
