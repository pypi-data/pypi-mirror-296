...
from ._identification import MeasureIdentifier, MeasureName
        ...
        *,
        ...
        if self.__java_api is None:
            ...
            return {
                ...
                for measure in cube_discovery.cubes[self._cube_name].measures
                if key is None or measure.name == key
            }

        measures = (
            self._java_api.get_measures(self._cube_name)
            if key is None
            else {
