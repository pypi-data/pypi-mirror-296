...
class PlanSuccessfulResponse(BaseModel):
    ...
    """ # noqa: E501
    motion: Optional[StrictStr] = Field(default=None, description="Unique identifier of the motion. Use as reference to execute the motion or to retrieve information on the motion.")
    end_joint_position: Optional[Joints] = Field(default=None, description="The final joint position. Use this position as a start joint position to concatenate motions.")
