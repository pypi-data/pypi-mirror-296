...
class MotionGroupInfosApi:
    ...
    async def get_current_motion_group_state(
        ...
        cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")],
        motion_group: Annotated[StrictStr, Field(description="The motion-group id.")],
        tcp: Annotated[Optional[StrictStr], Field(description="The identifier of the tool center point (TCP) to be used for tcp_pose in response. Set this to get the pose of a different TCP than the TCP currently selected on the robot control panel. If you need the information on the currently selected TCP, use the state.tcp_pose in the response. ")] = None,
        ...
        :param motion_group: The motion-group id. (required)
        :type motion_group: str
        :param tcp: The identifier of the tool center point (TCP) to be used for tcp_pose in response. Set this to get the pose of a different TCP than the TCP currently selected on the robot control panel. If you need the information on the currently selected TCP, use the state.tcp_pose in the response. 
        :type tcp: str
    ...
    @validate_call
    async def stream_motion_group_state(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")], motion_group: Annotated[StrictStr, Field(description="The motion-group id.")], response_rate: Annotated[Optional[StrictInt], Field(description="Update rate for the response message in milliseconds (ms). Default is 200 ms. We recommend to use the step rate of the controller or a multiple of the step rate as Nova updates the state in the controller's step rate as well. Minimal response rate is the step rate of controller.")] = None, response_coordinate_system: Annotated[Optional[StrictStr], Field(description="Unique identifier addressing a coordinate system to which the cartesian data of the responses should be converted. Default is the world coordinate system. ")] = None, tcp: Annotated[Optional[StrictStr], Field(description="The identifier of the tool center point (TCP) to be used for tcp_pose in response. Set this to get the pose of a different TCP than the TCP currently selected on the robot control panel. If you need the information on the currently selected TCP, use the state.tcp_pose in the response. ")] = None) -> AsyncGenerator[MotionGroupStateResponse, None]:  # noqa: E501
