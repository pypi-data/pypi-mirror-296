...
class SafetyConfiguration(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "safety_zone_limits": [SafetyZoneLimits.from_dict(_item) for _item in obj["safety_zone_limits"]] if obj.get("safety_zone_limits") is not None else None,
            "safety_zones": [SafetyZone.from_dict(_item) for _item in obj["safety_zones"]] if obj.get("safety_zones") is not None else None,
            ...
            "tcp_geometries": [Geometry.from_dict(_item) for _item in obj["tcp_geometries"]] if obj.get("tcp_geometries") is not None else None
        })
        return _obj
