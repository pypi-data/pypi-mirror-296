...
class ControllerInstance(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "physical_motion_groups": [MotionGroupPhysical.from_dict(_item) for _item in obj["physical_motion_groups"]] if obj.get("physical_motion_groups") is not None else None,
