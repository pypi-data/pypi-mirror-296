...
class Config:
    ...
    DEFAULT_PREFIX_SINGLE_DF = """
        ...
        - Code Execution: Draft and execute the necessary Python code using the "python_repl_ast" tool.
        - MUST never include any python code in your final answer.
        ...
        - Do not include any Python code in your final answer.
