...
def validate_ingest_focused_chat(req):
    ...
    required_arguments = ["focused_chat_id", "host", "site", "assertion_token", "client_secret", "client_id", "tenant_id"]
    validate_required_parameters(body, required_arguments)
    
    return focused_chat_id, host, site, assertion_token, client_secret, client_id, tenant_id
