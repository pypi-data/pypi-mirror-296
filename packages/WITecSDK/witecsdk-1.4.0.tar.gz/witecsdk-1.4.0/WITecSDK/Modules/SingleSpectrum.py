...
from WITecSDK.Modules.HelperStructs import channelpath
...
class SingleSpectrum(SingleSpectrumBase):
    ...
    def __init__(self, aGetParameter: Callable):
        ...
        self._showSpectrum1COM: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera1Data|SingleSpectrum|Show")
        self._showSpectrum2COM: COMBoolParameter = None
        self._showSpectrum3COM: COMBoolParameter = None
        try:
            self._showSpectrum2COM = aGetParameter(channelpath + "SpectralCamera2Data|SingleSpectrum|Show")
            self._showSpectrum3COM = aGetParameter(channelpath + "SpectralCamera3Data|SingleSpectrum|Show")
