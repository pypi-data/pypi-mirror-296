...
from WITecSDK.Modules.HelperStructs import DataChannelDescription, channelpath
...
class SlowTimeSeriesBase(SlowSeriesBase):
    ...
    def __init__(self, aGetParameter: Callable):
        ...
        self._showSpectrum1COM: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera1Data|TimeSeriesSlow|Show")
        self._showSpectrum2COM: COMBoolParameter = None
        self._showSpectrum3COM: COMBoolParameter = None
        try:
            self._showSpectrum2COM = aGetParameter(channelpath + "SpectralCamera2Data|TimeSeriesSlow|Show")
            self._showSpectrum3COM = aGetParameter(channelpath + "SpectralCamera3Data|TimeSeriesSlow|Show")
