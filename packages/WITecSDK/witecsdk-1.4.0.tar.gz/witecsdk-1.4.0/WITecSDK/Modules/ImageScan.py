...
from WITecSDK.Modules.HelperStructs import XYZPosition, LargeAreaSettings, channelpath
...
parampath = "UserParameters|SequencerScanImage|"
...
class ImageScan:
    ...
    def __init__(self, aGetParameter: Callable):
        ...
        try:
            self._FilterManager1: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera1Data|ScanImage|CreateFilterManagerTrace")
            self._FilterManager1R: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera1Data|ScanImage|CreateFilterManagerRetrace")
            self._FilterManager2: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera2Data|ScanImage|CreateFilterManagerTrace")
            self._FilterManager2R: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera2Data|ScanImage|CreateFilterManagerRetrace")
            self._FilterManager3: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera3Data|ScanImage|CreateFilterManagerTrace")
            self._FilterManager3R: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera3Data|ScanImage|CreateFilterManagerRetrace")
