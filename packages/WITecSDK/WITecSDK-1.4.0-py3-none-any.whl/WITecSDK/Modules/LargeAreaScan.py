...
parampath = "UserParameters|SequencerLargeScaleImaging|"
...
class LargeAreaScan:
    ...
    def __init__(self, aGetParameter: Callable):
        ...
        self._FilterManager1: COMBoolParameter = aGetParameter(channelpath + "SpectralCamera1Data|LargeScaleImaging|CreateFilterManager")
        self._FilterManager2: COMBoolParameter = None
        self._FilterManager3: COMBoolParameter = None
        try:
            self._FilterManager2 = aGetParameter(channelpath + "SpectralCamera2Data|LargeScaleImaging|CreateFilterManager")
            self._FilterManager3 = aGetParameter(channelpath + "SpectralCamera3Data|LargeScaleImaging|CreateFilterManager")
