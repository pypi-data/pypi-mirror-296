...
class BETAn:
    ...
    def prepdata(self, data, loading_col="Loading", conv_to_molperkg=1, p0=1e5, full=True):
        ...
        data["phi"] = (data["Loading"] / 1000 * self.R * self.T * scipy.log(data["P_rel"]))
        if (full):
    ...
    def makeconsistencyplot(self, plotting_information, ax3, data, tryminorticks="Yes"):
    ...
    def makelinregplot(self, plotting_information, ax2, p, q, data, mode="BET"):
    ...
    def makeeswplot(self, plotting_information, ax, data, eswpoints=3, fit_data=None):
    ...
    def saveimgsummary(self, plotting_information, bet_info, betesw_info, data, eswminima=None):
        rbet = bet_info[0]
        ...
        self.makeisothermplot(plotting_information, ax, data, fit_data=[bet_info, betesw_info])
        self.makelinregplot(plotting_information, ax2, rbet[0], rbet[1], data)
        self.makeconsistencyplot(plotting_information, ax3, data)
        self.makeeswplot(plotting_information, ax4, data, fit_data=[bet_info, betesw_info])
        self.makelinregplot(plotting_information, ax5, rbetesw[0], rbetesw[1], data)
    ...
    def generatesummary(self, data, plotting_information, eswpoints=3):
        ...
        BET_dict, BET_ESW_dict = self.saveimgsummary(plotting_information, bet_info, betesw_info, data, eswminima=eswminima)
        return BET_dict, BET_ESW_dict
