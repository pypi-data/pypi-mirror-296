def unlzw_chunked(file, chunk_size=1024):
    """
    Decompress compressed data generated by the Unix compress utility (LZW compression, files with .Z suffix)
    in a chunked manner. Input must be a file-like object. Returns a generator yielding decompressed data chunks.
    """
