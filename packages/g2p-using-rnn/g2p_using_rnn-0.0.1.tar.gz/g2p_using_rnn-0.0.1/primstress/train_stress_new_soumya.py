...
from stress_model_new_soumya import StressModel
...
def main(parsed_args):
    ...
    print(f'Time to process data: {t1 - t0}')
    ...
    print(f'Time to create feature vectors: {t2 - t1}')
    ...
    print(f'Time to train data: {t3 - t2}')
