...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Bash script creating a minimal Conda instance with GIT and SVN support
...
# Optional non-default installation options. Fetch rust compiler or git-lfs from shell script.
