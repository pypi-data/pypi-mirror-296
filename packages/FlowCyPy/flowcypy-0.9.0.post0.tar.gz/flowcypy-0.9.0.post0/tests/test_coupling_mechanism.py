...
from FlowCyPy.units import volt, watt, meter, hertz, particle, milliliter, volt, watt, hertz, degree
...
def detector():
    return Detector(
        ...
        name='first detector',
        responsitivity=1.0 * volt / watt,    # Responsitivity of the detector
...
def scatterer(normal_population, default_flow_cell):
    return Scatterer(populations=[normal_population], flow_cell=default_flow_cell)
