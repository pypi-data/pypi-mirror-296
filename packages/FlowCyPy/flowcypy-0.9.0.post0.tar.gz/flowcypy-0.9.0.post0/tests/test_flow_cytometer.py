...
def test_flow_cytometer_simulation(default_source, default_detector_0, default_detector_1, default_scatterer):
    ...
    assert np.any(default_detector_0.dataframe.Signal > 0 * volt), "FSC signal is all zeros."
    assert np.any(default_detector_0.dataframe.Signal > 0 * volt), "SSC signal is all zeros."
