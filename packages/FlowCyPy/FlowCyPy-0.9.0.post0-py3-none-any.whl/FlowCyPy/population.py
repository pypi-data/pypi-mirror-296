...
class Population:
    ...
    def get_properties(self) -> List[str]:
        return [
            ["Mean size value", f"{self.size_list.mean():.2f~#P}"],
            ["STD size", f"{self.size_list.std():.2f~#P}"],
            ["Mean RI value", f"{self.refractive_index_list.mean():.2f~#P}"],
            ["STD RI", f"{self.refractive_index_list.std():.2f~#P}"],
        ]
