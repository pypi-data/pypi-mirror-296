...
def compute_scattering_cross_section(scatterer_distribution: Scatterer, source: Source, detector: Detector) -> np.ndarray:
    r"""
...
def compute_detected_signal(source: Source, detector: Detector, scatterer_distribution: Scatterer) -> float:
    r"""
