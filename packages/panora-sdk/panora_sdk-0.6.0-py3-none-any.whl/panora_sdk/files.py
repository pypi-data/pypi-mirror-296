...
class Files(BaseSDK):
    def list(
        ...
        *,
        ...
        request = models.ListFilestorageFileRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listFilestorageFile",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListFilestorageFileResponse(
                result=utils.unmarshal_json(
                    http_res.text, Optional[models.ListFilestorageFileResponseBody]
                ),
                next=next_func,
            )
    ...
    def create(
        ...
        *,
        x_connection_token: str,
        unified_filestorage_file_input: Union[
            models.UnifiedFilestorageFileInput,
            models.UnifiedFilestorageFileInputTypedDict,
        ],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedFilestorageFileOutput]:
        r"""Create Files

        Create Files in any supported Filestorage software

        :param x_connection_token: The connection token
        :param unified_filestorage_file_input:
        ...
        request = models.CreateFilestorageFileRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_filestorage_file_input=utils.get_pydantic_model(
                unified_filestorage_file_input, models.UnifiedFilestorageFileInput
            ),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.unified_filestorage_file_input,
                False,
                False,
                "json",
                models.UnifiedFilestorageFileInput,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="createFilestorageFile",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedFilestorageFileOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
    ...
    def retrieve(
        ...
        *,
        ...
        :param x_connection_token: The connection token
        :param id: id of the file you want to retrieve.
        ...
        request = models.RetrieveFilestorageFileRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveFilestorageFile",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
