...
class Phonenumbers(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.ListAccountingPhonenumberResponse]:
        r"""List  PhoneNumbers
        ...
        request = models.ListAccountingPhonenumberRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listAccountingPhonenumber",
                oauth2_scopes=[],
        ...
        def next_func() -> Optional[models.ListAccountingPhonenumberResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAccountingPhonenumberResponse(
                result=utils.unmarshal_json(
                    http_res.text,
                    Optional[models.ListAccountingPhonenumberResponseBody],
                ),
                next=next_func,
            )
    ...
    def retrieve(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedAccountingPhonenumberOutput]:
        r"""Retrieve Phone Numbers

        Retrieve Phone Numbers from any connected Accounting software

        :param x_connection_token: The connection token
        :param id: id of the phonenumber you want to retrieve.
        ...
        request = models.RetrieveAccountingPhonenumberRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        req = self.build_request(
            method="GET",
            path="/accounting/phonenumbers/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveAccountingPhonenumber",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedAccountingPhonenumberOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
