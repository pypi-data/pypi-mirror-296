...
class Collections(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listTicketingCollections",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListTicketingCollectionsResponse(
                result=utils.unmarshal_json(
                    http_res.text, Optional[models.ListTicketingCollectionsResponseBody]
                ),
                next=next_func,
            )
    ...
    def retrieve(
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveCollection",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedTicketingCollectionOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
