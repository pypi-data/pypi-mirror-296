...
class ListFilestorageFolderResponseTypedDict(TypedDict):
    result: ListFilestorageFolderResponseBodyTypedDict


class ListFilestorageFolderResponse(BaseModel):
    next: Callable[[], Optional[ListFilestorageFolderResponse]]
