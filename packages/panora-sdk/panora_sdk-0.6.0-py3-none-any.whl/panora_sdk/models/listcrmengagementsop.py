...
class ListCrmEngagementsRequestTypedDict(TypedDict):
...
class ListCrmEngagementsRequest(BaseModel):
...
class ListCrmEngagementsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmEngagementOutputTypedDict]


class ListCrmEngagementsResponseBody(BaseModel):
    prev_cursor: Nullable[str]

    next_cursor: Nullable[str]

    data: List[UnifiedCrmEngagementOutput]
...
class ListCrmEngagementsResponseTypedDict(TypedDict):
    result: ListCrmEngagementsResponseBodyTypedDict


class ListCrmEngagementsResponse(BaseModel):
    next: Callable[[], Optional[ListCrmEngagementsResponse]]
