...
class UnifiedAccountingExpenseOutputTypedDict(TypedDict):
    ...
    field_mappings: NotRequired[
        Nullable[UnifiedAccountingExpenseOutputFieldMappingsTypedDict]
    ]
    r"""The custom field mappings of the object between the remote 3rd party & Panora"""
    ...
    remote_data: NotRequired[
        Nullable[UnifiedAccountingExpenseOutputRemoteDataTypedDict]
    ]
    r"""The remote data of the expense in the context of the 3rd Party"""
...
class UnifiedAccountingExpenseOutput(BaseModel):
    ...
    field_mappings: OptionalNullable[UnifiedAccountingExpenseOutputFieldMappings] = (
        UNSET
    )
    r"""The custom field mappings of the object between the remote 3rd party & Panora"""
