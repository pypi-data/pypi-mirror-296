...
class UnifiedAccountingInvoiceOutputTypedDict(TypedDict):
    ...
    field_mappings: NotRequired[
        Nullable[UnifiedAccountingInvoiceOutputFieldMappingsTypedDict]
    ]
    r"""The custom field mappings of the object between the remote 3rd party & Panora"""
    ...
    remote_data: NotRequired[
        Nullable[UnifiedAccountingInvoiceOutputRemoteDataTypedDict]
    ]
    r"""The remote data of the invoice in the context of the 3rd Party"""
...
class UnifiedAccountingInvoiceOutput(BaseModel):
    ...
    field_mappings: OptionalNullable[UnifiedAccountingInvoiceOutputFieldMappings] = (
        UNSET
    )
    r"""The custom field mappings of the object between the remote 3rd party & Panora"""
