...
class ListHrisBankInfoResponseTypedDict(TypedDict):
    result: ListHrisBankInfoResponseBodyTypedDict


class ListHrisBankInfoResponse(BaseModel):
    next: Callable[[], Optional[ListHrisBankInfoResponse]]
