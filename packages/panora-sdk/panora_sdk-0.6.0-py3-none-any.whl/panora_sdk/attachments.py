...
class Attachments(BaseSDK):
        ...
        *,
    ...
    ) -> Optional[models.ListAtsAttachmentResponse]:
        r"""List  Attachments
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listAtsAttachment",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAtsAttachmentResponse(
                result=utils.unmarshal_json(
                    http_res.text, Optional[models.ListAtsAttachmentResponseBody]
                ),
                next=next_func,
            )
    ...
    def create(
        ...
        *,
        x_connection_token: str,
        unified_ats_attachment_input: Union[
            models.UnifiedAtsAttachmentInput, models.UnifiedAtsAttachmentInputTypedDict
        ],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.CreateAtsAttachmentRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_ats_attachment_input=utils.get_pydantic_model(
                unified_ats_attachment_input, models.UnifiedAtsAttachmentInput
            ),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.unified_ats_attachment_input,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="createAtsAttachment",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedAtsAttachmentOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
    ...
    def retrieve(
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveAtsAttachment",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
