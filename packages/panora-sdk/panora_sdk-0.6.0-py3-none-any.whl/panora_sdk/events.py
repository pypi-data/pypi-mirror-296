...
class Events(BaseSDK):
    def get_panora_core_events(
        ...
        *,
    ...
    ) -> Optional[List[models.EventResponse]]:
        r"""List Events
        ...
        request = models.GetPanoraCoreEventsRequest(
            page=page,
            limit=limit,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="getPanoraCoreEvents",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[List[models.EventResponse]]
            )
