...
class PanoraAtsUsers(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.ListAtsUsersResponse]:
        r"""List  Users
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAtsUsersResponse(
                result=utils.unmarshal_json(
                    http_res.text, Optional[models.ListAtsUsersResponseBody]
                ),
                next=next_func,
            )
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedAtsUserOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
