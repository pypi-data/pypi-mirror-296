...
class ListAccountingJournalEntryRequestTypedDict(TypedDict):
...
class ListAccountingJournalEntryRequest(BaseModel):
...
class ListAccountingJournalEntryResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingJournalentryOutputTypedDict]


class ListAccountingJournalEntryResponseBody(BaseModel):
    prev_cursor: Nullable[str]

    next_cursor: Nullable[str]

    data: List[UnifiedAccountingJournalentryOutput]
...
class ListAccountingJournalEntryResponseTypedDict(TypedDict):
    result: ListAccountingJournalEntryResponseBodyTypedDict


class ListAccountingJournalEntryResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingJournalEntryResponse]]
