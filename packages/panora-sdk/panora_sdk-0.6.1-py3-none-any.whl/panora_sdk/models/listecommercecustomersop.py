...
class ListEcommerceCustomersRequestTypedDict(TypedDict):
...
class ListEcommerceCustomersRequest(BaseModel):
...
class ListEcommerceCustomersResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedEcommerceCustomerOutputTypedDict]


class ListEcommerceCustomersResponseBody(BaseModel):
    prev_cursor: Nullable[str]

    next_cursor: Nullable[str]

    data: List[UnifiedEcommerceCustomerOutput]
...
class ListEcommerceCustomersResponseTypedDict(TypedDict):
    result: ListEcommerceCustomersResponseBodyTypedDict


class ListEcommerceCustomersResponse(BaseModel):
    next: Callable[[], Optional[ListEcommerceCustomersResponse]]
