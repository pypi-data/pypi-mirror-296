...
class ListHrisTimeoffsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisTimeoffOutputTypedDict]


class ListHrisTimeoffsResponseBody(BaseModel):
    prev_cursor: Nullable[str]

    next_cursor: Nullable[str]

    data: List[UnifiedHrisTimeoffOutput]
...
class ListHrisTimeoffsResponseTypedDict(TypedDict):
    result: ListHrisTimeoffsResponseBodyTypedDict


class ListHrisTimeoffsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisTimeoffsResponse]]
