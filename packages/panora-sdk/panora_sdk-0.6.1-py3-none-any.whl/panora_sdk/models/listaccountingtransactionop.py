...
class ListAccountingTransactionResponseTypedDict(TypedDict):
    result: ListAccountingTransactionResponseBodyTypedDict


class ListAccountingTransactionResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingTransactionResponse]]
