...
class ListAccountingTaxRateRequestTypedDict(TypedDict):
...
class ListAccountingTaxRateRequest(BaseModel):
...
class ListAccountingTaxRateResponseTypedDict(TypedDict):
    result: ListAccountingTaxRateResponseBodyTypedDict


class ListAccountingTaxRateResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingTaxRateResponse]]
