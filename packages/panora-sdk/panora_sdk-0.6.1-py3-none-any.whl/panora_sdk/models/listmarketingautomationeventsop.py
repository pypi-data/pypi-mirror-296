...
class ListMarketingAutomationEventsResponseTypedDict(TypedDict):
    result: ListMarketingAutomationEventsResponseBodyTypedDict


class ListMarketingAutomationEventsResponse(BaseModel):
    next: Callable[[], Optional[ListMarketingAutomationEventsResponse]]
