...
class ListAccountingInvoiceRequestTypedDict(TypedDict):
...
class ListAccountingInvoiceRequest(BaseModel):
...
class ListAccountingInvoiceResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingInvoiceOutputTypedDict]


class ListAccountingInvoiceResponseBody(BaseModel):
    prev_cursor: Nullable[str]

    next_cursor: Nullable[str]

    data: List[UnifiedAccountingInvoiceOutput]
...
class ListAccountingInvoiceResponseTypedDict(TypedDict):
    result: ListAccountingInvoiceResponseBodyTypedDict


class ListAccountingInvoiceResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingInvoiceResponse]]
