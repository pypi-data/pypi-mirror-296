...
class ListAccountingAddressResponseTypedDict(TypedDict):
    result: ListAccountingAddressResponseBodyTypedDict


class ListAccountingAddressResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingAddressResponse]]
