...
class ListAtsOfficeResponseTypedDict(TypedDict):
    result: ListAtsOfficeResponseBodyTypedDict


class ListAtsOfficeResponse(BaseModel):
    next: Callable[[], Optional[ListAtsOfficeResponse]]
