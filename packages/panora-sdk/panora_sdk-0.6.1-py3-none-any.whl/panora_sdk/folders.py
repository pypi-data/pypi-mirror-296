...
class Folders(BaseSDK):
        ...
        *,
    ...
    ) -> Optional[models.ListFilestorageFolderResponse]:
        r"""List  Folders
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listFilestorageFolder",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListFilestorageFolderResponse(
                result=utils.unmarshal_json(
                    http_res.text, Optional[models.ListFilestorageFolderResponseBody]
                ),
                next=next_func,
            )
    ...
    def create(
        ...
        *,
        x_connection_token: str,
        unified_filestorage_folder_input: Union[
            models.UnifiedFilestorageFolderInput,
            models.UnifiedFilestorageFolderInputTypedDict,
        ],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.CreateFilestorageFolderRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_filestorage_folder_input=utils.get_pydantic_model(
                unified_filestorage_folder_input, models.UnifiedFilestorageFolderInput
            ),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.unified_filestorage_folder_input,
                False,
                False,
                "json",
                models.UnifiedFilestorageFolderInput,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="createFilestorageFolder",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedFilestorageFolderOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
    ...
    def retrieve(
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveFilestorageFolder",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
