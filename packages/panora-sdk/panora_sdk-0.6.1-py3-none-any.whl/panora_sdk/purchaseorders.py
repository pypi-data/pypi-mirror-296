...
class Purchaseorders(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listAccountingPurchaseOrder",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAccountingPurchaseOrderResponse(
                result=utils.unmarshal_json(
                    http_res.text,
                    Optional[models.ListAccountingPurchaseOrderResponseBody],
                ),
                next=next_func,
            )
    ...
    def create(
        ...
        *,
        x_connection_token: str,
        unified_accounting_purchaseorder_input: Union[
        ...
        request = models.CreateAccountingPurchaseOrderRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_accounting_purchaseorder_input=utils.get_pydantic_model(
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.unified_accounting_purchaseorder_input,
                False,
                False,
                "json",
                models.UnifiedAccountingPurchaseorderInput,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedAccountingPurchaseorderOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
    ...
    def retrieve(
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveAccountingPurchaseOrder",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
