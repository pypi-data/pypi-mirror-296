...
UnifiedAtsCandidateInputAttachmentsTypedDict = Union[
...
UnifiedAtsCandidateInputApplicationsTypedDict = Union[
    UnifiedAtsApplicationOutputTypedDict, str
]
...
class UnifiedAtsCandidateInputTypedDict(TypedDict):
    ...
    attachments: NotRequired[
        Nullable[List[UnifiedAtsCandidateInputAttachmentsTypedDict]]
    ]
    r"""The attachments UUIDs of the candidate"""
    applications: NotRequired[
        Nullable[List[UnifiedAtsCandidateInputApplicationsTypedDict]]
    ]
