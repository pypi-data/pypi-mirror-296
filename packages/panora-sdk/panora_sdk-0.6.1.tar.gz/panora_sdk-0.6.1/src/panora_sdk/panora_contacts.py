...
class PanoraContacts(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.ListCrmContactsResponse]:
        r"""List CRM Contacts
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListCrmContactsResponse(
                result=utils.unmarshal_json(
                    http_res.text, Optional[models.ListCrmContactsResponseBody]
                ),
                next=next_func,
            )
    ...
    def create(
        ...
        *,
        x_connection_token: str,
        unified_crm_contact_input: Union[
            models.UnifiedCrmContactInput, models.UnifiedCrmContactInputTypedDict
        ],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.CreateCrmContactRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_crm_contact_input=utils.get_pydantic_model(
                unified_crm_contact_input, models.UnifiedCrmContactInput
            ),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.unified_crm_contact_input,
                False,
                False,
                "json",
                models.UnifiedCrmContactInput,
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedCrmContactOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
    ...
    def retrieve(
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveCrmContact",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
