...
class Phonenumbers(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListAccountingPhonenumberResponse:
        r"""List  PhoneNumbers
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAccountingPhonenumberResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListAccountingPhonenumberResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedAccountingPhonenumberOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
