...
class Employees(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListHrisEmployeesResponse:
        r"""List Employees
        ...
        request = models.ListHrisEmployeesRequest(
        ...
        def next_func() -> Optional[models.ListHrisEmployeesResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListHrisEmployeesResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListHrisEmployeesResponseBody]), next=next_func)
    ...
    def create(
        self, *,
        x_connection_token: str,
        unified_hris_employee_input: Union[models.UnifiedHrisEmployeeInput, models.UnifiedHrisEmployeeInputTypedDict],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedHrisEmployeeOutput]:
        r"""Create Employees
        ...
        request = models.CreateHrisEmployeeRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_hris_employee_input=utils.get_pydantic_model(unified_hris_employee_input, models.UnifiedHrisEmployeeInput),
        )
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.unified_hris_employee_input, False, False, "json", models.UnifiedHrisEmployeeInput),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedHrisEmployeeOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def retrieve(
        ...
        :param x_connection_token: The connection token
        :param id: id of the employee you want to retrieve.
        :param remote_data: Set to true to include data from the original Hris software.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        ...
        request = models.RetrieveHrisEmployeeRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveHrisEmployee", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
