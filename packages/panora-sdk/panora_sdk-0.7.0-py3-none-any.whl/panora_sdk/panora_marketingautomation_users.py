...
class PanoraMarketingautomationUsers(BaseSDK):
    ...
    def list(
        ...
        request = models.ListMarketingAutomationUsersRequest(
        ...
        req = self.build_request(
            method="GET",
            path="/marketingautomation/users",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listMarketingAutomationUsers", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListMarketingAutomationUsersResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListMarketingAutomationUsersResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedMarketingautomationUserOutput]:
        r"""Retrieve Users
        ...
        request = models.RetrieveMarketingAutomationUserRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        req = self.build_request(
            method="GET",
            path="/marketingautomation/users/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveMarketingAutomationUser", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedMarketingautomationUserOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
