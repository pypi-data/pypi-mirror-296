...
class PanoraCompanies(BaseSDK):
    ...
    def list(
        ...
        request = models.ListHrisCompaniesRequest(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListHrisCompaniesResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListHrisCompaniesResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedHrisCompanyOutput]:
        r"""Retrieve Company
        ...
        request = models.RetrieveHrisCompanyRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveHrisCompany", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedHrisCompanyOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
