...
from .unifiedaccountingtrackingcategoryoutput import UnifiedAccountingTrackingcategoryOutput, UnifiedAccountingTrackingcategoryOutputTypedDict
...
class ListAccountingTrackingCategorysRequestTypedDict(TypedDict):
...
class ListAccountingTrackingCategorysRequest(BaseModel):
...
class ListAccountingTrackingCategorysResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingTrackingcategoryOutputTypedDict]
    

class ListAccountingTrackingCategorysResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingTrackingcategoryOutput]
...
class ListAccountingTrackingCategorysResponseTypedDict(TypedDict):
    result: ListAccountingTrackingCategorysResponseBodyTypedDict
    

class ListAccountingTrackingCategorysResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingTrackingCategorysResponse]]
