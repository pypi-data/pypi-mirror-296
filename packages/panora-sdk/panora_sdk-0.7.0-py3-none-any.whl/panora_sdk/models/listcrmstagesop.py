...
from .unifiedcrmstageoutput import UnifiedCrmStageOutput, UnifiedCrmStageOutputTypedDict
...
class ListCrmStagesRequestTypedDict(TypedDict):
...
class ListCrmStagesRequest(BaseModel):
...
class ListCrmStagesResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmStageOutputTypedDict]
    

class ListCrmStagesResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmStageOutput]
...
class ListCrmStagesResponseTypedDict(TypedDict):
    result: ListCrmStagesResponseBodyTypedDict
    

class ListCrmStagesResponse(BaseModel):
    next: Callable[[], Optional[ListCrmStagesResponse]]
