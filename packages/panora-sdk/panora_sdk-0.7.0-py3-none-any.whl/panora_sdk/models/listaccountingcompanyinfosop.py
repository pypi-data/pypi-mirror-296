...
from .unifiedaccountingcompanyinfooutput import UnifiedAccountingCompanyinfoOutput, UnifiedAccountingCompanyinfoOutputTypedDict
...
class ListAccountingCompanyInfosRequestTypedDict(TypedDict):
...
class ListAccountingCompanyInfosRequest(BaseModel):
...
class ListAccountingCompanyInfosResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingCompanyinfoOutputTypedDict]
    

class ListAccountingCompanyInfosResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingCompanyinfoOutput]
...
class ListAccountingCompanyInfosResponseTypedDict(TypedDict):
    result: ListAccountingCompanyInfosResponseBodyTypedDict
    

class ListAccountingCompanyInfosResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingCompanyInfosResponse]]
