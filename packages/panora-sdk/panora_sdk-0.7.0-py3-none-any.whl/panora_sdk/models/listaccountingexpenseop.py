...
from .unifiedaccountingexpenseoutput import UnifiedAccountingExpenseOutput, UnifiedAccountingExpenseOutputTypedDict
...
class ListAccountingExpenseRequestTypedDict(TypedDict):
...
class ListAccountingExpenseRequest(BaseModel):
...
class ListAccountingExpenseResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingExpenseOutputTypedDict]
    

class ListAccountingExpenseResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingExpenseOutput]
...
class ListAccountingExpenseResponseTypedDict(TypedDict):
    result: ListAccountingExpenseResponseBodyTypedDict
    

class ListAccountingExpenseResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingExpenseResponse]]
