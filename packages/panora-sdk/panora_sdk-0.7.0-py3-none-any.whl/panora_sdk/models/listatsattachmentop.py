...
class ListAtsAttachmentResponseTypedDict(TypedDict):
    result: ListAtsAttachmentResponseBodyTypedDict
    

class ListAtsAttachmentResponse(BaseModel):
    next: Callable[[], Optional[ListAtsAttachmentResponse]]
