...
from .unifiedatsactivityinput import UnifiedAtsActivityInput, UnifiedAtsActivityInputTypedDict
...
class CreateAtsActivityRequestTypedDict(TypedDict):
    ...
    unified_ats_activity_input: UnifiedAtsActivityInputTypedDict
...
class CreateAtsActivityRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_ats_activity_input: Annotated[UnifiedAtsActivityInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
