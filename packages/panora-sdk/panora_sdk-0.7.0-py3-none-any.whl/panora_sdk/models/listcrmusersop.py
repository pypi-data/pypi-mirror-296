...
class ListCrmUsersRequestTypedDict(TypedDict):
...
class ListCrmUsersRequest(BaseModel):
...
class ListCrmUsersResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmUserOutputTypedDict]
    

class ListCrmUsersResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmUserOutput]
...
class ListCrmUsersResponseTypedDict(TypedDict):
    result: ListCrmUsersResponseBodyTypedDict
    

class ListCrmUsersResponse(BaseModel):
    next: Callable[[], Optional[ListCrmUsersResponse]]
