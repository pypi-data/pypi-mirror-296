...
from .unifiedaccountingattachmentoutput import UnifiedAccountingAttachmentOutput, UnifiedAccountingAttachmentOutputTypedDict
...
class ListAccountingAttachmentsRequestTypedDict(TypedDict):
...
class ListAccountingAttachmentsRequest(BaseModel):
...
class ListAccountingAttachmentsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingAttachmentOutputTypedDict]
    

class ListAccountingAttachmentsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingAttachmentOutput]
...
class ListAccountingAttachmentsResponseTypedDict(TypedDict):
    result: ListAccountingAttachmentsResponseBodyTypedDict
    

class ListAccountingAttachmentsResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingAttachmentsResponse]]
