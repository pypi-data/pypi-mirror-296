...
from .unifiedecommerceproductoutput import UnifiedEcommerceProductOutput, UnifiedEcommerceProductOutputTypedDict
...
class ListEcommerceProductsRequestTypedDict(TypedDict):
...
class ListEcommerceProductsRequest(BaseModel):
...
class ListEcommerceProductsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedEcommerceProductOutputTypedDict]
    

class ListEcommerceProductsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedEcommerceProductOutput]
...
class ListEcommerceProductsResponseTypedDict(TypedDict):
    result: ListEcommerceProductsResponseBodyTypedDict
    

class ListEcommerceProductsResponse(BaseModel):
    next: Callable[[], Optional[ListEcommerceProductsResponse]]
