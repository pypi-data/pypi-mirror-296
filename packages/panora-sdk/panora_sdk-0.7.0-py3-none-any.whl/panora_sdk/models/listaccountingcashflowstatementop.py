...
from .unifiedaccountingcashflowstatementoutput import UnifiedAccountingCashflowstatementOutput, UnifiedAccountingCashflowstatementOutputTypedDict
...
class ListAccountingCashflowStatementRequestTypedDict(TypedDict):
...
class ListAccountingCashflowStatementRequest(BaseModel):
...
class ListAccountingCashflowStatementResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingCashflowstatementOutputTypedDict]
    

class ListAccountingCashflowStatementResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingCashflowstatementOutput]
...
class ListAccountingCashflowStatementResponseTypedDict(TypedDict):
    result: ListAccountingCashflowStatementResponseBodyTypedDict
    

class ListAccountingCashflowStatementResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingCashflowStatementResponse]]
