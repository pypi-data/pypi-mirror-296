...
from .unifiedaccountingaccountoutput import UnifiedAccountingAccountOutput, UnifiedAccountingAccountOutputTypedDict
...
class ListAccountingAccountsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingAccountOutputTypedDict]
    

class ListAccountingAccountsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingAccountOutput]
...
class ListAccountingAccountsResponseTypedDict(TypedDict):
    result: ListAccountingAccountsResponseBodyTypedDict
    

class ListAccountingAccountsResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingAccountsResponse]]
