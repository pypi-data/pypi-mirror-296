...
from .unifiedhristimesheetentryoutput import UnifiedHrisTimesheetEntryOutput, UnifiedHrisTimesheetEntryOutputTypedDict
...
class ListHrisTimesheetentriesRequestTypedDict(TypedDict):
...
class ListHrisTimesheetentriesRequest(BaseModel):
...
class ListHrisTimesheetentriesResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisTimesheetEntryOutputTypedDict]
    

class ListHrisTimesheetentriesResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisTimesheetEntryOutput]
...
class ListHrisTimesheetentriesResponseTypedDict(TypedDict):
    result: ListHrisTimesheetentriesResponseBodyTypedDict
    

class ListHrisTimesheetentriesResponse(BaseModel):
    next: Callable[[], Optional[ListHrisTimesheetentriesResponse]]
