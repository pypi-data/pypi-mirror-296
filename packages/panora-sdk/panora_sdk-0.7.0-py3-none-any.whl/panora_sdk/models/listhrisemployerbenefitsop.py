...
from .unifiedhrisemployerbenefitoutput import UnifiedHrisEmployerbenefitOutput, UnifiedHrisEmployerbenefitOutputTypedDict
...
class ListHrisEmployerBenefitsRequestTypedDict(TypedDict):
...
class ListHrisEmployerBenefitsRequest(BaseModel):
...
class ListHrisEmployerBenefitsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmployerbenefitOutputTypedDict]
    

class ListHrisEmployerBenefitsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmployerbenefitOutput]
...
class ListHrisEmployerBenefitsResponseTypedDict(TypedDict):
    result: ListHrisEmployerBenefitsResponseBodyTypedDict
    

class ListHrisEmployerBenefitsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisEmployerBenefitsResponse]]
