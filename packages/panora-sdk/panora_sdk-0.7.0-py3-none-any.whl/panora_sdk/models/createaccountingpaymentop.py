...
from .unifiedaccountingpaymentinput import UnifiedAccountingPaymentInput, UnifiedAccountingPaymentInputTypedDict
...
class CreateAccountingPaymentRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_accounting_payment_input: UnifiedAccountingPaymentInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Accounting software."""
    

class CreateAccountingPaymentRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_accounting_payment_input: Annotated[UnifiedAccountingPaymentInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
