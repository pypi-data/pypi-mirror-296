...
from .unifiedhrislocationoutput import UnifiedHrisLocationOutput, UnifiedHrisLocationOutputTypedDict
...
class ListHrisLocationsRequestTypedDict(TypedDict):
...
class ListHrisLocationsRequest(BaseModel):
...
class ListHrisLocationsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisLocationOutputTypedDict]
    

class ListHrisLocationsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisLocationOutput]
...
class ListHrisLocationsResponseTypedDict(TypedDict):
    result: ListHrisLocationsResponseBodyTypedDict
    

class ListHrisLocationsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisLocationsResponse]]
