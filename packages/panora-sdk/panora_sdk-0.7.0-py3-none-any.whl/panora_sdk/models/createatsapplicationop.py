...
from .unifiedatsapplicationinput import UnifiedAtsApplicationInput, UnifiedAtsApplicationInputTypedDict
...
class CreateAtsApplicationRequestTypedDict(TypedDict):
    ...
    unified_ats_application_input: UnifiedAtsApplicationInputTypedDict
...
class CreateAtsApplicationRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_ats_application_input: Annotated[UnifiedAtsApplicationInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
