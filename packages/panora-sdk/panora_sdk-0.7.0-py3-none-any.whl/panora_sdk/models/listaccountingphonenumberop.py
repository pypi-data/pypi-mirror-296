...
from .unifiedaccountingphonenumberoutput import UnifiedAccountingPhonenumberOutput, UnifiedAccountingPhonenumberOutputTypedDict
...
class ListAccountingPhonenumberRequestTypedDict(TypedDict):
...
class ListAccountingPhonenumberRequest(BaseModel):
...
class ListAccountingPhonenumberResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingPhonenumberOutputTypedDict]
    

class ListAccountingPhonenumberResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingPhonenumberOutput]
...
class ListAccountingPhonenumberResponseTypedDict(TypedDict):
    result: ListAccountingPhonenumberResponseBodyTypedDict
    

class ListAccountingPhonenumberResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingPhonenumberResponse]]
