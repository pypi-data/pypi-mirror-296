...
class UnifiedCrmNoteOutput(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["user_id", "company_id", "contact_id", "deal_id", "field_mappings", "id", "remote_id", "remote_data", "created_at", "modified_at"]
        nullable_fields = ["content", "user_id", "company_id", "contact_id", "deal_id", "field_mappings", "id", "remote_id", "remote_data", "created_at", "modified_at"]
        null_default_fields = []
