...
class ListCrmDealsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmDealOutputTypedDict]
    

class ListCrmDealsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmDealOutput]
...
class ListCrmDealsResponseTypedDict(TypedDict):
    result: ListCrmDealsResponseBodyTypedDict
    

class ListCrmDealsResponse(BaseModel):
    next: Callable[[], Optional[ListCrmDealsResponse]]
