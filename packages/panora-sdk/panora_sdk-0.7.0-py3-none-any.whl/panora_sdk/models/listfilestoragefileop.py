...
from .unifiedfilestoragefileoutput import UnifiedFilestorageFileOutput, UnifiedFilestorageFileOutputTypedDict
...
class ListFilestorageFileRequestTypedDict(TypedDict):
...
class ListFilestorageFileRequest(BaseModel):
...
class ListFilestorageFileResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedFilestorageFileOutputTypedDict]
    

class ListFilestorageFileResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedFilestorageFileOutput]
...
class ListFilestorageFileResponseTypedDict(TypedDict):
    result: ListFilestorageFileResponseBodyTypedDict
    

class ListFilestorageFileResponse(BaseModel):
    next: Callable[[], Optional[ListFilestorageFileResponse]]
