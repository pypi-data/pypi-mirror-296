...
class ListTicketingTagsRequestTypedDict(TypedDict):
...
class ListTicketingTagsRequest(BaseModel):
...
class ListTicketingTagsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingTagOutputTypedDict]
    

class ListTicketingTagsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingTagOutput]
...
class ListTicketingTagsResponseTypedDict(TypedDict):
    result: ListTicketingTagsResponseBodyTypedDict
    

class ListTicketingTagsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketingTagsResponse]]
