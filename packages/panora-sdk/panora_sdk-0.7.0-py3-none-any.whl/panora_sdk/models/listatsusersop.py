...
class ListAtsUsersRequestTypedDict(TypedDict):
...
class ListAtsUsersRequest(BaseModel):
...
class ListAtsUsersResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsUserOutputTypedDict]
    

class ListAtsUsersResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsUserOutput]
...
class ListAtsUsersResponseTypedDict(TypedDict):
    result: ListAtsUsersResponseBodyTypedDict
    

class ListAtsUsersResponse(BaseModel):
    next: Callable[[], Optional[ListAtsUsersResponse]]
