...
from .unifiedhrisemployeeoutput import UnifiedHrisEmployeeOutput, UnifiedHrisEmployeeOutputTypedDict
...
class ListHrisEmployeesRequestTypedDict(TypedDict):
...
class ListHrisEmployeesRequest(BaseModel):
...
class ListHrisEmployeesResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmployeeOutputTypedDict]
    

class ListHrisEmployeesResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmployeeOutput]
...
class ListHrisEmployeesResponseTypedDict(TypedDict):
    result: ListHrisEmployeesResponseBodyTypedDict
    

class ListHrisEmployeesResponse(BaseModel):
    next: Callable[[], Optional[ListHrisEmployeesResponse]]
