...
from .unifiedatsscorecardoutput import UnifiedAtsScorecardOutput, UnifiedAtsScorecardOutputTypedDict
...
class ListAtsScorecardRequestTypedDict(TypedDict):
...
class ListAtsScorecardRequest(BaseModel):
...
class ListAtsScorecardResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsScorecardOutputTypedDict]
    

class ListAtsScorecardResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsScorecardOutput]
...
class ListAtsScorecardResponseTypedDict(TypedDict):
    result: ListAtsScorecardResponseBodyTypedDict
    

class ListAtsScorecardResponse(BaseModel):
    next: Callable[[], Optional[ListAtsScorecardResponse]]
