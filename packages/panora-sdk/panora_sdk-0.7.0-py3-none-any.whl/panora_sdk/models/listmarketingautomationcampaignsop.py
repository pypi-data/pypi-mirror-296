...
from .unifiedmarketingautomationcampaignoutput import UnifiedMarketingautomationCampaignOutput, UnifiedMarketingautomationCampaignOutputTypedDict
...
class ListMarketingautomationCampaignsRequestTypedDict(TypedDict):
...
class ListMarketingautomationCampaignsRequest(BaseModel):
...
class ListMarketingautomationCampaignsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationCampaignOutputTypedDict]
    

class ListMarketingautomationCampaignsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationCampaignOutput]
