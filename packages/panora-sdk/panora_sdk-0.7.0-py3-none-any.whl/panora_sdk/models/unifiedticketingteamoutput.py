...
class UnifiedTicketingTeamOutputTypedDict(TypedDict):
    ...
    r"""The custom field mappings of the team between the remote 3rd party & Panora"""
    ...
    r"""The remote data of the team in the context of the 3rd Party"""
...
class UnifiedTicketingTeamOutput(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["description", "field_mappings", "id", "remote_id", "remote_data", "created_at", "modified_at"]
        nullable_fields = ["name", "description", "field_mappings", "id", "remote_id", "remote_data", "created_at", "modified_at"]
        null_default_fields = []
