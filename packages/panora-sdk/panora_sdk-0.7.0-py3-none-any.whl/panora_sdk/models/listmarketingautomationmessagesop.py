...
from .unifiedmarketingautomationmessageoutput import UnifiedMarketingautomationMessageOutput, UnifiedMarketingautomationMessageOutputTypedDict
...
class ListMarketingautomationMessagesRequestTypedDict(TypedDict):
...
class ListMarketingautomationMessagesRequest(BaseModel):
...
class ListMarketingautomationMessagesResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationMessageOutputTypedDict]
    

class ListMarketingautomationMessagesResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationMessageOutput]
...
class ListMarketingautomationMessagesResponseTypedDict(TypedDict):
    result: ListMarketingautomationMessagesResponseBodyTypedDict
    

class ListMarketingautomationMessagesResponse(BaseModel):
    next: Callable[[], Optional[ListMarketingautomationMessagesResponse]]
