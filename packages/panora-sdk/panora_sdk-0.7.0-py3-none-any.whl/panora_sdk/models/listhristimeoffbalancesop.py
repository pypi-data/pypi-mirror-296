...
from .unifiedhristimeoffbalanceoutput import UnifiedHrisTimeoffbalanceOutput, UnifiedHrisTimeoffbalanceOutputTypedDict
...
class ListHrisTimeoffbalancesRequestTypedDict(TypedDict):
...
class ListHrisTimeoffbalancesRequest(BaseModel):
...
class ListHrisTimeoffbalancesResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisTimeoffbalanceOutputTypedDict]
    

class ListHrisTimeoffbalancesResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisTimeoffbalanceOutput]
...
class ListHrisTimeoffbalancesResponseTypedDict(TypedDict):
    result: ListHrisTimeoffbalancesResponseBodyTypedDict
    

class ListHrisTimeoffbalancesResponse(BaseModel):
    next: Callable[[], Optional[ListHrisTimeoffbalancesResponse]]
