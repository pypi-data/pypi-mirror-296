...
from .unifiedatsinterviewoutput import UnifiedAtsInterviewOutput, UnifiedAtsInterviewOutputTypedDict
...
class ListAtsInterviewRequestTypedDict(TypedDict):
...
class ListAtsInterviewRequest(BaseModel):
...
class ListAtsInterviewResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsInterviewOutputTypedDict]
    

class ListAtsInterviewResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsInterviewOutput]
...
class ListAtsInterviewResponseTypedDict(TypedDict):
    result: ListAtsInterviewResponseBodyTypedDict
    

class ListAtsInterviewResponse(BaseModel):
    next: Callable[[], Optional[ListAtsInterviewResponse]]
