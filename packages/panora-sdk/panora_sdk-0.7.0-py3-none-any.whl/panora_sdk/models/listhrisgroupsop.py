...
from .unifiedhrisgroupoutput import UnifiedHrisGroupOutput, UnifiedHrisGroupOutputTypedDict
...
class ListHrisGroupsRequestTypedDict(TypedDict):
...
class ListHrisGroupsRequest(BaseModel):
...
class ListHrisGroupsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisGroupOutputTypedDict]
    

class ListHrisGroupsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisGroupOutput]
...
class ListHrisGroupsResponseTypedDict(TypedDict):
    result: ListHrisGroupsResponseBodyTypedDict
    

class ListHrisGroupsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisGroupsResponse]]
