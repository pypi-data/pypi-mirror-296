...
class ListTicketingAttachmentsRequestTypedDict(TypedDict):
...
class ListTicketingAttachmentsRequest(BaseModel):
...
class ListTicketingAttachmentsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingAttachmentOutputTypedDict]
    

class ListTicketingAttachmentsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingAttachmentOutput]
...
class ListTicketingAttachmentsResponseTypedDict(TypedDict):
    result: ListTicketingAttachmentsResponseBodyTypedDict
    

class ListTicketingAttachmentsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketingAttachmentsResponse]]
