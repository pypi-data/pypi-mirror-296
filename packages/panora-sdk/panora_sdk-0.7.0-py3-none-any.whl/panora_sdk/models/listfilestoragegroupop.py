...
from .unifiedfilestoragegroupoutput import UnifiedFilestorageGroupOutput, UnifiedFilestorageGroupOutputTypedDict
...
class ListFilestorageGroupRequestTypedDict(TypedDict):
...
class ListFilestorageGroupRequest(BaseModel):
...
class ListFilestorageGroupResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedFilestorageGroupOutputTypedDict]
    

class ListFilestorageGroupResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedFilestorageGroupOutput]
...
class ListFilestorageGroupResponseTypedDict(TypedDict):
    result: ListFilestorageGroupResponseBodyTypedDict
    

class ListFilestorageGroupResponse(BaseModel):
    next: Callable[[], Optional[ListFilestorageGroupResponse]]
