...
from .unifiedmarketingautomationtemplateinput import UnifiedMarketingautomationTemplateInput, UnifiedMarketingautomationTemplateInputTypedDict
...
class CreateMarketingautomationTemplateRequestTypedDict(TypedDict):
...
class CreateMarketingautomationTemplateRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_marketingautomation_template_input: Annotated[UnifiedMarketingautomationTemplateInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
