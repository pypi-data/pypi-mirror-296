...
class ListCrmNoteRequestTypedDict(TypedDict):
...
class ListCrmNoteRequest(BaseModel):
...
class ListCrmNoteResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmNoteOutputTypedDict]
    

class ListCrmNoteResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmNoteOutput]
...
class ListCrmNoteResponseTypedDict(TypedDict):
    result: ListCrmNoteResponseBodyTypedDict
    

class ListCrmNoteResponse(BaseModel):
    next: Callable[[], Optional[ListCrmNoteResponse]]
