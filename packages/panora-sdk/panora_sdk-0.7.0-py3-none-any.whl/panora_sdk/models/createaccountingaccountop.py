...
from .unifiedaccountingaccountinput import UnifiedAccountingAccountInput, UnifiedAccountingAccountInputTypedDict
...
class CreateAccountingAccountRequestTypedDict(TypedDict):
    ...
    unified_accounting_account_input: UnifiedAccountingAccountInputTypedDict
...
class CreateAccountingAccountRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_accounting_account_input: Annotated[UnifiedAccountingAccountInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
