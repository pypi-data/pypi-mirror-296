...
from .unifiedecommerceorderinput import UnifiedEcommerceOrderInput, UnifiedEcommerceOrderInputTypedDict
...
class CreateEcommerceOrderRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_ecommerce_order_input: UnifiedEcommerceOrderInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Accounting software."""
    

class CreateEcommerceOrderRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_ecommerce_order_input: Annotated[UnifiedEcommerceOrderInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
