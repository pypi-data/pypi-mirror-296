...
from .unifiedatsactivityoutput import UnifiedAtsActivityOutput, UnifiedAtsActivityOutputTypedDict
...
class ListAtsActivityRequestTypedDict(TypedDict):
...
class ListAtsActivityRequest(BaseModel):
...
class ListAtsActivityResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsActivityOutputTypedDict]
    

class ListAtsActivityResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsActivityOutput]
...
class ListAtsActivityResponseTypedDict(TypedDict):
    result: ListAtsActivityResponseBodyTypedDict
    

class ListAtsActivityResponse(BaseModel):
    next: Callable[[], Optional[ListAtsActivityResponse]]
