...
class CreateTicketingCommentRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_ticketing_comment_input: UnifiedTicketingCommentInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Ticketing software."""
    

class CreateTicketingCommentRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_ticketing_comment_input: Annotated[UnifiedTicketingCommentInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
