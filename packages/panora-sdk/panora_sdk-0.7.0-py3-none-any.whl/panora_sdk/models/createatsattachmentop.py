...
from .unifiedatsattachmentinput import UnifiedAtsAttachmentInput, UnifiedAtsAttachmentInputTypedDict
...
class CreateAtsAttachmentRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_ats_attachment_input: UnifiedAtsAttachmentInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Ats software."""
    

class CreateAtsAttachmentRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_ats_attachment_input: Annotated[UnifiedAtsAttachmentInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
