...
from .unifiedhrisbenefitoutput import UnifiedHrisBenefitOutput, UnifiedHrisBenefitOutputTypedDict
...
class ListHrisBenefitsRequestTypedDict(TypedDict):
...
class ListHrisBenefitsRequest(BaseModel):
...
class ListHrisBenefitsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisBenefitOutputTypedDict]
    

class ListHrisBenefitsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisBenefitOutput]
...
class ListHrisBenefitsResponseTypedDict(TypedDict):
    result: ListHrisBenefitsResponseBodyTypedDict
    

class ListHrisBenefitsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisBenefitsResponse]]
