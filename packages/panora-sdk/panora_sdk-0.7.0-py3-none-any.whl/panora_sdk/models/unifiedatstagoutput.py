...
class UnifiedAtsTagOutputTypedDict(TypedDict):
    ...
    id_ats_candidate: NotRequired[Nullable[str]]
...
class UnifiedAtsTagOutput(BaseModel):
    ...
    r"""The name of the tag"""
    id_ats_candidate: OptionalNullable[str] = UNSET
    r"""The UUID of the candidate"""
    ...
    def serialize_model(self, handler):
        optional_fields = ["name", "id_ats_candidate", "field_mappings", "id", "remote_id", "remote_data", "created_at", "modified_at"]
        nullable_fields = ["name", "id_ats_candidate", "field_mappings", "id", "remote_id", "remote_data", "created_at", "modified_at"]
        null_default_fields = []
