...
from .unifiedmarketingautomationlistoutput import UnifiedMarketingautomationListOutput, UnifiedMarketingautomationListOutputTypedDict
...
class ListMarketingautomationListsRequestTypedDict(TypedDict):
...
class ListMarketingautomationListsRequest(BaseModel):
...
class ListMarketingautomationListsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationListOutputTypedDict]
    

class ListMarketingautomationListsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationListOutput]
...
class ListMarketingautomationListsResponseTypedDict(TypedDict):
    result: ListMarketingautomationListsResponseBodyTypedDict
    

class ListMarketingautomationListsResponse(BaseModel):
    next: Callable[[], Optional[ListMarketingautomationListsResponse]]
