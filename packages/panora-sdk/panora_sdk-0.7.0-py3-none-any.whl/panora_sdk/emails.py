...
class Emails(BaseSDK):
    ...
    def list(
        ...
        request = models.ListMarketingautomationEmailsRequest(
        ...
        req = self.build_request(
            method="GET",
            path="/marketingautomation/emails",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listMarketingautomationEmails", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListMarketingautomationEmailsResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListMarketingautomationEmailsResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedMarketingautomationEmailOutput]:
        r"""Retrieve Email

        Retrieve an Email from any connected Marketingautomation software

        :param x_connection_token: The connection token
        :param id: id of the email you want to retrieve.
        ...
        request = models.RetrieveMarketingautomationEmailRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        req = self.build_request(
            method="GET",
            path="/marketingautomation/emails/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveMarketingautomationEmail", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedMarketingautomationEmailOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
