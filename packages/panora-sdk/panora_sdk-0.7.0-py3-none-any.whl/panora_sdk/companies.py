...
class Companies(BaseSDK):
    ...
    def list(
        ...
        request = models.ListCrmCompanyRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listCrmCompany", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListCrmCompanyResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListCrmCompanyResponseBody]), next=next_func)
    ...
    def create(
        self, *,
        x_connection_token: str,
        unified_crm_company_input: Union[models.UnifiedCrmCompanyInput, models.UnifiedCrmCompanyInputTypedDict],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedCrmCompanyOutput]:
        r"""Create Companies
        ...
        request = models.CreateCrmCompanyRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_crm_company_input=utils.get_pydantic_model(unified_crm_company_input, models.UnifiedCrmCompanyInput),
        )
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.unified_crm_company_input, False, False, "json", models.UnifiedCrmCompanyInput),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedCrmCompanyOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def retrieve(
        ...
        request = models.RetrieveCrmCompanyRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveCrmCompany", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
