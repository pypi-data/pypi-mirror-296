...
class Creditnotes(BaseSDK):
    ...
    def list(
        ...
        request = models.ListAccountingCreditNoteRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listAccountingCreditNote", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAccountingCreditNoteResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListAccountingCreditNoteResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedAccountingCreditnoteOutput]:
        r"""Retrieve Credit Notes

        Retrieve Credit Notes from any connected Accounting software

        :param x_connection_token: The connection token
        :param id: id of the creditnote you want to retrieve.
        ...
        request = models.RetrieveAccountingCreditNoteRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        req = self.build_request(
            method="GET",
            path="/accounting/creditnotes/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveAccountingCreditNote", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedAccountingCreditnoteOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
