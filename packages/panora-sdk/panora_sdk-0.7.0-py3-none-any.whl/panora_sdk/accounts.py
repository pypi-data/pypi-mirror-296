...
class Accounts(BaseSDK):
    ...
    def list(
        ...
        request = models.ListTicketingAccountRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listTicketingAccount", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListTicketingAccountResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListTicketingAccountResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedTicketingAccountOutput]:
        r"""Retrieve Accounts
        ...
        request = models.RetrieveTicketingAccountRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveTicketingAccount", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedTicketingAccountOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
