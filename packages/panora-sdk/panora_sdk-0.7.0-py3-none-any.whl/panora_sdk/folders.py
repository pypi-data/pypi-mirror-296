...
class Folders(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListFilestorageFolderResponse:
        r"""List  Folders
        ...
        request = models.ListFilestorageFolderRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listFilestorageFolder", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        
        def next_func() -> Optional[models.ListFilestorageFolderResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListFilestorageFolderResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListFilestorageFolderResponseBody]), next=next_func)
    ...
    def create(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedFilestorageFolderOutput]:
        r"""Create Folders
        ...
        request = models.CreateFilestorageFolderRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.unified_filestorage_folder_input, False, False, "json", models.UnifiedFilestorageFolderInput),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="createFilestorageFolder", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedFilestorageFolderOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def retrieve(
        ...
        :param x_connection_token: The connection token
        :param id: id of the folder you want to retrieve.
        ...
        request = models.RetrieveFilestorageFolderRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveFilestorageFolder", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
