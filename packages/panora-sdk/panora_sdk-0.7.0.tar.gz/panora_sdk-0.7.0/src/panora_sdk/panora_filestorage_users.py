...
class PanoraFilestorageUsers(BaseSDK):
    ...
    def list(
        ...
        request = models.ListFilestorageUsersRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listFilestorageUsers", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListFilestorageUsersResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListFilestorageUsersResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        request = models.RetrieveFilestorageUserRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveFilestorageUser", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
