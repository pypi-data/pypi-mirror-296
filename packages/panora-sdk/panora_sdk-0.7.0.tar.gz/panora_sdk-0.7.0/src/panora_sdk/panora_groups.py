...
class PanoraGroups(BaseSDK):
    ...
    def list(
        ...
        request = models.ListFilestorageGroupRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listFilestorageGroup", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListFilestorageGroupResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListFilestorageGroupResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedFilestorageGroupOutput]:
        r"""Retrieve Groups

        Retrieve Groups from any connected Filestorage software

        :param x_connection_token: The connection token
        :param id: id of the permission you want to retrieve.
        ...
        request = models.RetrieveFilestorageGroupRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveFilestorageGroup", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedFilestorageGroupOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
