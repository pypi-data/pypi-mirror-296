...
class Timesheetentries(BaseSDK):
    ...
    def create(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedHrisTimesheetEntryOutput]:
        r"""Create Timesheetentrys
    ...
    def retrieve(
        ...
        r"""Retrieve Timesheetentry

        Retrieve an Timesheetentry from any connected Hris software

        :param x_connection_token: The connection token
        :param id: id of the timesheetentry you want to retrieve.
        :param remote_data: Set to true to include data from the original Hris software.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
