...
class Timeoffs(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListHrisTimeoffsResponse:
        r"""List Time Offs
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListHrisTimeoffsResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListHrisTimeoffsResponseBody]), next=next_func)
    ...
    def create(
        self, *,
        x_connection_token: str,
        unified_hris_timeoff_input: Union[models.UnifiedHrisTimeoffInput, models.UnifiedHrisTimeoffInputTypedDict],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.unified_hris_timeoff_input, False, False, "json", models.UnifiedHrisTimeoffInput),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="createHrisTimeoff", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedHrisTimeoffOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def retrieve(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveHrisTimeoff", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
