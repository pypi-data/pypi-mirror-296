...
class Contacts(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListTicketingContactsResponse:
        r"""List Contacts
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listTicketingContacts", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListTicketingContactsResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListTicketingContactsResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveTicketingContact", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.RetrieveTicketingContactResponseBody])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
