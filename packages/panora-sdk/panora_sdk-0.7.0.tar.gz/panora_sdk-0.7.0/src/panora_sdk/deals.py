...
class Deals(BaseSDK):
    ...
    def list(
        ...
        request = models.ListCrmDealsRequest(
        ...
        def next_func() -> Optional[models.ListCrmDealsResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListCrmDealsResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListCrmDealsResponseBody]), next=next_func)
    ...
    def create(
        self, *,
        x_connection_token: str,
        unified_crm_deal_input: Union[models.UnifiedCrmDealInput, models.UnifiedCrmDealInputTypedDict],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedCrmDealOutput]:
        r"""Create Deals

        Create Deals in any supported Crm software

        :param x_connection_token: The connection token
        :param unified_crm_deal_input: 
        ...
        request = models.CreateCrmDealRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_crm_deal_input=utils.get_pydantic_model(unified_crm_deal_input, models.UnifiedCrmDealInput),
        )
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.unified_crm_deal_input, False, False, "json", models.UnifiedCrmDealInput),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedCrmDealOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def retrieve(
        ...
        request = models.RetrieveCrmDealRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveCrmDeal", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
