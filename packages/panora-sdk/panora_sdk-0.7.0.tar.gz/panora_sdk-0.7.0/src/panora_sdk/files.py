...
class Files(BaseSDK):
    ...
    def list(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListFilestorageFileResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListFilestorageFileResponseBody]), next=next_func)
    ...
    def create(
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedFilestorageFileOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
