...
from .unifiedticketingcontactoutput import UnifiedTicketingContactOutput, UnifiedTicketingContactOutputTypedDict
...
class ListTicketingContactsRequestTypedDict(TypedDict):
...
class ListTicketingContactsRequest(BaseModel):
...
class ListTicketingContactsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingContactOutputTypedDict]
    

class ListTicketingContactsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingContactOutput]
...
class ListTicketingContactsResponseTypedDict(TypedDict):
    result: ListTicketingContactsResponseBodyTypedDict
    

class ListTicketingContactsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketingContactsResponse]]
