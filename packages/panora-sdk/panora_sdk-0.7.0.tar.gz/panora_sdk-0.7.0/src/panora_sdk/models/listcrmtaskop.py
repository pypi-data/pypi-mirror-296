...
class ListCrmTaskRequestTypedDict(TypedDict):
...
class ListCrmTaskRequest(BaseModel):
...
class ListCrmTaskResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmTaskOutputTypedDict]
    

class ListCrmTaskResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmTaskOutput]
...
class ListCrmTaskResponseTypedDict(TypedDict):
    result: ListCrmTaskResponseBodyTypedDict
    

class ListCrmTaskResponse(BaseModel):
    next: Callable[[], Optional[ListCrmTaskResponse]]
