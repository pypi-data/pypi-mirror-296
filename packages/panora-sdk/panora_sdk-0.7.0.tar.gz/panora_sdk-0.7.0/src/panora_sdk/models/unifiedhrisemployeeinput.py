...
class UnifiedHrisEmployeeInputFieldMappingsTypedDict(TypedDict):
    r"""The custom field mappings of the object between the remote 3rd party & Panora"""
    
    

class UnifiedHrisEmployeeInputFieldMappings(BaseModel):
    r"""The custom field mappings of the object between the remote 3rd party & Panora"""
    
    

class UnifiedHrisEmployeeInputTypedDict(TypedDict):
...
class UnifiedHrisEmployeeInput(BaseModel):
    ...
    r"""UUID of the manager (employee) of the employee"""
    field_mappings: OptionalNullable[UnifiedHrisEmployeeInputFieldMappings] = UNSET
    r"""The custom field mappings of the object between the remote 3rd party & Panora"""
    
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["groups", "locations", "employee_number", "company_id", "first_name", "last_name", "preferred_name", "display_full_name", "username", "work_email", "personal_email", "mobile_phone_number", "employments", "ssn", "gender", "ethnicity", "marital_status", "date_of_birth", "start_date", "employment_status", "termination_date", "avatar_url", "manager_id", "field_mappings"]
