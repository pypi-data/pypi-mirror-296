...
from .unifiedaccountingvendorcreditoutput import UnifiedAccountingVendorcreditOutput, UnifiedAccountingVendorcreditOutputTypedDict
...
class ListAccountingVendorCreditRequestTypedDict(TypedDict):
...
class ListAccountingVendorCreditRequest(BaseModel):
...
class ListAccountingVendorCreditResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingVendorcreditOutputTypedDict]
    

class ListAccountingVendorCreditResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingVendorcreditOutput]
...
class ListAccountingVendorCreditResponseTypedDict(TypedDict):
    result: ListAccountingVendorCreditResponseBodyTypedDict
    

class ListAccountingVendorCreditResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingVendorCreditResponse]]
