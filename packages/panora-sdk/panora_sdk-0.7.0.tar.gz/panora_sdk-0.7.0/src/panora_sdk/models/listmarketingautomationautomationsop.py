...
from .unifiedmarketingautomationautomationoutput import UnifiedMarketingautomationAutomationOutput, UnifiedMarketingautomationAutomationOutputTypedDict
...
class ListMarketingautomationAutomationsRequestTypedDict(TypedDict):
...
class ListMarketingautomationAutomationsRequest(BaseModel):
...
class ListMarketingautomationAutomationsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationAutomationOutputTypedDict]
    

class ListMarketingautomationAutomationsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationAutomationOutput]
...
class ListMarketingautomationAutomationsResponseTypedDict(TypedDict):
    result: ListMarketingautomationAutomationsResponseBodyTypedDict
    

class ListMarketingautomationAutomationsResponse(BaseModel):
