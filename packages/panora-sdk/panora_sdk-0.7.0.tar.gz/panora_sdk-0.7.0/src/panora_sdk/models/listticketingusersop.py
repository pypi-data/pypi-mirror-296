...
from .unifiedticketinguseroutput import UnifiedTicketingUserOutput, UnifiedTicketingUserOutputTypedDict
...
class ListTicketingUsersRequestTypedDict(TypedDict):
...
class ListTicketingUsersRequest(BaseModel):
...
class ListTicketingUsersResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingUserOutputTypedDict]
    

class ListTicketingUsersResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingUserOutput]
...
class ListTicketingUsersResponseTypedDict(TypedDict):
    result: ListTicketingUsersResponseBodyTypedDict
    

class ListTicketingUsersResponse(BaseModel):
    next: Callable[[], Optional[ListTicketingUsersResponse]]
