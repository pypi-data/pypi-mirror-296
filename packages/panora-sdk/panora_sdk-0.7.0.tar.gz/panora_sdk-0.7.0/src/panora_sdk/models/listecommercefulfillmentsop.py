...
from .unifiedecommercefulfillmentoutput import UnifiedEcommerceFulfillmentOutput, UnifiedEcommerceFulfillmentOutputTypedDict
...
class ListEcommerceFulfillmentsRequestTypedDict(TypedDict):
...
class ListEcommerceFulfillmentsRequest(BaseModel):
...
class ListEcommerceFulfillmentsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedEcommerceFulfillmentOutputTypedDict]
    

class ListEcommerceFulfillmentsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedEcommerceFulfillmentOutput]
...
class ListEcommerceFulfillmentsResponseTypedDict(TypedDict):
    result: ListEcommerceFulfillmentsResponseBodyTypedDict
    

class ListEcommerceFulfillmentsResponse(BaseModel):
    next: Callable[[], Optional[ListEcommerceFulfillmentsResponse]]
