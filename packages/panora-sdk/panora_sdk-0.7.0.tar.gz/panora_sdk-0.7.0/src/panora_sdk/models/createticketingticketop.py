...
class CreateTicketingTicketRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_ticketing_ticket_input: UnifiedTicketingTicketInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Ticketing software."""
    

class CreateTicketingTicketRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_ticketing_ticket_input: Annotated[UnifiedTicketingTicketInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
