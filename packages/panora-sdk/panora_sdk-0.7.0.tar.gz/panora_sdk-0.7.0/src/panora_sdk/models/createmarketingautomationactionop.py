...
from .unifiedmarketingautomationactioninput import UnifiedMarketingautomationActionInput, UnifiedMarketingautomationActionInputTypedDict
...
class CreateMarketingautomationActionRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_marketingautomation_action_input: UnifiedMarketingautomationActionInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Marketingautomation software."""
    

class CreateMarketingautomationActionRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_marketingautomation_action_input: Annotated[UnifiedMarketingautomationActionInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
