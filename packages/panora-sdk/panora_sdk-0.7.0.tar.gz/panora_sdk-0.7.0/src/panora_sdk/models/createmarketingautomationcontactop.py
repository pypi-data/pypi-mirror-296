...
from .unifiedmarketingautomationcontactinput import UnifiedMarketingautomationContactInput, UnifiedMarketingautomationContactInputTypedDict
...
class CreateMarketingAutomationContactRequestTypedDict(TypedDict):
...
class CreateMarketingAutomationContactRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_marketingautomation_contact_input: Annotated[UnifiedMarketingautomationContactInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
