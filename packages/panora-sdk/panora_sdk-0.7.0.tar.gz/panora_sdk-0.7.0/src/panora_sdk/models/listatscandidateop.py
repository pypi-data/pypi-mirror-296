...
from .unifiedatscandidateoutput import UnifiedAtsCandidateOutput, UnifiedAtsCandidateOutputTypedDict
...
class ListAtsCandidateRequestTypedDict(TypedDict):
...
class ListAtsCandidateRequest(BaseModel):
...
class ListAtsCandidateResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsCandidateOutputTypedDict]
    

class ListAtsCandidateResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsCandidateOutput]
...
class ListAtsCandidateResponseTypedDict(TypedDict):
    result: ListAtsCandidateResponseBodyTypedDict
    

class ListAtsCandidateResponse(BaseModel):
    next: Callable[[], Optional[ListAtsCandidateResponse]]
