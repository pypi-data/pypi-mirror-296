...
from .unifiedhrispayrollrunoutput import UnifiedHrisPayrollrunOutput, UnifiedHrisPayrollrunOutputTypedDict
...
class ListHrisPayrollRunsRequestTypedDict(TypedDict):
...
class ListHrisPayrollRunsRequest(BaseModel):
...
class ListHrisPayrollRunsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisPayrollrunOutputTypedDict]
    

class ListHrisPayrollRunsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisPayrollrunOutput]
...
class ListHrisPayrollRunsResponseTypedDict(TypedDict):
    result: ListHrisPayrollRunsResponseBodyTypedDict
    

class ListHrisPayrollRunsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisPayrollRunsResponse]]
