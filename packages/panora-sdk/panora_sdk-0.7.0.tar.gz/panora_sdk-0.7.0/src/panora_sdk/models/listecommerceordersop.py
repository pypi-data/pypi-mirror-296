...
from .unifiedecommerceorderoutput import UnifiedEcommerceOrderOutput, UnifiedEcommerceOrderOutputTypedDict
...
class ListEcommerceOrdersRequestTypedDict(TypedDict):
...
class ListEcommerceOrdersRequest(BaseModel):
...
class ListEcommerceOrdersResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedEcommerceOrderOutputTypedDict]
    

class ListEcommerceOrdersResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedEcommerceOrderOutput]
...
class ListEcommerceOrdersResponseTypedDict(TypedDict):
    result: ListEcommerceOrdersResponseBodyTypedDict
    

class ListEcommerceOrdersResponse(BaseModel):
    next: Callable[[], Optional[ListEcommerceOrdersResponse]]
