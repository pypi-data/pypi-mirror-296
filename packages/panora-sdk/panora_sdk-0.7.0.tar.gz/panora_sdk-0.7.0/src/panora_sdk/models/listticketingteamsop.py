...
from .unifiedticketingteamoutput import UnifiedTicketingTeamOutput, UnifiedTicketingTeamOutputTypedDict
...
class ListTicketingTeamsRequestTypedDict(TypedDict):
...
class ListTicketingTeamsRequest(BaseModel):
...
class ListTicketingTeamsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingTeamOutputTypedDict]
    

class ListTicketingTeamsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingTeamOutput]
...
class ListTicketingTeamsResponseTypedDict(TypedDict):
    result: ListTicketingTeamsResponseBodyTypedDict
    

class ListTicketingTeamsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketingTeamsResponse]]
