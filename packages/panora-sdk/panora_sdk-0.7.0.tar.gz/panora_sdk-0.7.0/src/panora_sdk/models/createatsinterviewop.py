...
from .unifiedatsinterviewinput import UnifiedAtsInterviewInput, UnifiedAtsInterviewInputTypedDict
...
class CreateAtsInterviewRequestTypedDict(TypedDict):
    ...
    unified_ats_interview_input: UnifiedAtsInterviewInputTypedDict
...
class CreateAtsInterviewRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_ats_interview_input: Annotated[UnifiedAtsInterviewInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
