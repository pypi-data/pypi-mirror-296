...
class RetrieveHrisTimesheetentryRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    id: str
    r"""id of the timesheetentry you want to retrieve."""
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Hris software."""
    

class RetrieveHrisTimesheetentryRequest(BaseModel):
