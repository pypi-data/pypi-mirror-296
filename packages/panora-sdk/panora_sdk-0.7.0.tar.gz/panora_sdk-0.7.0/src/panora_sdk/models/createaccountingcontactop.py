...
from .unifiedaccountingcontactinput import UnifiedAccountingContactInput, UnifiedAccountingContactInputTypedDict
...
class CreateAccountingContactRequestTypedDict(TypedDict):
    ...
    unified_accounting_contact_input: UnifiedAccountingContactInputTypedDict
...
class CreateAccountingContactRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_accounting_contact_input: Annotated[UnifiedAccountingContactInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
