...
class CreateHrisTimeoffRequestTypedDict(TypedDict):
    ...
    unified_hris_timeoff_input: UnifiedHrisTimeoffInputTypedDict
...
class CreateHrisTimeoffRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_hris_timeoff_input: Annotated[UnifiedHrisTimeoffInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
