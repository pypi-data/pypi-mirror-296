...
from .unifiedaccountingcreditnoteoutput import UnifiedAccountingCreditnoteOutput, UnifiedAccountingCreditnoteOutputTypedDict
...
class ListAccountingCreditNoteRequestTypedDict(TypedDict):
...
class ListAccountingCreditNoteRequest(BaseModel):
...
class ListAccountingCreditNoteResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingCreditnoteOutputTypedDict]
    

class ListAccountingCreditNoteResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingCreditnoteOutput]
...
class ListAccountingCreditNoteResponseTypedDict(TypedDict):
    result: ListAccountingCreditNoteResponseBodyTypedDict
    

class ListAccountingCreditNoteResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingCreditNoteResponse]]
