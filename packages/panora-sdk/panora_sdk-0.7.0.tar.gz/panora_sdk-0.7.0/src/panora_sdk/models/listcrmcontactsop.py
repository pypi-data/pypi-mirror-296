...
from .unifiedcrmcontactoutput import UnifiedCrmContactOutput, UnifiedCrmContactOutputTypedDict
...
class ListCrmContactsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmContactOutputTypedDict]
    

class ListCrmContactsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmContactOutput]
...
class ListCrmContactsResponseTypedDict(TypedDict):
    result: ListCrmContactsResponseBodyTypedDict
    

class ListCrmContactsResponse(BaseModel):
    next: Callable[[], Optional[ListCrmContactsResponse]]
