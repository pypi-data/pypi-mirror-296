...
from .unifiedaccountingbalancesheetoutput import UnifiedAccountingBalancesheetOutput, UnifiedAccountingBalancesheetOutputTypedDict
...
class ListAccountingBalanceSheetsRequestTypedDict(TypedDict):
...
class ListAccountingBalanceSheetsRequest(BaseModel):
...
class ListAccountingBalanceSheetsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingBalancesheetOutputTypedDict]
    

class ListAccountingBalanceSheetsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingBalancesheetOutput]
...
class ListAccountingBalanceSheetsResponseTypedDict(TypedDict):
    result: ListAccountingBalanceSheetsResponseBodyTypedDict
    

class ListAccountingBalanceSheetsResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingBalanceSheetsResponse]]
