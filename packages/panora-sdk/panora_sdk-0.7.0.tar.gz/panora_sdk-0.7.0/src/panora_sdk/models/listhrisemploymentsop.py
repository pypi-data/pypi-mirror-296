...
from .unifiedhrisemploymentoutput import UnifiedHrisEmploymentOutput, UnifiedHrisEmploymentOutputTypedDict
...
class ListHrisEmploymentsRequestTypedDict(TypedDict):
...
class ListHrisEmploymentsRequest(BaseModel):
...
class ListHrisEmploymentsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmploymentOutputTypedDict]
    

class ListHrisEmploymentsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmploymentOutput]
...
class ListHrisEmploymentsResponseTypedDict(TypedDict):
    result: ListHrisEmploymentsResponseBodyTypedDict
    

class ListHrisEmploymentsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisEmploymentsResponse]]
