...
from .unifiedaccountingpurchaseorderinput import UnifiedAccountingPurchaseorderInput, UnifiedAccountingPurchaseorderInputTypedDict
...
class CreateAccountingPurchaseOrderRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_accounting_purchaseorder_input: UnifiedAccountingPurchaseorderInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Accounting software."""
    

class CreateAccountingPurchaseOrderRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_accounting_purchaseorder_input: Annotated[UnifiedAccountingPurchaseorderInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
