...
class ListTicketingCollectionsRequestTypedDict(TypedDict):
...
class ListTicketingCollectionsRequest(BaseModel):
...
class ListTicketingCollectionsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingCollectionOutputTypedDict]
    

class ListTicketingCollectionsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingCollectionOutput]
...
class ListTicketingCollectionsResponseTypedDict(TypedDict):
    result: ListTicketingCollectionsResponseBodyTypedDict
    

class ListTicketingCollectionsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketingCollectionsResponse]]
