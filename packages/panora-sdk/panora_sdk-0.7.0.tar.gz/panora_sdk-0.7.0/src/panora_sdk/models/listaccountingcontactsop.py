...
from .unifiedaccountingcontactoutput import UnifiedAccountingContactOutput, UnifiedAccountingContactOutputTypedDict
...
class ListAccountingContactsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingContactOutputTypedDict]
    

class ListAccountingContactsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingContactOutput]
...
class ListAccountingContactsResponseTypedDict(TypedDict):
    result: ListAccountingContactsResponseBodyTypedDict
    

class ListAccountingContactsResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingContactsResponse]]
