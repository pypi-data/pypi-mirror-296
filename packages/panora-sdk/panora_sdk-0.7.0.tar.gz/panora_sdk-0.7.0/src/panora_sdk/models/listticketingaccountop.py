...
from .unifiedticketingaccountoutput import UnifiedTicketingAccountOutput, UnifiedTicketingAccountOutputTypedDict
...
class ListTicketingAccountRequestTypedDict(TypedDict):
...
class ListTicketingAccountRequest(BaseModel):
...
class ListTicketingAccountResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingAccountOutputTypedDict]
    

class ListTicketingAccountResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingAccountOutput]
...
class ListTicketingAccountResponseTypedDict(TypedDict):
    result: ListTicketingAccountResponseBodyTypedDict
    

class ListTicketingAccountResponse(BaseModel):
    next: Callable[[], Optional[ListTicketingAccountResponse]]
