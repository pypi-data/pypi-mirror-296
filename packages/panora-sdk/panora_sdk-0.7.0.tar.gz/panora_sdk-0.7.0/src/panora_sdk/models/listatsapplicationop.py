...
class ListAtsApplicationRequestTypedDict(TypedDict):
...
class ListAtsApplicationRequest(BaseModel):
...
class ListAtsApplicationResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsApplicationOutputTypedDict]
    

class ListAtsApplicationResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsApplicationOutput]
...
class ListAtsApplicationResponseTypedDict(TypedDict):
    result: ListAtsApplicationResponseBodyTypedDict
    

class ListAtsApplicationResponse(BaseModel):
    next: Callable[[], Optional[ListAtsApplicationResponse]]
