...
from .unifiedmarketingautomationactionoutput import UnifiedMarketingautomationActionOutput, UnifiedMarketingautomationActionOutputTypedDict
...
class ListMarketingautomationActionRequestTypedDict(TypedDict):
...
class ListMarketingautomationActionRequest(BaseModel):
...
class ListMarketingautomationActionResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationActionOutputTypedDict]
    

class ListMarketingautomationActionResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationActionOutput]
...
class ListMarketingautomationActionResponseTypedDict(TypedDict):
    result: ListMarketingautomationActionResponseBodyTypedDict
    

class ListMarketingautomationActionResponse(BaseModel):
    next: Callable[[], Optional[ListMarketingautomationActionResponse]]
