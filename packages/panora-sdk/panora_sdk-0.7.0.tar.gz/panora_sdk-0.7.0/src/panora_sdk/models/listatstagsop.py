...
class ListAtsTagsRequestTypedDict(TypedDict):
...
class ListAtsTagsRequest(BaseModel):
...
class ListAtsTagsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsTagOutputTypedDict]
    

class ListAtsTagsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsTagOutput]
...
class ListAtsTagsResponseTypedDict(TypedDict):
    result: ListAtsTagsResponseBodyTypedDict
    

class ListAtsTagsResponse(BaseModel):
    next: Callable[[], Optional[ListAtsTagsResponse]]
