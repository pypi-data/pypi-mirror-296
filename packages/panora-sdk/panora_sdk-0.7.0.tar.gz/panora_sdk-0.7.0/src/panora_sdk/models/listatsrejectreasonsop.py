...
from .unifiedatsrejectreasonoutput import UnifiedAtsRejectreasonOutput, UnifiedAtsRejectreasonOutputTypedDict
...
class ListAtsRejectReasonsRequestTypedDict(TypedDict):
...
class ListAtsRejectReasonsRequest(BaseModel):
...
class ListAtsRejectReasonsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsRejectreasonOutputTypedDict]
    

class ListAtsRejectReasonsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsRejectreasonOutput]
...
class ListAtsRejectReasonsResponseTypedDict(TypedDict):
    result: ListAtsRejectReasonsResponseBodyTypedDict
    

class ListAtsRejectReasonsResponse(BaseModel):
    next: Callable[[], Optional[ListAtsRejectReasonsResponse]]
