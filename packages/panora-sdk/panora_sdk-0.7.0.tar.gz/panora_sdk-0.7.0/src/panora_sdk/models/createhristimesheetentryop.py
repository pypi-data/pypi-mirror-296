...
from .unifiedhristimesheetentryinput import UnifiedHrisTimesheetEntryInput, UnifiedHrisTimesheetEntryInputTypedDict
...
class CreateHrisTimesheetentryRequestTypedDict(TypedDict):
    x_connection_token: str
    r"""The connection token"""
    unified_hris_timesheet_entry_input: UnifiedHrisTimesheetEntryInputTypedDict
    remote_data: NotRequired[bool]
    r"""Set to true to include data from the original Hris software."""
    

class CreateHrisTimesheetentryRequest(BaseModel):
    ...
    r"""The connection token"""
    unified_hris_timesheet_entry_input: Annotated[UnifiedHrisTimesheetEntryInput, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
