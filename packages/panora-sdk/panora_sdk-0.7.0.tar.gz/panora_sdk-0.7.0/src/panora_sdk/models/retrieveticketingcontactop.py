...
class RetrieveTicketingContactRequestTypedDict(TypedDict):
...
class RetrieveTicketingContactRequest(BaseModel):
...
class RetrieveTicketingContactResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedTicketingContactOutputTypedDict]
    

class RetrieveTicketingContactResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
