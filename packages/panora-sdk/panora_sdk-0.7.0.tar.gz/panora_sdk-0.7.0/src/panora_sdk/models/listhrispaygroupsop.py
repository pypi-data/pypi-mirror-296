...
from .unifiedhrispaygroupoutput import UnifiedHrisPaygroupOutput, UnifiedHrisPaygroupOutputTypedDict
...
class ListHrisPaygroupsRequestTypedDict(TypedDict):
...
class ListHrisPaygroupsRequest(BaseModel):
...
class ListHrisPaygroupsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisPaygroupOutputTypedDict]
    

class ListHrisPaygroupsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisPaygroupOutput]
...
class ListHrisPaygroupsResponseTypedDict(TypedDict):
    result: ListHrisPaygroupsResponseBodyTypedDict
    

class ListHrisPaygroupsResponse(BaseModel):
    next: Callable[[], Optional[ListHrisPaygroupsResponse]]
