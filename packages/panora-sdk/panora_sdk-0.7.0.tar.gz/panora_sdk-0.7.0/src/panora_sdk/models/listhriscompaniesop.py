...
from .unifiedhriscompanyoutput import UnifiedHrisCompanyOutput, UnifiedHrisCompanyOutputTypedDict
...
class ListHrisCompaniesRequestTypedDict(TypedDict):
...
class ListHrisCompaniesRequest(BaseModel):
...
class ListHrisCompaniesResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisCompanyOutputTypedDict]
    

class ListHrisCompaniesResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisCompanyOutput]
...
class ListHrisCompaniesResponseTypedDict(TypedDict):
    result: ListHrisCompaniesResponseBodyTypedDict
    

class ListHrisCompaniesResponse(BaseModel):
    next: Callable[[], Optional[ListHrisCompaniesResponse]]
