...
from .unifiedcrmcompanyoutput import UnifiedCrmCompanyOutput, UnifiedCrmCompanyOutputTypedDict
...
class ListCrmCompanyRequestTypedDict(TypedDict):
...
class ListCrmCompanyRequest(BaseModel):
...
class ListCrmCompanyResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmCompanyOutputTypedDict]
    

class ListCrmCompanyResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedCrmCompanyOutput]
...
class ListCrmCompanyResponseTypedDict(TypedDict):
    result: ListCrmCompanyResponseBodyTypedDict
