...
from .unifiedaccountingpaymentoutput import UnifiedAccountingPaymentOutput, UnifiedAccountingPaymentOutputTypedDict
...
class ListAccountingPaymentRequestTypedDict(TypedDict):
...
class ListAccountingPaymentRequest(BaseModel):
...
class ListAccountingPaymentResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingPaymentOutputTypedDict]
    

class ListAccountingPaymentResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingPaymentOutput]
...
class ListAccountingPaymentResponseTypedDict(TypedDict):
    result: ListAccountingPaymentResponseBodyTypedDict
    

class ListAccountingPaymentResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingPaymentResponse]]
