...
class ListFilestorageUsersRequestTypedDict(TypedDict):
...
class ListFilestorageUsersRequest(BaseModel):
...
class ListFilestorageUsersResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedFilestorageUserOutputTypedDict]
    

class ListFilestorageUsersResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedFilestorageUserOutput]
...
class ListFilestorageUsersResponseTypedDict(TypedDict):
    result: ListFilestorageUsersResponseBodyTypedDict
    

class ListFilestorageUsersResponse(BaseModel):
    next: Callable[[], Optional[ListFilestorageUsersResponse]]
