...
class ListAtsEeocsRequestTypedDict(TypedDict):
...
class ListAtsEeocsRequest(BaseModel):
...
class ListAtsEeocsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsEeocsOutputTypedDict]
    

class ListAtsEeocsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsEeocsOutput]
...
class ListAtsEeocsResponseTypedDict(TypedDict):
    result: ListAtsEeocsResponseBodyTypedDict
    

class ListAtsEeocsResponse(BaseModel):
    next: Callable[[], Optional[ListAtsEeocsResponse]]
