...
from .unifiedatsdepartmentoutput import UnifiedAtsDepartmentOutput, UnifiedAtsDepartmentOutputTypedDict
...
class ListAtsDepartmentsRequestTypedDict(TypedDict):
...
class ListAtsDepartmentsRequest(BaseModel):
...
class ListAtsDepartmentsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsDepartmentOutputTypedDict]
    

class ListAtsDepartmentsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAtsDepartmentOutput]
...
class ListAtsDepartmentsResponseTypedDict(TypedDict):
    result: ListAtsDepartmentsResponseBodyTypedDict
    

class ListAtsDepartmentsResponse(BaseModel):
    next: Callable[[], Optional[ListAtsDepartmentsResponse]]
