...
from .unifiedmarketingautomationuseroutput import UnifiedMarketingautomationUserOutput, UnifiedMarketingautomationUserOutputTypedDict
...
class ListMarketingAutomationUsersRequestTypedDict(TypedDict):
...
class ListMarketingAutomationUsersRequest(BaseModel):
...
class ListMarketingAutomationUsersResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationUserOutputTypedDict]
    

class ListMarketingAutomationUsersResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationUserOutput]
...
class ListMarketingAutomationUsersResponseTypedDict(TypedDict):
    result: ListMarketingAutomationUsersResponseBodyTypedDict
    

class ListMarketingAutomationUsersResponse(BaseModel):
    next: Callable[[], Optional[ListMarketingAutomationUsersResponse]]
