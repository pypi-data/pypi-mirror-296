...
from .unifiedaccountingitemoutput import UnifiedAccountingItemOutput, UnifiedAccountingItemOutputTypedDict
...
class ListAccountingItemRequestTypedDict(TypedDict):
...
class ListAccountingItemRequest(BaseModel):
...
class ListAccountingItemResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingItemOutputTypedDict]
    

class ListAccountingItemResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedAccountingItemOutput]
...
class ListAccountingItemResponseTypedDict(TypedDict):
    result: ListAccountingItemResponseBodyTypedDict
    

class ListAccountingItemResponse(BaseModel):
    next: Callable[[], Optional[ListAccountingItemResponse]]
