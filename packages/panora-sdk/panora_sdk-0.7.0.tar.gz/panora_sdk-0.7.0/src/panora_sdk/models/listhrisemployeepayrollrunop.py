...
from .unifiedhrisemployeepayrollrunoutput import UnifiedHrisEmployeepayrollrunOutput, UnifiedHrisEmployeepayrollrunOutputTypedDict
...
class ListHrisEmployeePayrollRunRequestTypedDict(TypedDict):
...
class ListHrisEmployeePayrollRunRequest(BaseModel):
...
class ListHrisEmployeePayrollRunResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmployeepayrollrunOutputTypedDict]
    

class ListHrisEmployeePayrollRunResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedHrisEmployeepayrollrunOutput]
...
class ListHrisEmployeePayrollRunResponseTypedDict(TypedDict):
    result: ListHrisEmployeePayrollRunResponseBodyTypedDict
    

class ListHrisEmployeePayrollRunResponse(BaseModel):
    next: Callable[[], Optional[ListHrisEmployeePayrollRunResponse]]
