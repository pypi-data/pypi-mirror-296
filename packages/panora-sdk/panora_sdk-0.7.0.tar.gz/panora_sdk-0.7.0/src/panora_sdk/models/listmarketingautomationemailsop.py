...
from .unifiedmarketingautomationemailoutput import UnifiedMarketingautomationEmailOutput, UnifiedMarketingautomationEmailOutputTypedDict
...
class ListMarketingautomationEmailsRequestTypedDict(TypedDict):
...
class ListMarketingautomationEmailsRequest(BaseModel):
...
class ListMarketingautomationEmailsResponseBodyTypedDict(TypedDict):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationEmailOutputTypedDict]
    

class ListMarketingautomationEmailsResponseBody(BaseModel):
    prev_cursor: Nullable[str]
    next_cursor: Nullable[str]
    data: List[UnifiedMarketingautomationEmailOutput]
...
class ListMarketingautomationEmailsResponseTypedDict(TypedDict):
    result: ListMarketingautomationEmailsResponseBodyTypedDict
    

class ListMarketingautomationEmailsResponse(BaseModel):
    next: Callable[[], Optional[ListMarketingautomationEmailsResponse]]
