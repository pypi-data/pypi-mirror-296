...
class Templates(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListMarketingautomationTemplatesResponse:
        r"""List Templates
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListMarketingautomationTemplatesResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListMarketingautomationTemplatesResponseBody]), next=next_func)
    ...
    def create(
        self, *,
        x_connection_token: str,
        unified_marketingautomation_template_input: Union[models.UnifiedMarketingautomationTemplateInput, models.UnifiedMarketingautomationTemplateInputTypedDict],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.CreateMarketingautomationTemplateRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_marketingautomation_template_input=utils.get_pydantic_model(unified_marketingautomation_template_input, models.UnifiedMarketingautomationTemplateInput),
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedMarketingautomationTemplateOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
