...
class Companyinfos(BaseSDK):
    ...
    def list(
        ...
        request = models.ListAccountingCompanyInfosRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listAccountingCompanyInfos", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAccountingCompanyInfosResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListAccountingCompanyInfosResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedAccountingCompanyinfoOutput]:
        r"""Retrieve Company Infos

        Retrieve Company Infos from any connected Accounting software

        :param x_connection_token: The connection token
        :param id: id of the companyinfo you want to retrieve.
        ...
        request = models.RetrieveAccountingCompanyInfoRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveAccountingCompanyInfo", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedAccountingCompanyinfoOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
