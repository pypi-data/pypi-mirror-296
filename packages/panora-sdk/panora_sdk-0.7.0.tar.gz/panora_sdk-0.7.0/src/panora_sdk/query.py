...
class Query(BaseSDK):
    ...
    def query(
        ...
        query_body: Union[models.QueryBody, models.QueryBodyTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.QueryResponseBody]:
        r"""Query using RAG Search
        ...
        request = models.QueryRequest(
            ...
            query_body=utils.get_pydantic_model(query_body, models.QueryBody),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.query_body, False, False, "json", models.QueryBody),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.QueryResponseBody])
