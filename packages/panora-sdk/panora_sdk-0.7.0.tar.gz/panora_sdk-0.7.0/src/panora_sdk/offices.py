...
class Offices(BaseSDK):
    ...
    def list(
        ...
        request = models.ListAtsOfficeRequest(
        ...
        def next_func() -> Optional[models.ListAtsOfficeResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAtsOfficeResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListAtsOfficeResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedAtsOfficeOutput]:
        r"""Retrieve Offices

        Retrieve Offices from any connected Ats software

        :param x_connection_token: The connection token
        :param id: id of the office you want to retrieve.
        ...
        request = models.RetrieveAtsOfficeRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedAtsOfficeOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
