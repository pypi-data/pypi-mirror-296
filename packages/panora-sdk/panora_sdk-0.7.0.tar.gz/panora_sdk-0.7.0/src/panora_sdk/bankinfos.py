...
class Bankinfos(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListHrisBankInfoResponse:
        r"""List Bank Info
        ...
        def next_func() -> Optional[models.ListHrisBankInfoResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListHrisBankInfoResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListHrisBankInfoResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedHrisBankinfoOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
