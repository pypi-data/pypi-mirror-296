...
class Users(BaseSDK):
    ...
    def list(
    ...
    ) -> models.ListTicketingUsersResponse:
        r"""List Users
        ...
        request = models.ListTicketingUsersRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listTicketingUsers", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        
        def next_func() -> Optional[models.ListTicketingUsersResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListTicketingUsersResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListTicketingUsersResponseBody]), next=next_func)
    ...
    def retrieve(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.UnifiedTicketingUserOutput]:
        r"""Retrieve User
        ...
        request = models.RetrieveTicketingUserRequest(
            x_connection_token=x_connection_token,
            id=id,
            remote_data=remote_data,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="retrieveTicketingUser", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.UnifiedTicketingUserOutput])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
