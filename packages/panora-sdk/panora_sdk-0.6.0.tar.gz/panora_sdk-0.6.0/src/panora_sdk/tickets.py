...
class Tickets(BaseSDK):
        ...
        *,
    ...
    ) -> Optional[models.ListTicketingTicketResponse]:
        r"""List  Tickets
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listTicketingTicket",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListTicketingTicketResponse(
                result=utils.unmarshal_json(
                    http_res.text, Optional[models.ListTicketingTicketResponseBody]
                ),
                next=next_func,
            )
    ...
    def create(
        ...
        *,
        x_connection_token: str,
        unified_ticketing_ticket_input: Union[
            models.UnifiedTicketingTicketInput,
            models.UnifiedTicketingTicketInputTypedDict,
        ],
        remote_data: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.CreateTicketingTicketRequest(
            x_connection_token=x_connection_token,
            remote_data=remote_data,
            unified_ticketing_ticket_input=utils.get_pydantic_model(
                unified_ticketing_ticket_input, models.UnifiedTicketingTicketInput
            ),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.unified_ticketing_ticket_input,
                False,
                False,
                "json",
                models.UnifiedTicketingTicketInput,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.UnifiedTicketingTicketOutput]
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
    ...
    def retrieve(
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveTicketingTicket",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
