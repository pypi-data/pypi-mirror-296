...
def load_model_and_inference_fn(inference_function_name_key: str, inference_decorator: Callable = None, device_map="auto"):
    """
...
def lisa_predict(
    ...
    load_model_and_inference_fn(inference_function_name_key, inference_decorator=inference_decorator, device_map=device_map)
