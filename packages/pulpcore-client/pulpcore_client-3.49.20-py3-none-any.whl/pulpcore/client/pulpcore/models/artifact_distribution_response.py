...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_last_updated=None, name=None, pulp_labels=None, base_path=None, pulp_created=None, base_url=None, hidden=False, pulp_href=None, local_vars_configuration=None):  # noqa: E501
