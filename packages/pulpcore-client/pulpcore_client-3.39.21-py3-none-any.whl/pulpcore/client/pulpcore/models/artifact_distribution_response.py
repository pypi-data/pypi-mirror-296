...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_labels=None, content_guard=None, base_path=None, hidden=False, pulp_created=None, name=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
