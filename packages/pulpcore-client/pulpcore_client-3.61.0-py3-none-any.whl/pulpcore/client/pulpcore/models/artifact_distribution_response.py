...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, content_guard=None, base_path=None, pulp_last_updated=None, pulp_href=None, no_content_change_since=None, hidden=False, pulp_created=None, base_url=None, local_vars_configuration=None):  # noqa: E501
