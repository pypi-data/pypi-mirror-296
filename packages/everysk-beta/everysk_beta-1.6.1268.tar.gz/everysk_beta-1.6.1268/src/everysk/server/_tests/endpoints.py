        ...
        log.assert_called_once_with(
            ...
            extra={
                ...
                'traceback': (
                    ...
                    '  File "/var/app/src/everysk/server/endpoints.py", line 116, in dispatch\n'
                    '    response = await self.get_http_response()\n'
                    '               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n'
                    '  File "/var/app/src/everysk/server/endpoints.py", line 156, in get_http_response\n'
        ...
        log.assert_called_once_with(
            ...
            extra={
                ...
                'traceback': (
                    ...
                    '    response = await self.get_http_response()\n'
                    '               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n'
                    '  File "/var/app/src/everysk/server/endpoints.py", line 245, in get_http_response\n'
