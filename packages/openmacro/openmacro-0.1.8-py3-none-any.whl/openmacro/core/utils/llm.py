...
class LLM:
    def __init__(self, profile, verbose=False, messages: list = None, system=""):
        ...
        self.llm = SnSdk("Meta-Llama-3.1-405B-Instruct",
                         ...
                         priority=0,
                         system=self.system,
                         access_token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJqb2xseW9sbGllYnJvd25AZ21haWwuY29tIiwiZXhwIjoxNzI2NDk0MzM0LCJqdGkiOiJqb2xseW9sbGllYnJvd25AZ21haWwuY29tMTcyNjQ5NDMzNGRGT3BKZyJ9.jXvCA0KemUdXleE-Y4c3UTCahaWXmX5nGunP9bnhJTE",
