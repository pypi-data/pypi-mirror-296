...
DEFAULT_CONFIG_FILE_PATH = os.path.join(CURRENT_DIR, 'middleware.ini')
CONFIG_FILE_PATH = os.getenv('MIDDLEWARE_CONFIG_FILE',os.getcwd())
...
class Config:
    ...
    def __init__(self):
        ...
        self.log_level = self.get_config("middleware.common", "log_level", "WARNING")
