...
class TargetArduinoCore(TargetBase):
    ...
    def _gen_core_cpp_compile(self):
        ...
        for src, obj in src_files:
            ...
            self._writeln(
                f'\t{self._shared.cpp} {self._shared.cpp_opts} {self._inc_dirs} {self._compile_opts} {src} -o {obj}')
    ...
    def _gen_core_c_compile(self):
        ...
        for src, obj in src_files:
            ...
            self._writeln(f'{obj}: {src}')
            self._writeln(
                f'\t{self._shared.cc} {self._shared.cc_opts} {self._inc_dirs} {self._compile_opts} {src} -o {obj}')
            self._objs.append(obj)
