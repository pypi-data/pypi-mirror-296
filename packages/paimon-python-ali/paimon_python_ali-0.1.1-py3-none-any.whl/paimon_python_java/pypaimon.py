...
def _inject_options(catalog_options: dict):
    metastore = catalog_options.get('metastore')
    if metastore and 'dlf' in metastore:
        catalog_options['get.data.token.in.catalog'] = 'true'
        catalog_options['dlf.tokenCache.data.credential.provider'] = \
            'com.aliyun.datalake.common.credential.DlfDataTokenCredentialsProvider'
        catalog_options['dlf.tokenCache.meta.credential.provider'] = \
            'com.aliyun.datalake.common.credential.SimpleCredentialsProvider'
...
class Catalog(catalog.Catalog):
    ...
    def create(catalog_options: dict) -> 'Catalog':
        _inject_options(catalog_options)
