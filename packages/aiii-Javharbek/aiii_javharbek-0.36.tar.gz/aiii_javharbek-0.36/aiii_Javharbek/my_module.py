...
def resize_image_correct_polygons2(resize_info, polygon):
    ...
    :param polygon: List of coordinates in the format [(x1, y1), (x2, y2), (x3, y3), ...] or [[x1, y1], [x2, y2], [x3, y3], ...].
    ...
    for point in polygon:
        ...
        if isinstance(point, (list, tuple)) and len(point) == 2:
            ...
            raise ValueError(f"Invalid point format: {point}. Each point should be a tuple (x, y) or list [x, y].")
