...
def preprocced_image(image, polygon_cords = None, is_show=False, isResize=True, resizeWidth=1024, resizeHeight=1448, cropWidth=1024, cropHeight=362,polygon_cords_check = None):
