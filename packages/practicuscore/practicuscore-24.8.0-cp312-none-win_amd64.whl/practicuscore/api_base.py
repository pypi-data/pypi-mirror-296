...
from typing import List, Optional, Union, cast, Type, Tuple, TYPE_CHECKING
...
class PRTValidator(ABC):
    @staticmethod
    def validate(pydantic_obj: BaseModel) -> Tuple[Optional[str], Optional[str]]:
        """
