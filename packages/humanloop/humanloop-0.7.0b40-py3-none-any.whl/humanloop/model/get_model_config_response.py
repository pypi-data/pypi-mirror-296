...
class GetModelConfigResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project_id", "project_name", "created_at", "updated_at", "last_used", "config", "num_datapoints", "evaluation_aggregates", "environment_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project_id", "project_name", "created_at", "updated_at", "last_used", "config", "num_datapoints", "evaluation_aggregates", "environment_id", ], str]):
