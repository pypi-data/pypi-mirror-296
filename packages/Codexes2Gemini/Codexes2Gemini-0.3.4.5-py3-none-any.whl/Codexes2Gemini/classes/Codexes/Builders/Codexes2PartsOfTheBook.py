...
class Codexes2Parts:
    ...
    def __init__(self):
        ...
        self.system_instructions_dict_file_path = resources.files('Codexes2Gemini.resources.prompts').joinpath(self.system_instructions_dict_file_name)
    ...
    def assemble_system_prompt(self, plan):
        ...
        if plan.complete_system_instruction:
            ...
            if not systems_instructions_dict_file_path.existss():
