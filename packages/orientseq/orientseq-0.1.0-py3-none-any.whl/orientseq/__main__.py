...
def parse_arguments():
  ...
  parser.add_argument('--threshold', type=int, default=5, help='maximum possible difference between polyA and polyT to count as ambigous')
  parser.add_argument('--ambigous', help='output file for ambigous reads, not printed anywhere by default')
