...
def get_new_data_map_old(database: str, tableName: str, queryTime: str, pointList: List[str],
...
def get_new_data_map(database: str, tableName: str, queryTime: str, pointList: List[str],
    ...
    # 分批处理
    batch_size = 100
    for i in range(0, len(pointList), batch_size):
        batch_points = pointList[i:i + batch_size]
        point_str = '|'.join(batch_points)
