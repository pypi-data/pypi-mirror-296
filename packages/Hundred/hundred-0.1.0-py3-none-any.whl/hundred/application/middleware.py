...
type MiddlewareGenerator[T] = AsyncGenerator[None, T | None]
type Middleware[**P, T] = Callable[P, MiddlewareGenerator[T]]
...
class MiddlewareGroup[**P, T]:
    ...
    def __apply_middleware(
        ...
        async def wrapper(*args: P.args, **kwargs: P.kwargs) -> T | None:
            generator: MiddlewareGenerator[T] = middleware(*args, **kwargs)
            value: T | None = None
