...
class NextCallGenerator:
    ...
    def check_runs_not_in_dqmgui(self, run_list: list[int]):
        ...
        """
        dqmgui = DQMGUI(AUTH_CERT, AUTH_CERT_KEY)
    ...
    def generate(self):
        ...
        # Fifth step: check for bril x rr mismatches
        rr_oms_bril_mismatches = self.check_rr_oms_bril_mismatches(final_run_list, bril_by_run)
        ...
        return {
            ...
            "rr_oms_bril_mismatches": rr_oms_bril_mismatches,
