...
class EraPlotter:
    ...
    def plot_dc_efficiency_per_era(self):
        ...
        # Save fig
        outpath = os.path.join(self.output_path, "dc_efficiency_per_era.png")
        fig.savefig(outpath)
