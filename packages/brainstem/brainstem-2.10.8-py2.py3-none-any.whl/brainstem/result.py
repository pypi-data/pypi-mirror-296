...
class Result(object):
    ...
    def getErrorDescription(error):
        ...
        """
        return ffi.string(_BS_C.aError_GetErrorDescription(Result.__getError(error)), 100)
    ...
    def __getErrorText(error):
        ...
        # return ffi.string(_BS_C.aError_GetErrorText(the_error), 100)
