...
try:
    ...
    # Linux... So many Linux's...
        ...
        pathList = [os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'x86_64',  'Ubuntu', '22.04', 'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'x86_64',  'Ubuntu', '20.04', 'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'x86_64',  'Ubuntu', '18.04', 'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'x86_64',  'Ubuntu', '16.04', 'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'aarch64', 'Ubuntu', '16.04', 'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'aarch64', 'Ubuntu', '18.04', 'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'aarch64', 'Ubuntu', '20.04', 'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'armv7l',  'debian', '11.7' ,  'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'x86_64',  'debian', '12'   ,  'libBrainStem2.so'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Linux', 'i686'  ,  'Ubuntu', '16.04', 'libBrainStem2.so')]
