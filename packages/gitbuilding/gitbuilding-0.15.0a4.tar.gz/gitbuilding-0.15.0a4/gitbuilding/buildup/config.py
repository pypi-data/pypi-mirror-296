...
class ConfigSchema(Schema):
    ...
    target_format =  fields.Str(missing='html', data_key='OutputType')
    ...
    exsource_def = fields.Str(missing=None, allow_none=True, data_key='ExSourceDef')
    exsource_out = fields.Str(missing=None, allow_none=True, data_key='ExSourceOut')
