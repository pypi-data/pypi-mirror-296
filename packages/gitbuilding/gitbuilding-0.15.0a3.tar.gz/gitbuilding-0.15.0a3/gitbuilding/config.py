...
class GBConfigSchema(ConfigSchema):
    ...
    include_search = fields.Bool(missing="True", data_key='IncludeSearch')
    ...
    remove_images_border = fields.Bool(missing=None,
                                       allow_none=True,
                                       data_key="RemoveImagesBorder")
    remove_images_background = fields.Bool(missing=None,
                                           allow_none=True,
    ...
    # Allow custom tab length: https://python-markdown.github.io/reference/#tab_length
    tab_length = fields.Int(missing=4, allow_none=False, data_key='TabLength')
