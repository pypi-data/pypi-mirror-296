...
class TestUser:
    ...
    def test_method_retrieve(self, client: Pyopenwebui) -> None:
        user = client.functions.valves.user.retrieve(
            "id",
        )
    ...
    def test_raw_response_retrieve(self, client: Pyopenwebui) -> None:
        response = client.functions.valves.user.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Pyopenwebui) -> None:
        with client.functions.valves.user.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.functions.valves.user.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Pyopenwebui) -> None:
        user = client.functions.valves.user.update(
            id="id",
            body={},
        )
        assert_matches_type(object, user, path=["response"])
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.functions.valves.user.with_raw_response.update(
            id="id",
            body={},
        )
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.functions.valves.user.with_streaming_response.update(
            id="id",
            body={},
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.functions.valves.user.with_raw_response.update(
                id="",
                body={},
            )
...
class TestAsyncUser:
    ...
    async def test_method_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        user = await async_client.functions.valves.user.retrieve(
            "id",
        )
        assert_matches_type(object, user, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.functions.valves.user.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.functions.valves.user.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.functions.valves.user.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        user = await async_client.functions.valves.user.update(
            id="id",
            body={},
        )
        assert_matches_type(object, user, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.functions.valves.user.with_raw_response.update(
            id="id",
            body={},
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.functions.valves.user.with_streaming_response.update(
            id="id",
            body={},
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.functions.valves.user.with_raw_response.update(
                id="",
                body={},
            )
