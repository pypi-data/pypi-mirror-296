...
class TestSpec:
    ...
    def test_method_retrieve(self, client: Pyopenwebui) -> None:
        spec = client.functions.valves.spec.retrieve(
            "id",
        )
    ...
    def test_raw_response_retrieve(self, client: Pyopenwebui) -> None:
        response = client.functions.valves.spec.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Pyopenwebui) -> None:
        with client.functions.valves.spec.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.functions.valves.spec.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncSpec:
    ...
    async def test_method_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        spec = await async_client.functions.valves.spec.retrieve(
            "id",
        )
        assert_matches_type(object, spec, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.functions.valves.spec.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.functions.valves.spec.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.functions.valves.spec.with_raw_response.retrieve(
                "",
            )
