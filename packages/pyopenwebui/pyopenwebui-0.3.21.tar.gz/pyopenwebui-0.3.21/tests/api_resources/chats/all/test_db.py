...
class TestDB:
    ...
    def test_method_list(self, client: Pyopenwebui) -> None:
        db = client.chats.all.db.list()
        assert_matches_type(DBListResponse, db, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Pyopenwebui) -> None:
        response = client.chats.all.db.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Pyopenwebui) -> None:
        with client.chats.all.db.with_streaming_response.list() as response:
...
class TestAsyncDB:
    ...
    async def test_method_list(self, async_client: AsyncPyopenwebui) -> None:
        db = await async_client.chats.all.db.list()
        assert_matches_type(DBListResponse, db, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.chats.all.db.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.chats.all.db.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
