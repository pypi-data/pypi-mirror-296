...
class TestValve:
    ...
    def test_raw_response_list(self, client: Pyopenwebui) -> None:
        response = client.tools.valve.with_raw_response.list(
            "id",
        )
    ...
    def test_streaming_response_list(self, client: Pyopenwebui) -> None:
        with client.tools.valve.with_streaming_response.list(
            "id",
        ) as response:
    ...
    def test_path_params_list(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.tools.valve.with_raw_response.list(
                "",
            )


class TestAsyncValve:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_list(self, async_client: AsyncPyopenwebui) -> None:
        valve = await async_client.tools.valve.list(
            "id",
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.tools.valve.with_raw_response.list(
            "id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.tools.valve.with_streaming_response.list(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.tools.valve.with_raw_response.list(
                "",
            )
