...
class CasesBucketsService(): 
    ...
    def insert_case_started_rows(self, data):
        base_query = (
            ...
            "(user_id, case_number, case_title, case_title_formatted, case_status, processes, requests, request_tokens, tasks, participants, created_at, initiated_at, completed_at, updated_at, keywords) "
