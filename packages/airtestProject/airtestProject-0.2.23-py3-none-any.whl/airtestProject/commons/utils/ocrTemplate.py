...
class PpOcr:
    ...
    def __init__(self, language=None):
        ...
        if language is None:
            ...
            self.ppOcr_languages = [language_mapping[lang]["PaddleOCR"] for lang in language if lang in language_mapping]
...
class OcrTemplate(Template):
    ...
    def __init__(self, filename=None, threshold=None, target_pos=TargetPos.MID, record_pos=None, resolution=(), rgb=False,
