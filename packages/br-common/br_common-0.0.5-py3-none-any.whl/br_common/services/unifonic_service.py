        ...
        try:
            ...
            if response.status_code != 200 or not response_data.get("success"):
                ...
                raise HTTPException(
                    ...
                    detail=ErrorMessages.UNIFONIC_EXCEPTION.value.format(
                        response_data.get("message", "Unknown error")
                    ),
                )
            ...
            raise HTTPException(
                ...
                detail=ErrorMessages.UNIFONIC_REQUEST_TIMEOUT.value,
            )
            ...
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
                detail="An error occurred while sending OTP. Please try again later.",
            )
