...
from ._hook import filter_hook
from . import ResponseBody,  Hooks
from . import HookSendBefore, HookSendAfter
from . import UrlMeta, StatsUrlHostView, StatsSentUrl
...
class _BaseRest(metaclass=ABCMeta):
    ...
    @property
    @abstractmethod
    def stats_datas(self) -> '_StatsSentUrl':
        pass
...
class _Rest(_BaseRest):
    ...
    def __run_before_hooks(instance_hooks, method_hooks, opts_hooks, req):
        req = _Rest.__run_hooks(filter_hook(opts_hooks, HookSendBefore), req)
        req = _Rest.__run_hooks(filter_hook(method_hooks, HookSendBefore), req)
        req = _Rest.__run_hooks(instance_hooks, req)
        return req

    @staticmethod
    def __run_after_hooks(instance_hooks, method_hooks, opts_hooks, resp):
        resp = _Rest.__run_hooks(filter_hook(opts_hooks, HookSendAfter), resp)
        resp = _Rest.__run_hooks(filter_hook(method_hooks, HookSendAfter), resp)
