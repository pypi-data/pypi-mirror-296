...
from ._constants import ResponseBody, _OPTIONAL_ARGS_KEYS, _HTTP_RE, _Constant, Hooks
from ._hook import HookSendBefore, HookSendAfter, filter_hook
from ._statistics import UrlMeta, StatsUrlHostView, StatsSentUrl
...
class Rest(BaseRest):
    ...
    def hooks(self, hooks: Hooks):
        ...
        self.__hooks = hooks
        self.__hooks_before.extend(filter_hook(self.__hooks, HookSendBefore))
        self.__hooks_after.extend(filter_hook(self.__hooks, HookSendAfter))
    ...
    def __run_before_hooks(instance_hooks, method_hooks, opts_hooks, req):
        req = Rest.__run_hooks(filter_hook(opts_hooks, HookSendBefore), req)
        req = Rest.__run_hooks(filter_hook(method_hooks, HookSendBefore), req)
        req = Rest.__run_hooks(instance_hooks, req)
        return req

    @staticmethod
    def __run_after_hooks(instance_hooks, method_hooks, opts_hooks, resp):
        resp = Rest.__run_hooks(filter_hook(opts_hooks, HookSendAfter), resp)
        resp = Rest.__run_hooks(filter_hook(method_hooks, HookSendAfter), resp)
        resp = Rest.__run_hooks(instance_hooks, resp)
        return resp
