...
class BaseRest(metaclass=ABCMeta):
    ...
    def get(self, api_name: str = None, server_name: str = None, host: str = None, api: str = None,
            ...
            restful: RestFul = None, stats: bool = True) -> T:
        """
    ...
    def post(self, api_name: str = None, server_name: str = None, host: str = None, api: str = None,
             ...
             description: str = None, restful: RestFul = None, stats: bool = True) -> T:
        """
    ...
    def lazy_init(self, rest: 'Rest' = None, file: str = None, server_list: list = None, server_name: str = None,
        ...
        if isinstance(rest, Rest):
            ...
            self.__initialize(file=file, server_list=server_list, server_name=server_name, host=host, headers=headers,
                              ...
                              max_redirects=max_redirects, stats=stats)
...
class StatsUrlMeta:
    ...
    def __eq__(self, other: 'StatsUrlMeta'):
        return self.__host == other.__host and self.path == other.path

    def __hash__(self):
        return hash(f"{self.__host}{self.path}")

    def __str__(self):
        return f"{self.__host}{self.path}"
...
class StatsUrlHostView:
    ...
    def __init__(self, host):
        ...
        self.__urls: set[StatsUrlMeta] = set()
    ...
    @property
    def urls(self) -> set[StatsUrlMeta]:
        return self.__urls
    ...
    def add(self, *paths: StatsUrlMeta):
        for p in paths:
    ...
    def __str__(self):
        return str({self.__host: self.__paths})
...
__all__ = [Rest, BaseRest, RestFast, HttpMethod, RestOptions, RestFul, RestResponse, ResponseBody,
           StatsUrlMeta, StatsUrlHostView, StatsSentUrl]
