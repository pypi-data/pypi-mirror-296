...
class Client:
    ...
    def on_event(self, event_name: str, uid: t.Optional[str] = None):
        """
        ...
        def decorator(fn):
            self._event_manager.register_handler(event_name, fn, uid)
            return fn

        return decorator

    def on_connect(self, uid=None):
        """
        ...
        Example:
            ...
            ```
        """
        return self.on_event(event_name='connect', uid=uid)

    def on_disconnect(self, uid=None):
        """
        ...
        Example:
            ...
            ```
        """
        return self.on_event(event_name='disconnect', uid=uid)

    def on_error(self, uid=None):
        """
        ...
        Example:
            ...
            ```
        """
        return self.on_event(event_name='error', uid=uid)

    def on_video_stream(self, uid=None):
        """
        ...
        Example:
            ...
            ```
        """
        return self.on_event(event_name='video_stream', uid=uid)
