...
class ORMBaseSchema(BaseModel):
    ...
    def __init__(self, **data: Any):
        ...
        elif not config.from_attributes:
        ...
        if type(self._from_attributes) != DeclarativeMeta:
            raise ValueError(
                "sqlalchemy-pydantic-orm: "
    ...
    @property
    @abstractmethod
    def _from_attributes(self) -> Type[DeclarativeMeta]:
    ...
    def orm_create(self, **extra_fields: Any) -> DeclarativeMeta:
        ...
        for field in self.model_fields_set:
            field_name = self.model_fields[field].alias
