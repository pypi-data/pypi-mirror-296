...
class SolidipesLogoWidget(SPW):
    ...
    def long(self, title=None, width="30%", **kwargs):
        ...
        self.layout.markdown(
            f'<center><img src="https://gitlab.com/dcsm/solidipes/-/raw/main/logos/solidipes.jpg" width="{width}"'
    ...
    def short(self, width="30%", **kwargs):
        self.layout.markdown(
            '<center><a href="https://gitlab.com/dcsm/solidipes"><em><strong>Solidipes</strong></em></a><br>'
            '<a href="./"><img'
            f' src="https://gitlab.com/dcsm/solidipes/-/raw/main/logos/solidipes.jpg" width="{width}"'
