    ...
    class AddParticle:
        ...
        def __init__(self, **kwargs) -> None:
            ...
            if 'sizeOverLifetime' in kwargs:
                self.sizeOverLifetime : Data_Pair.Range_Pair = Data_Pair.Range_Pair.from_tuple(kwargs.get('sizeOverLifetime'))
                """随时间缩放"""
            self.velocity : Data_Pair.Increasing_XY_Pair = Data_Pair.Increasing_XY_Pair.from_tuple(kwargs.get('velocity', ((0, 0), (0, 0))))
            """随时间变速"""
