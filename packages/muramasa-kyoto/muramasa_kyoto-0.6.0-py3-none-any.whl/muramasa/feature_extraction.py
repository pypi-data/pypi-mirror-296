...
def extract_features(sequence):
    ...
    # Consecutive k-mers
    features.update(count_kmer_consecutive(sequence, 2, 8))
    features.update(count_kmer_consecutive(sequence, 3, 5))
    features.update(count_kmer_consecutive(sequence, 4, 4))
    
    # Rich regions
    features.update(count_rich_regions(sequence, 100, 0.8, 10))
