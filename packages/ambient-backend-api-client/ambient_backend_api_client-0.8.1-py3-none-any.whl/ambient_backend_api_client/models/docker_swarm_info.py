...
class DockerSwarmInfo(BaseModel):
    ...
    node_addr: StrictStr = Field(alias="NodeAddr")
    local_node_state: StrictStr = Field(alias="LocalNodeState")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "NodeAddr": obj.get("NodeAddr"),
            "LocalNodeState": obj.get("LocalNodeState"),
