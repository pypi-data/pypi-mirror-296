...
import polystar._polystar as polystar_module
version = polystar_module.__version__ # just the 'short' version
release = polystar_module.version # the 'full' version information
...
breathe_projects = {'polystar' : '_build/doxygenxml/'}
breathe_default_project = 'polystar'
