...
#ifndef POLYSTAR_TRIANGULATION_POLY_HPP_
#define POLYSTAR_TRIANGULATION_POLY_HPP_
/*! \file
    \author Greg Tucker
...
triangulate(const T max_volume, const bool addGamma, const A<T>& points, const Faces& faces){
  ...
  if (addGamma){
    gammaPresent = points.row_is(polystar::cmp::eq, 0 * points.view(0)).any();
  }
...
#endif // POLYSTAR_TRIANGULATION_POLY_HPP_
