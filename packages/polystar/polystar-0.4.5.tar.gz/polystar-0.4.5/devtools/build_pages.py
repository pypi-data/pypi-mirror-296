...
def main(build_wheel, wheelhouse, output):
    ...
    image = get_image(client, 'docker.io/polystar/docact:v5.0.0')
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Build image-based Sphinx documentation locally for polystar')
