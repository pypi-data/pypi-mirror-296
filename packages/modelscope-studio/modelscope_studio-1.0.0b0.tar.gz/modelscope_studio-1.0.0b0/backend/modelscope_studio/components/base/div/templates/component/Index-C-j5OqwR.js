...
function V(o) {
  ...
  const t = A(ye), n = ((_ = v(t)) == null ? void 0 : _.as_item) || o.as_item, l = t ? n ? v(t)[n] : v(t) : {}, c = C({
    ...o,
    ...l
  });
  return t ? (t.subscribe((i) => {
    ...
    const u = i.as_item ? v(t)[i.as_item] : v(t);
    return c.set({
      ...i,
      ...u
    });
...
function Xe(o, e, s) {
  ...
  const c = be(() => import("./fragment-CGxuoBtQ.js"));
  let {
    _internal: _ = {}
  } = e, {
    as_item: i = void 0
  ...
  return o.$$set = (a) => {
    ...
    16387) {
      ...
      O.forEach(({
        ...
        h == null || h.removeEventListener(z, E);
      }), s(14, O = Object.keys(a).reduce((z, E) => {
        const x = E.replace(/^on(.+)/, (Ot, W) => W[0].toLowerCase() + W.slice(1)), H = a[E];
        return h == null || h.addEventListener(x, H), z.push({
          event: x,
          handler: H
        }), z;
      }, []));
    }
  }, e = B(e), [h, t, m, U, e, _, i, u, d, f, r, b, y, j, O, n, l, me, c];
}
class At extends mt {
  constructor(e) {
