...
function g(t, e = N) {
  ...
  function l(a, c = N) {
    const f = [a, c];
    return n.add(f), n.size === 1 && (o = e(i, s) || N), a(t), () => {
...
function W(t) {
  ...
  const n = I(T), i = ((a = y(n)) == null ? void 0 : a.as_item) || t.as_item, s = n ? i ? y(n)[i] : y(n) : {}, l = g({
    ...t,
    ...s
  });
...
function Se(t, e, o) {
  ...
  const c = B(() => import("./input-number-kVeVlwBL.js"));
  let {
    gradio: f
  } = e, {
    props: d = {}
  ...
  return t.$$set = (r) => {
    "gradio" in r && o(7, f = r.gradio), "props" in r && o(8, d = r.props), "_internal" in r && o(9, b = r._internal), "value" in r && o(0, u = r.value), "as_item" in r && o(10, h = r.as_item), "visible" in r && o(11, C = r.visible), "elem_id" in r && o(12, K = r.elem_id), "elem_classes" in r && o(13, S = r.elem_classes), "elem_style" in r && o(14, P = r.elem_style), "$$scope" in r && o(18, a = r.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    256 && m.update((r) => ({
      ...r,
  ...
  }, [u, i, s, c, m, E, O, f, d, b, h, C, K, S, P, n, l, M, a];
}
class Ne extends oe {
  constructor(e) {
