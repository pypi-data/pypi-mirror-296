import { g as O, w as f } from "./Index-CffADblK.js";
const k = window.ms_globals.ReactDOM.createPortal, U = window.ms_globals.antd.Watermark, {
  SvelteComponent: j,
  assign: v,
  binding_callbacks: y,
  check_outros: A,
...
function C(l) {
  ...
  return {
    c() {
      t = W("svelte-slot"), s && s.c(), K(t, "class", "svelte-1rt0kpf");
    },
    m(e, n) {
...
function te(l) {
  ...
  return {
    c() {
      t = W("react-portal-target"), o = V(), e && e.c(), a = G(), K(t, "class", "svelte-1rt0kpf");
    },
    m(n, c) {
...
function se(l, t, o) {
  ...
  return l.$$set = (r) => {
    o(17, t = v(v({}, t), S(r))), "svelteInit" in r && o(5, i = r.svelteInit), "$$scope" in r && o(6, n = r.$$scope);
  }, t = S(t), [a, s, u, _, c, i, n, e, M, N];
}
class ne extends j {
  constructor(t) {
