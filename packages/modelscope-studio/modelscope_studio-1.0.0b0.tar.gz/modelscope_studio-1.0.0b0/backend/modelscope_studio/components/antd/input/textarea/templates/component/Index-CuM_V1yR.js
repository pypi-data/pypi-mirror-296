...
function W(t) {
  ...
  const n = I(Q), i = ((a = y(n)) == null ? void 0 : a.as_item) || t.as_item, s = n ? i ? y(n)[i] : y(n) : {}, l = g({
    ...t,
    ...s
  });
...
function Se(t, e, o) {
  ...
  const c = Z(() => import("./input.textarea-D9psmA6w.js"));
  let {
    gradio: f
  } = e, {
    props: d = {}
  ...
  }, [u, i, s, c, m, z, E, f, d, p, h, C, K, S, P, n, l, M, a];
}
class xe extends oe {
  constructor(e) {
