...
function Ne(e) {
  ...
  e[24]({
    ...
    p(n, l) {
      const c = l & /*$mergedProps, $slots, $items, $children, value*/
...
function qe(e, t, i) {
  ...
  const _ = J(() => import("./tabs-CRDCeMiY.js"));
  let {
    gradio: m
  } = t, {
    props: b = {}
  ...
  v(e, A, (r) => i(3, l = r)), v(e, F, (r) => i(4, c = r));
  const G = (r) => {
    i(0, k = r);
  };
  return e.$$set = (r) => {
    "gradio" in r && i(11, m = r.gradio), "props" in r && i(12, b = r.props), "_internal" in r && i(13, g = r._internal), "value" in r && i(0, k = r.value), "as_item" in r && i(14, S = r.as_item), "visible" in r && i(15, I = r.visible), "elem_id" in r && i(16, P = r.elem_id), "elem_classes" in r && i(17, j = r.elem_classes), "elem_style" in r && i(18, N = r.elem_style), "$$scope" in r && i(22, f = r.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    4096 && a.update((r) => ({
      ...r,
  ...
  }, [k, o, n, l, c, _, a, q, V, A, F, m, b, g, S, I, P, j, N, s, u, G, f];
}
class Fe extends _e {
  constructor(t) {
