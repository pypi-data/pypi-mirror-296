import { g as z, w as f } from "./Index-9pcZeVqv.js";
const W = window.ms_globals.React, I = window.ms_globals.ReactDOM.createPortal, A = window.ms_globals.antd.Divider;
var P = {
  exports: {}
}, b = {};
/**
...
function h(r) {
  ...
  return {
    c() {
      t = C("svelte-slot"), s && s.c(), j(t, "class", "svelte-1rt0kpf");
    },
    m(e, n) {
...
function fe(r) {
  ...
  return {
    c() {
      t = C("react-portal-target"), l = le(), e && e.c(), o = ee(), j(t, "class", "svelte-1rt0kpf");
    },
    m(n, i) {
      ...
      props: {
        svelteInit(e) {
          ...
          return i.nodes = [...i.nodes, n], O({
            ...
            i.nodes = i.nodes.filter((c) => c.svelteInstance !== o), O({
              createPortal: I,
              node: g
            });
          }), n;
