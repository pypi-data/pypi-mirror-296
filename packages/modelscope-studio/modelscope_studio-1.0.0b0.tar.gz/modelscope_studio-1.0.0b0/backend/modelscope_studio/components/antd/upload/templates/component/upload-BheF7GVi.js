import { g as se, w as E } from "./Index-D7nCj_3T.js";
const H = window.ms_globals.React, oe = window.ms_globals.React.forwardRef, ne = window.ms_globals.React.useRef, re = window.ms_globals.React.useEffect, K = window.ms_globals.React.useMemo, D = window.ms_globals.ReactDOM.createPortal, ie = window.ms_globals.antd.Upload;
var B = {
  exports: {}
}, F = {};
/**
...
function Le(e) {
  ...
  return {
    ...
    p(r, [a]) {
      ...
      16 && S(t, 1)) : (t = A(r), t.c(), S(t, 1), t.m(n.parentNode, n)) : t && (ye(), N(t, 1, 1, () => {
        t = null;
      }), me());
    },
    i(r) {
...
function ke(e, o, s) {
  ...
  const l = E();
  W(e, l, (d) => s(1, i = d));
  const u = [], y = Ue("$$ms-gr-antd-react-wrapper"), {
    slotKey: m,
    slotIndex: L,
    subSlotIndex: k
  } = se() || {}, v = f({
  ...
  }, o = z(o), [n, i, c, l, a, f, r, t, g, O];
}
class Oe extends pe {
  constructor(o) {
    super(), Ie(this, o, ke, Le, ge, {
      svelteInit: 5
    });
  }
}
...
const x = oe(({
  ...
  return re(() => {
    ...
    function a() {
      let c = r;
      if (r.tagName.toLowerCase() === "svelte-slot" && r.children.length === 1 && r.children[0] && (c = r.children[0], c.tagName.toLowerCase() === "react-portal-target" && c.children[0] && (c = c.children[0])), Ce(i, c), s && c.classList.add(...s.split(" ")), n) {
        const l = Ne(n);
...
const We = je(({
  ...
  const k = e["showUploadList.downloadIcon"] || e["showUploadList.removeIcon"] || e["showUploadList.previewIcon"] || e["showUploadList.extra"] || typeof s == "object", v = qe(s), g = w(i), O = w(t), d = w(n == null ? void 0 : n.format), Z = w(r), V = w(a), $ = w(f), ee = w(b), te = w(c), C = K(() => (m == null ? void 0 : m.map((p) => ({
    ...p,
    name: p.orig_name || p.path,
    uid: p.url || p.path,
    status: "done"
  }))) || [], [m]);
  return /* @__PURE__ */ I.jsx(ie, {
    ...L,
    fileList: C,
    data: te || c,
    previewFile: Z,
    ...
    onRemove: (p) => {
      y == null || y(p);
      const j = C.findIndex((_) => _.uid === p.uid), h = m.slice();
      h.splice(j, 1), u == null || u(h), l == null || l(h.map((_) => _.path));
    },
    beforeUpload: async (p, j) => {
      if (g && !await g(p, j))
        return !1;
      const h = (await o([p])).filter((_) => _);
      return u == null || u([...m, ...h]), l == null || l([...m.map((_) => _.path), ...h.map((_) => _.path)]), !1;
    },
    customRequest: O,
    progress: n && {
      ...n,
    ...
    showUploadList: k ? {
      ...v,
      downloadIcon: e["showUploadList.downloadIcon"] ? /* @__PURE__ */ I.jsx(x, {
        slot: e["showUploadList.downloadIcon"]
      }) : v.downloadIcon,
      removeIcon: e["showUploadList.removeIcon"] ? /* @__PURE__ */ I.jsx(x, {
        slot: e["showUploadList.removeIcon"]
      }) : v.removeIcon,
      previewIcon: e["showUploadList.previewIcon"] ? /* @__PURE__ */ I.jsx(x, {
        slot: e["showUploadList.previewIcon"]
      }) : v.previewIcon,
      extra: e["showUploadList.extra"] ? /* @__PURE__ */ I.jsx(x, {
