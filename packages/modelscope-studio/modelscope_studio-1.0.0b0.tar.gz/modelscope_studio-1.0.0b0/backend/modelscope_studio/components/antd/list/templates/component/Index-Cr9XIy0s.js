...
function Ke(t, e, o) {
  ...
  const r = V(() => import("./list-BBS7ueca.js"));
  let {
    gradio: _
  } = e, {
    props: d = {}
  ...
  return j(t, I, (a) => o(1, s = a)), t.$$set = (a) => {
    "gradio" in a && o(6, _ = a.gradio), "props" in a && o(7, d = a.props), "_internal" in a && o(8, p = a._internal), "as_item" in a && o(9, c = a.as_item), "visible" in a && o(10, h = a.visible), "elem_id" in a && o(11, K = a.elem_id), "elem_classes" in a && o(12, S = a.elem_classes), "elem_style" in a && o(13, v = a.elem_style), "$$scope" in a && o(16, u = a.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    128 && m.update((a) => ({
      ...a,
  ...
  }, [i, s, r, m, z, I, _, d, p, c, h, K, S, v, n, l, u];
}
class ve extends ne {
  constructor(e) {
