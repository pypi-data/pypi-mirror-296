...
function Q(t) {
  ...
  const n = j(J), o = ((u = y(n)) == null ? void 0 : u.as_item) || t.as_item, s = n ? o ? y(n)[o] : y(n) : {}, l = g({
    ...t,
    ...s
  });
...
function Se(t, e, i) {
  ...
  const r = V(() => import("./skeleton.node-Dxc35c9E.js"));
  let {
    gradio: _
  } = e, {
    props: d = {}
  ...
  N(t, z, (a) => i(0, o = a));
  const I = H();
  return N(t, I, (a) => i(1, s = a)), t.$$set = (a) => {
