import { g as Q, w as g } from "./Index-BXXr-wMk.js";
...
function k(t) {
  ...
  return {
    c() {
      n = A("svelte-slot"), l && l.c(), N(n, "class", "svelte-1rt0kpf");
    },
    m(e, s) {
      h(e, n, s), l && l.m(n, null), t[9](n), r = !0;
    },
    p(e, s) {
      l && l.p && (!r || s & /*$$scope*/
      64) && me(
...
function he(t) {
  ...
  return {
    c() {
      n = A("react-portal-target"), r = _e(), e && e.c(), o = ie(), N(n, "class", "svelte-1rt0kpf");
    },
    m(s, i) {
      h(s, n, i), t[8](n), h(s, r, i), e && e.m(s, i), h(s, o, i), l = !0;
    },
    p(s, [i]) {
      /*$$slots*/
      s[4].default ? e ? (e.p(s, i), i & /*$$slots*/
      16 && y(e, 1)) : (e = k(s), e.c(), y(e, 1), e.m(o.parentNode, o)) : e && (de(), I(e, 1, 1, () => {
        e = null;
      }), oe());
    },
    i(s) {
...
function ye(t, n, r) {
  ...
  const c = g();
  R(t, c, (d) => r(1, l = d));
  const f = [], M = we("$$ms-gr-antd-react-wrapper"), {
    slotKey: W,
    slotIndex: z,
    subSlotIndex: T
  } = Q() || {}, U = u({
  ...
  return t.$$set = (d) => {
    r(17, n = S(S({}, n), j(d))), "svelteInit" in d && r(5, u = d.svelteInit), "$$scope" in d && r(6, s = d.$$scope);
  }, n = j(n), [o, l, a, c, i, u, s, e, q, G];
}
class xe extends re {
  constructor(n) {
    super(), ue(this, n, ye, he, fe, {
      svelteInit: 5
    });
  }
}
...
const p = H(({
  ...
  return J(() => {
    ...
    function i() {
      let a = s;
      if (s.tagName.toLowerCase() === "svelte-slot" && s.children.length === 1 && s.children[0] && (a = s.children[0], a.tagName.toLowerCase() === "react-portal-target" && a.children[0] && (a = a.children[0])), Se(l, a), r && a.classList.add(...r.split(" ")), o) {
        const c = Ee(o);
    ...
    if (n && window.MutationObserver) {
      let a = function() {
        var c;
        s = D(t), s.style.display = "contents", i(), (c = e.current) == null || c.appendChild(s);
      };
...
const je = ve(({
  ...
  const u = w(r == null ? void 0 : r.strategy), m = w(r == null ? void 0 : r.exceedFormatter), a = w(r == null ? void 0 : r.show), c = w(typeof o == "object" ? o.formatter : void 0);
  return /* @__PURE__ */ _.jsxs(_.Fragment, {
    children: [/* @__PURE__ */ _.jsx("div", {
      ...
      enterButton: t.enterButton ? /* @__PURE__ */ _.jsx(p, {
        slot: t.enterButton
      }) : i.enterButton,
