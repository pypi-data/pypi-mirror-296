...
function ie(t) {
  ...
  const s = E(se), o = ((u = v(s)) == null ? void 0 : u.as_item) || t.as_item, i = s ? o ? v(s)[o] : v(s) : {}, r = w({
    ...t,
    ...i
  });
...
class me {
  constructor({
    ...
    }), this.path = e, this.url = n, this.orig_name = s, this.size = o, this.blob = n ? void 0 : i, this.is_stream = r, this.mime_type = u, this.alt_text = a;
  }
}
typeof process < "u" && process.versions && process.versions.node;
class Te extends TransformStream {
...
`), i = e.allowCR ? n.indexOf("\r") : -1;
          ...
          if (o === -1) break;
          const r = n[o - 1] === "\r" ? o - 1 : o;
          s.enqueue(n.slice(0, r)), n = n.slice(o + 1);
        }
        _e(this, y, n);
      },
      flush: (n) => {
...
function Ee(t) {
  ...
  t[22]({
    ...
    p(i, r) {
      const u = r & /*$mergedProps, $slots, value, gradio, root*/
      31 ? Se(s, [r & /*$mergedProps*/
      8 && {
        style: (
          /*$mergedProps*/
          i[3].elem_style
...
function De(t, e, n) {
  ...
  const a = Q(() => import("./upload.dragger-DCNSCOb3.js"));
  let {
    gradio: _
  } = e, {
    props: p = {}
  ...
  const B = (l) => {
    n(0, g = l);
  }, H = async (l) => await _.client.upload(await fe(l), c) || [];
  return t.$$set = (l) => {
    "gradio" in l && n(1, _ = l.gradio), "props" in l && n(9, p = l.props), "_internal" in l && n(10, h = l._internal), "root" in l && n(2, c = l.root), "value" in l && n(0, g = l.value), "as_item" in l && n(11, P = l.as_item), "visible" in l && n(12, x = l.visible), "elem_id" in l && n(13, z = l.elem_id), "elem_classes" in l && n(14, I = l.elem_classes), "elem_style" in l && n(15, N = l.elem_style), "$$scope" in l && n(20, u = l.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    512 && m.update((l) => ({
      ...l,
  ...
  }, [g, _, c, o, i, a, m, A, R, p, h, P, x, z, I, N, s, r, B, H, u];
}
class Ue extends he {
  constructor(e) {
    super(), xe(this, e, De, Re, Ie, {
      gradio: 1,
      props: 9,
      _internal: 10,
      root: 2,
