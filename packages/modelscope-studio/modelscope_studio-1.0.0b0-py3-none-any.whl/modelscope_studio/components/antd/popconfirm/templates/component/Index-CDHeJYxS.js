...
function Se(t, e, i) {
  ...
  const c = Z(() => import("./popconfirm-vAgStDWx.js"));
  let {
    gradio: f
  } = e, {
    props: d = {}
  ...
  return N(t, O, (r) => i(1, s = r)), t.$$set = (r) => {
    "gradio" in r && i(6, f = r.gradio), "props" in r && i(7, d = r.props), "_internal" in r && i(8, p = r._internal), "title" in r && i(9, u = r.title), "as_item" in r && i(10, h = r.as_item), "visible" in r && i(11, K = r.visible), "elem_id" in r && i(12, S = r.elem_id), "elem_classes" in r && i(13, P = r.elem_classes), "elem_style" in r && i(14, v = r.elem_style), "$$scope" in r && i(17, a = r.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    128 && m.update((r) => ({
      ...r,
  ...
  }, [o, s, c, m, E, O, f, d, p, u, h, K, S, P, v, n, l, a];
}
class ve extends se {
  constructor(e) {
