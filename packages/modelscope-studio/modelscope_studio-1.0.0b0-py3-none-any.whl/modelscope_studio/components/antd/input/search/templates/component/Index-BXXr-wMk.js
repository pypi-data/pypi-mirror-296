...
function Ke(t, e, o) {
  ...
  const u = B(() => import("./input.search-jDfdpbIK.js"));
  let {
    gradio: f
  } = e, {
    props: d = {}
  ...
  return t.$$set = (r) => {
    "gradio" in r && o(7, f = r.gradio), "props" in r && o(8, d = r.props), "_internal" in r && o(9, p = r._internal), "value" in r && o(0, c = r.value), "as_item" in r && o(10, h = r.as_item), "visible" in r && o(11, C = r.visible), "elem_id" in r && o(12, S = r.elem_id), "elem_classes" in r && o(13, K = r.elem_classes), "elem_style" in r && o(14, P = r.elem_style), "$$scope" in r && o(18, a = r.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    256 && m.update((r) => ({
      ...r,
  ...
  }, [c, i, s, u, m, E, O, f, d, p, h, C, S, K, P, n, l, M, a];
}
class je extends oe {
  constructor(e) {
    super(), pe(this, e, Ke, Se, he, {
      gradio: 7,
      props: 8,
      _internal: 9,
      value: 0,
