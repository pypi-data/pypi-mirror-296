import { g as J, w as m } from "./Index-CDlBwj_p.js";
const j = window.ms_globals.React, K = window.ms_globals.React.forwardRef, M = window.ms_globals.React.useRef, B = window.ms_globals.React.useEffect, E = window.ms_globals.ReactDOM.createPortal, Y = window.ms_globals.antd.Empty;
var L = {
  exports: {}
}, b = {};
/**
...
function we(n) {
  ...
  return {
    c() {
      t = D("react-portal-target"), s = ue(), e && e.c(), o = se(), W(t, "class", "svelte-1rt0kpf");
    },
    m(r, i) {
...
function be(n, t, s) {
  ...
  const d = m();
  C(n, d, (a) => s(1, l = a));
  const f = [], A = me("$$ms-gr-antd-react-wrapper"), {
    slotKey: F,
    slotIndex: T,
    subSlotIndex: U
  } = J() || {}, q = u({
  ...
  return n.$$set = (a) => {
    s(17, t = x(x({}, t), S(a))), "svelteInit" in a && s(5, u = a.svelteInit), "$$scope" in a && s(6, r = a.$$scope);
  }, t = S(t), [o, l, c, d, i, u, r, e, G, H];
}
class he extends te {
  constructor(t) {
    super(), ae(this, t, be, we, de, {
      svelteInit: 5
    });
  }
}
      ...
      props: {
        svelteInit(e) {
          ...
          return i.nodes = [...i.nodes, r], O({
            ...
            i.nodes = i.nodes.filter((u) => u.svelteInstance !== o), O({
              createPortal: E,
              node: y
            });
          }), r;
...
const P = K(({
  ...
  return B(() => {
    ...
    if (t && window.MutationObserver) {
      let c = function() {
        var d;
        r = z(n), r.style.display = "contents", i(), (d = e.current) == null || d.appendChild(r);
      };
      c(), u = new window.MutationObserver(() => {
        var d, f;
        (d = e.current) != null && d.contains(r) && ((f = e.current) == null || f.removeChild(r)), c();
      }), u.observe(n, {
        attributes: !0,
        childList: !0,
        subtree: !0
    ...
    return () => {
      var c, d;
      r.style.display = "", (c = e.current) != null && c.contains(r) && ((d = e.current) == null || d.removeChild(r)), u == null || u.disconnect();
    };
  ...
  image: n.image ? /* @__PURE__ */ h.jsx(P, {
    slot: n.image
  }) : s.image
}));
export {
