...
function Ct(n, t, s) {
  ...
  return n.$$set = (r) => {
    "gradio" in r && s(7, _ = r.gradio), "props" in r && s(8, m = r.props), "_internal" in r && s(9, f = r._internal), "as_item" in r && s(10, h = r.as_item), "label" in r && s(11, C = r.label), "visible" in r && s(12, K = r.visible), "elem_id" in r && s(13, S = r.elem_id), "elem_classes" in r && s(14, w = r.elem_classes), "elem_style" in r && s(15, I = r.elem_style), "$$scope" in r && s(19, a = r.$$scope);
  }, n.$$.update = () => {
    n.$$.dirty & /*props*/
    256 && y.update((r) => ({
      ...r,
    ...
    196611 && Y(o, e._internal.index || 0, {
      props: {
        style: e.elem_style,
        className: nt(e.elem_classes, "ms-gr-antd-collapse-item"),
        id: e.elem_id,
        label: e.label,
        ...e.props,
        ...L(e)
