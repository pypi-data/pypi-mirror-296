...
function Q(t) {
  ...
  const n = z(J), i = ((a = y(n)) == null ? void 0 : a.as_item) || t.as_item, s = n ? i ? y(n)[i] : y(n) : {}, l = g({
    ...t,
    ...s
  });
...
function Se(t, e, o) {
  ...
  const c = W(() => import("./watermark-sn8mOhJy.js"));
  let {
    gradio: f
  } = e, {
    props: d = {}
  ...
  return N(t, O, (r) => o(1, s = r)), t.$$set = (r) => {
    "gradio" in r && o(6, f = r.gradio), "props" in r && o(7, d = r.props), "_internal" in r && o(8, b = r._internal), "content" in r && o(9, u = r.content), "as_item" in r && o(10, h = r.as_item), "visible" in r && o(11, K = r.visible), "elem_id" in r && o(12, S = r.elem_id), "elem_classes" in r && o(13, v = r.elem_classes), "elem_style" in r && o(14, P = r.elem_style), "$$scope" in r && o(17, a = r.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    128 && m.update((r) => ({
      ...r,
      ...d
    })), t.$$.dirty & /*gradio, $updatedProps, _internal, visible, elem_id, elem_classes, elem_style, as_item, content*/
    65344 && M({
      gradio: f,
      props: n,
      _internal: b,
  ...
  }, [i, s, c, m, E, O, f, d, b, u, h, K, S, v, P, n, l, a];
}
class Pe extends se {
  constructor(e) {
