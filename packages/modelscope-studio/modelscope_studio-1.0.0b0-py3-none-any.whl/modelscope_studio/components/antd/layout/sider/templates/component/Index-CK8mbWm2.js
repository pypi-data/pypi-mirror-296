...
function Q(t) {
  ...
  const n = x(J), o = ((u = g(n)) == null ? void 0 : u.as_item) || t.as_item, s = n ? o ? g(n)[o] : g(n) : {}, l = y({
    ...t,
    ...s
  });
  return n ? (n.subscribe((r) => {
    ...
    const _ = r.as_item ? g(n)[r.as_item] : g(n);
    return l.set({
      ...r,
      ..._
    });
...
function Se(t, e, i) {
  ...
  const r = V(() => import("./layout.sider-vN7S_nbG.js"));
  let {
    gradio: _
  } = e, {
    props: d = {}
  ...
  }, [o, s, r, m, z, I, _, d, p, c, h, S, K, v, n, l, u];
}
class ve extends ne {
  constructor(e) {
