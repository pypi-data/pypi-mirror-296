...
function g(t, e = v) {
  ...
  function l(u, r = v) {
    const f = [u, r];
    return n.add(f), n.size === 1 && (o = e(i, s) || v), u(t), () => {
...
function Q(t) {
  ...
  const n = j(J), i = ((u = y(n)) == null ? void 0 : u.as_item) || t.as_item, s = n ? i ? y(n)[i] : y(n) : {}, l = g({
    ...t,
    ...s
  });
...
function Ce(t) {
  ...
  return {
    ...
    p(i, [s]) {
      ...
      1 && k(n, 1)) : (n = A(i), n.c(), k(n, 1), n.m(e.parentNode, e)) : n && (fe(), C(n, 1, 1, () => {
        n = null;
      }), ie());
    },
    i(i) {
...
function Ke(t, e, o) {
  ...
  const r = V(() => import("./affix-By-Ncujk.js"));
  let {
    gradio: f
  } = e, {
    props: d = {}
  ...
  P(t, z, (a) => o(0, i = a));
  const I = H();
  return P(t, I, (a) => o(1, s = a)), t.$$set = (a) => {
    "gradio" in a && o(6, f = a.gradio), "props" in a && o(7, d = a.props), "_internal" in a && o(8, p = a._internal), "as_item" in a && o(9, c = a.as_item), "visible" in a && o(10, h = a.visible), "elem_id" in a && o(11, K = a.elem_id), "elem_classes" in a && o(12, S = a.elem_classes), "elem_style" in a && o(13, x = a.elem_style), "$$scope" in a && o(16, u = a.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    128 && m.update((a) => ({
      ...a,
  ...
  }, [i, s, r, m, z, I, f, d, p, c, h, K, S, x, n, l, u];
}
class xe extends ne {
  constructor(e) {
