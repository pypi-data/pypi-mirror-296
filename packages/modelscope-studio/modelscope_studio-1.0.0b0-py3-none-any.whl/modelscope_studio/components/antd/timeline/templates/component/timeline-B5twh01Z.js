import { g as Q, w as m } from "./Index-DbEVSCbs.js";
const D = window.ms_globals.React, B = window.ms_globals.React.forwardRef, J = window.ms_globals.React.useRef, Y = window.ms_globals.React.useEffect, K = window.ms_globals.React.useMemo, I = window.ms_globals.ReactDOM.createPortal, V = window.ms_globals.antd.Timeline;
var L = {
  exports: {}
}, y = {};
/**
...
function S(r) {
  ...
  return {
    c() {
      t = T("svelte-slot"), s && s.c(), F(t, "class", "svelte-1rt0kpf");
    },
    m(e, l) {
...
function we(r) {
  ...
  return {
    c() {
      t = T("react-portal-target"), n = _e(), e && e.c(), o = ie(), F(t, "class", "svelte-1rt0kpf");
    },
    m(l, i) {
    ...
    d(l) {
      l && (p(t), p(n), p(o)), r[8](null), e && e.d(l);
    }
  };
}
function j(r) {
...
function ye(r, t, n) {
  ...
  const a = m();
  O(r, a, (u) => n(1, s = u));
  const f = [], v = pe("$$ms-gr-antd-react-wrapper"), {
    slotKey: z,
    slotIndex: A,
    subSlotIndex: U
  } = Q() || {}, q = d({
  ...
  he("$$ms-gr-antd-react-wrapper", q), me(() => {
    _.set(j(t));
  }), be(() => {
    f.forEach((u) => u());
  });
...
const w = B(({
  ...
  return Y(() => {
    ...
    if (t && window.MutationObserver) {
      let c = function() {
        var a;
        l = M(r), l.style.display = "contents", i(), (a = e.current) == null || a.appendChild(l);
      };
  ...
  }, [r, t, n, o, s]), D.createElement("react-child", {
    ref: e,
    style: {
      display: "contents"
    }
...
function W(r, t) {
  return r.filter(Boolean).map((n) => {
    ...
    Object.keys(n.slots).forEach((l) => {
      ...
      const d = n.slots[l];
      let _, c, a = !1;
      d instanceof Element ? _ = d : (_ = d.el, c = d.callback, a = d.clone || !1), s[i[i.length - 1]] = _ ? c ? (...f) => (c(i[i.length - 1], f), /* @__PURE__ */ g.jsx(w, {
        slot: _,
...
const Oe = xe(({
  ...
  children: [/* @__PURE__ */ g.jsx("div", {
    ...
    ...s,
    items: K(() => t || W(n), [t, n]),
    pending: r.pending ? /* @__PURE__ */ g.jsx(w, {
      slot: r.pending
    }) : s.pending,
    pendingDot: r.pendingDot ? /* @__PURE__ */ g.jsx(w, {
      slot: r.pendingDot
    }) : s.pendingDot
  })]
}));
