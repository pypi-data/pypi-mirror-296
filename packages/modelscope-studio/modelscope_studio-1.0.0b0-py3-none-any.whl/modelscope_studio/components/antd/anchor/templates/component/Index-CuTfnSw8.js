...
function xe(e, t, i) {
  ...
  const _ = H(() => import("./anchor-vu6Ltd7L.js"));
  let {
    gradio: m
  } = t, {
    props: p = {}
  ...
  return k(e, q, (u) => i(2, l = u)), k(e, A, (u) => i(3, r = u)), e.$$set = (u) => {
    "gradio" in u && i(10, m = u.gradio), "props" in u && i(11, p = u.props), "_internal" in u && i(12, g = u._internal), "as_item" in u && i(13, K = u.as_item), "visible" in u && i(14, I = u.visible), "elem_id" in u && i(15, v = u.elem_id), "elem_classes" in u && i(16, P = u.elem_classes), "elem_style" in u && i(17, j = u.elem_style), "$$scope" in u && i(20, f = u.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    2048 && a.update((u) => ({
      ...u,
  ...
  }, [o, n, l, r, _, a, E, O, q, A, m, p, g, K, I, v, P, j, s, c, f];
}
class qe extends ae {
  constructor(t) {
