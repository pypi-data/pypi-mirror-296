import { g as J, w as p } from "./Index-BeEvcxBg.js";
const j = window.ms_globals.React, K = window.ms_globals.React.forwardRef, M = window.ms_globals.React.useRef, B = window.ms_globals.React.useEffect, x = window.ms_globals.ReactDOM.createPortal, Y = window.ms_globals.antd.Avatar;
var L = {
  exports: {}
}, h = {};
/**
...
function we(n) {
  ...
  return {
    ...
    p(r, [i]) {
      ...
      16 && b(e, 1)) : (e = S(r), e.c(), b(e, 1), e.m(o.parentNode, o)) : e && (ce(), y(e, 1, 1, () => {
        e = null;
      }), ne());
    },
    i(r) {
...
const O = window.ms_globals.rerender, v = window.ms_globals.tree;
function ve(n) {
  function t(s) {
    const o = p(), l = new he({
      ...s,
...
const P = K(({
  ...
  children: [n.icon ? t : null, /* @__PURE__ */ m.jsx(Y, {
    ...s,
    icon: n.icon ? /* @__PURE__ */ m.jsx(P, {
      slot: n.icon
    }) : s.icon,
    src: n.src ? /* @__PURE__ */ m.jsx(P, {
      slot: n.src
    }) : s.src,
