...
function Se(t, e, i) {
  ...
  const r = M(() => import("./skeleton.button-CqqRPXBB.js"));
  let {
    gradio: _
  } = e, {
    props: d = {}
  ...
  return j(t, I, (a) => i(1, s = a)), t.$$set = (a) => {
    "gradio" in a && i(6, _ = a.gradio), "props" in a && i(7, d = a.props), "_internal" in a && i(8, b = a._internal), "as_item" in a && i(9, c = a.as_item), "visible" in a && i(10, h = a.visible), "elem_id" in a && i(11, S = a.elem_id), "elem_classes" in a && i(12, K = a.elem_classes), "elem_style" in a && i(13, v = a.elem_style), "$$scope" in a && i(16, u = a.$$scope);
  }, t.$$.update = () => {
    t.$$.dirty & /*props*/
    128 && m.update((a) => ({
      ...a,
  ...
  }, [o, s, r, m, z, I, _, d, b, c, h, S, K, v, n, l, u];
}
class ve extends ne {
  constructor(e) {
    super(), me(this, e, Se, Ce, be, {
      gradio: 6,
      props: 7,
      _internal: 8,
      as_item: 9,
