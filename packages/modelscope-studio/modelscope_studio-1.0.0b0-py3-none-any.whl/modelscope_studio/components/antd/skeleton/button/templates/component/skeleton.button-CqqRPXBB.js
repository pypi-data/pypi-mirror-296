import { g as O, w as f } from "./Index-eFtO88Zf.js";
const k = window.ms_globals.ReactDOM.createPortal, U = window.ms_globals.antd.Skeleton, {
  SvelteComponent: W,
  assign: v,
  binding_callbacks: y,
  check_outros: j,
...
function se(l, t, o) {
  ...
  const _ = f();
  S(l, _, (r) => o(1, s = r));
  const I = [], B = Z("$$ms-gr-antd-react-wrapper"), {
    slotKey: R,
    slotIndex: q,
    subSlotIndex: z
  } = O() || {}, E = i({
...
const re = oe(U.Button);
export {
  re as SkeletonButton,
  re as default
};
