...
{
    Matrix_as_number.nb_multiply = (binaryfunc)Matrix_mul;
    Matrix_as_number.nb_invert = (unaryfunc)Matrix_inv;
    Matrix_as_number.nb_inplace_multiply = (binaryfunc)Matrix_imul;

    Matrix_as_sequence.sq_length = (lenfunc)Matrix_length;
    Matrix_as_sequence.sq_item = (ssizeargfunc)Matrix_item;
    ...
    Box_as_sequence.sq_length = (lenfunc)Box_length;
    Box_as_sequence.sq_item = (ssizeargfunc)Box_item;
