...
static PyObject* Element_parent(Element_Object* self, PyObject* args)
{
    return Element_Create(self->document_ob, self->element.parent());
}
...
static PyMethodDef Element_methods[] = {
    ...
    {"parent", (PyCFunction)Element_parent, METH_NOARGS},
