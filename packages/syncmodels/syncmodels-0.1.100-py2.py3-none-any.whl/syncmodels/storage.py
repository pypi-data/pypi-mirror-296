                    ...
                    if sv:
                        ...
                        if st:
                            ...
                            if vs:
                                ...
                                log.debug(
                                    "[%s]: SKIP, new and existing are identical.",
                                    uid,
                                )
                                foo = 1
                            else:
                                ...
                                log.warning(
                                    "[%s].[%s], EP send an modified version of an already sent object",
                                    uid,
                                    key,
                                )
                                foo = 1
...
class SurrealistStorage(Storage):
    ...
    async def query(self, query: URI | QUERY, **params) -> List[JSON]:
        ...
        limit__ = params.pop(LIMIT_KEY, None)
