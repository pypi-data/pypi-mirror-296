...
class Files:
            ...
            with zip_file.open(self.metadata_file_name) as f:
                ...
                if video_file not in files:
                    if self.file_is_absent(
                        os.path.join(project_file_dir, video_file)
                    ):
                ...
                if video_file_in_zip:
                    path = os.path.join(temp_dir.name, video_file)
                else:
                    path = os.path.join(project_file_dir, video_file)
    ...
    def save_project(self) -> bool:
        ...
        sha1_hexdigest = sha1_file(self.media.path())
            ...
            yaml.safe_dump(
                {
                    "video": {
                        ...
                        "size": os.path.getsize(self.media.path()),
