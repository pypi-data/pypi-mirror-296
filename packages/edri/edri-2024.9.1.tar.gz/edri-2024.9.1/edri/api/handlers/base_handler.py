...
class BaseDirectiveHandlerDict(TypedDict):
    pass


class BaseHandler(ABC):
    _directive_handlers: dict[Type[ResponseDirective], BaseDirectiveHandlerDict] = {}
    ...
    def insert_default_parameters(self, event_constructor: Type[Event]) -> None:
        self.parameters = {k: v.default for k, v in event_constructor.__dataclass_fields__.items() if
                                not k.startswith("_") and k not in ("response", "method")} | self.parameters
