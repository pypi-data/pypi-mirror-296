...
if versions_to_check not in compatible_versions:
    logger.critical(f"Version mismatch: {versions_to_check} is not in the compatibility list")
else:
    logger.info(f"Version check passed: {versions_to_check} is in the compatibility list")
