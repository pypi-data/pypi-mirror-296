...
from thonnycontrib.utils import format_filename_to_hyperlink, remove_url_part, tostring
import thonny
...
class L1TestReporter():    
    ...
    def display_verdicts(self, l1TestModule: L1TestModule):
        """Display the verdicts into the `L1TestTreeView`.

        Args:
            verdicts (List[L1DocTest]): the dictionary of verdicts.
        """
        assert l1TestModule != None
        self.__treeview.set_l1test_module(l1TestModule)
        self.__treeview.update_tree_contents()
