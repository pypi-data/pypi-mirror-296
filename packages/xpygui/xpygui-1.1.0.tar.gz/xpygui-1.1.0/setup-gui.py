...
packages = find_packages(exclude=["thonnycontrib.frontend.cli"]) # Exclure le package cli en mode GUI
...
setup(
    ...
    description="This is the GUI version of the xpytest tool for Thonny",
    long_description="This is the GUI version of the xpytest tool for Thonny",
    classifiers=[
