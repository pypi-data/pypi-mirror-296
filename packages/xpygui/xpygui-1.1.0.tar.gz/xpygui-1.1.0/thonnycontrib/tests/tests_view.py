...
from thonnycontrib.backend.ast_parser import L1DocTest, L1DocTestFlag
...
"""
        ...
        summarize = L1DocTest.build_summarize(l1doctests)
        ...
        self.assertEqual(l1doctest.get_flag(), L1DocTestFlag.FAILED)
...
"""
        ...
        self.assertEqual(l1doctest.get_flag(), L1DocTestFlag.EMPTY)
...
"""
        ...
        # ###########################################################################
        # ------------------ Verification du status du l1doctest ---------------------
        self.assertEqual(l1doctest.get_flag(), L1DocTestFlag.PASSED)
...
"""
        ...
        # le flag est `EMPTY` car il n'y a pas de tests pour `minus()`
        self.assertEqual(l1doctest.get_flag(), L1DocTestFlag.EMPTY)
        ...
        # le flag est `PASSED` car il existe un test qui passe pour `somme()`
        self.assertEqual(l1doctest.get_flag(), L1DocTestFlag.PASSED)
