...
class TestEvaluator(ut.TestCase):
    ...
    """
    Ce test vérifie:
    1. Le type `ExampleExceptionExpected` est le type `Example` extrait 
...
""" 
    ...
    le flag du l1doctest est `FAILED`.
    """     
...
""" 
    ...
    est renvoyé. Enfin, le flag du l1doctest est `FAILED`.
    """        
