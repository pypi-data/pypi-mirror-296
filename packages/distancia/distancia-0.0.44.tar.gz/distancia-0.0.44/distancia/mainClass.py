...
class Distance(ABC):
	...
	def checkDimensionData(self,data1,data2):
		...
		if self.__class__.__name__=='Euclidean'or self.__class__.__name__=='L2'or self.__class__.__name__=='Manhattan'or  self.__class__.__name__=='L1'or  self.__class__.__name__=='Minkowski'or  self.__class__.__name__=='RussellRao' or  self.__class__.__name__=='Chebyshev'or  self.__class__.__name__=='KendallTau'or  self.__class__.__name__=='Canberra' or  self.__class__.__name__=='BrayCurtis'or  self.__class__.__name__=='Matching'or  self.__class__.__name__=='Kulsinski'or  self.__class__.__name__=='Yule' or  self.__class__.__name__=='Bhattacharyya'or  self.__class__.__name__=='Gower'or  self.__class__.__name__=='Hellinger' or  self.__class__.__name__=='CzekanowskiDice' or  self.__class__.__name__=='Wasserstein' :
			if len(data1) != len(data2):
				raise ValueError(str_raise+'points must have the same dimensions')
		if self.__class__.__name__=='Mahalanobis':
			if len(data1[0]) != len(data2):
				raise ValueError(str_raise+"points dimensions must match dataset dimensions")
		if self.__class__.__name__=='Levenshtein'or  self.__class__.__name__=='Jaro'or  self.__class__.__name__=='SorensenDice'or  self.__class__.__name__=='JaroWinkler':
			pass
