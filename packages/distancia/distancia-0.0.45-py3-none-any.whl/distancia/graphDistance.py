...
class DiffusionDistance(Distance):
    ...
    def computeDiffusion(self, graph, source_node=None, steps=self.steps):
        """
    ...
    def compute(self, graph1, graph2, source_node):
        ...
        """
        diff1 = self.compute(graph1, source_node, steps)
        diff2 = self.compute(graph2, source_node, steps)
