...
#-----------------------------------------------------------------------
if os.path.isdir(dir_files + '/output/Penetration_length'):
   0 == 0
else:
   os.mkdir(dir_files + '/output/Penetration_length')
#----------------------------------------------------
...
print ("##############################################################")
print ("################ Penetration length of states ################")
print ("##############################################################")
print (" ")
...
if (escolha == -1 or escolha == 1):
   ...
   print ("percentage for the states, ranging from [0.0 to 1.0]          ")
   print ("------------------------------------------------------------- ")
   print ("For example:                                                  ")
   ...
   print (" ")
   #---------------------------------
   contrib_perc = float(contrib_perc)
   if (contrib_perc <= 0.0 or contrib_perc > 1.0): contrib_perc = 0.9 
...
#---------------------------------------------------------------------------------------
contrib_ions = open(dir_files + '/output/Penetration_length/contribution_ions.dat', 'w')
kpoints_info = open(dir_files + '/output/Penetration_length/kpoints_info.dat', 'w')
#----------------------------------------------------------------------------------
    ...
    for n_spin in range(1,(ispin+1)):
        ...
        for point_k in range(1, (nk+1)):   
            ...
            for Band_n in range (1, (int(nb/ispin) +1)):
                ...
                if ( (bands_sn[Band] == 'sim') and (points_sn[point_k] == 'sim') ):  contrib_ions.write(f'Band {Band_n} \n')
                ...
                for ion_n in range (1,(ni+1)):
                    ...
                    if ((total != 0) and (soma*100 <= contrib_perc)):
                       contrib_ions.write(f'{rotulo_temp[ion_n]:>2}: ion {atomo[ion_n]:<3} | Contribution: {tot_ion[ion_n]:>6,.3f}% | Sum:  {soma:>7,.3f}% | \n')
 
                if ((bands_sn[Band] == 'sim') and (points_sn[point_k] == 'sim') and (ion_n == ni)):  contrib_ions.write(" \n")
