...
if (escolha == -1 or escolha == 1):
   ...
   if (penetration_plot == 1):
      #--------------------------------------------------------------------
      p_length = [[0]*(nb) for i in range(nk*n_procar)]  # p_length[nk][nb]
      #--------------------------------------------------------------------
...
if (penetration_plot == 1):
   ...
   for i in range(1,(ni+1)):
       ...
       if (dirc_penet_length == 1): Coord[i] = ((C1*A1x) + (C2*A2x) + (C3*A3x))*param
       if (dirc_penet_length == 2): Coord[i] = ((C1*A1y) + (C2*A2y) + (C3*A3y))*param
       if (dirc_penet_length == 3): Coord[i] = ((C1*A1z) + (C2*A2z) + (C3*A3z))*param
        ...
        for point_k in range(1, (nk+1)):                       
            ...
            for Band_n in range (1, (int(nb/ispin) +1)):
                ...
                for ion_n in range (1,(ni+1)):
                    ...
                    #-----------------------------------------------------------------------------------------------------------------------------------------------------------
                    if (total != 0):  contrib_ions.write(f'{rotulo_temp[ion_n]:>2}: ion {atomo[ion_n]:<3} | Contribution: {tot_ion[ion_n]:>6,.3f}% | Sum:  {soma:>7,.3f}% | \n')
                    #-----------------------------------------------------------------------------------------------------------------------------------------------------------
                    print(ni, ion_n, len(Coord))
                    if ((penetration_plot == 1) and (soma <= contrib_perc)):  vector_length.append(Coord[ion_n])    
                #-----------------------------------------------------------------------------------------------
                if (penetration_plot == 1):  p_length[n_point_k][Band] = max(vector_length) -min(vector_length)
                #----------------------------------------------------------------------------------------------
...
if (penetration_plot == 1):
   ...
   #-------------------------------------------------------------------
   for i in range(1, ((nk*n_procar)+1)):
       p_file.write(f'{separacao[i]} ') 
       for j in range (1, (nb+1)):
           p_file.write(f'{p_length[i][j]} ')
       p_file.write(f' \n')
   #-------------
   p_file.close()
   #-------------
