...
if (escolha == -1 or escolha == 1):
   ...
   if (penetration_plot == 1):
      ...
      print ("[1] (X)      [2] (Y)      [3] (Z)                             ")
      print ("##############################################################")
      dirc_p_length = input (" "); dirc_penet_length = int(dirc_p_length)
      print (" ")
...
if (penetration_plot == 1):
   ...
   for i in range(1,(ni+1)):
       ...
       if (dirc_p_length == 1): Coord[i] = ((C1*A1x) + (C2*A2x) + (C3*A3x))*param
       if (dirc_p_length == 2): Coord[i] = ((C1*A1y) + (C2*A2y) + (C3*A3y))*param
       if (dirc_p_length == 3): Coord[i] = ((C1*A1z) + (C2*A2z) + (C3*A3z))*param
