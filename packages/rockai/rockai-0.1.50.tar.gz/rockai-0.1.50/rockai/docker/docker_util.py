...
def build_docker_image_without_configuration(
    ...
    """
        ...
        docker_list.append(
            add_run(
                """curl -s -S -L https://raw.staticdn.net/pyenv/pyenv-installer/master/bin/pyenv-installer | bash && \
...
""".format(
    ...
    docker_list.append(add_run("pip install huggingface_hub hf_transfer -i https://pypi.tuna.tsinghua.edu.cn/simple"))
