...
class FoundAccountData(BaseModel):
    """
    A representation of a user within an integration. The fields provided here are the most commonly occurring across all integrations. For a complete list of fields specific to your integration, please refer to the [info endpoint](#tag/Describe/operation/info).
    """ # noqa: E501
    ...
    custom_attributes: Optional[Dict[str, StrictStr]] = None
