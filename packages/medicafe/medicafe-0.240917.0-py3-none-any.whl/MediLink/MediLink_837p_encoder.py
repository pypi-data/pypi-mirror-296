...
def format_single_claim(patient_data, config, endpoint, transaction_set_control_number, crosswalk): # BUG upstream crosswalk needs to be passed here.
    """
...
def format_claims(parsed_data_list, config, endpoint, starting_transaction_set_control_number, crosswalk): # BUG upstream crosswalk needs to be passed here.
    """
