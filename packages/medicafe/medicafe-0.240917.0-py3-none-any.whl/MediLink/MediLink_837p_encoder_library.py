...
def create_clm_and_related_segments(parsed_data, config, crosswalk): 
    ...
    medisoft_code = parsed_data['DIAG']
    ...
    if diagnosis_code is None:
        error_message = "Diagnosis code is empty for chart number: {}. Please verify the diagnosis code. Medisoft code is {}".format(chart_number, medisoft_code)
        MediLink_ConfigLoader.log(error_message, config, level="CRITICAL")
        print(error_message)
