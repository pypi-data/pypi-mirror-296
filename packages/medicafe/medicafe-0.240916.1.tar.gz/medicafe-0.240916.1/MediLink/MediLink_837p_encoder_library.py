...
def resolve_payer_name(payer_id, config, primary_endpoint, insurance_name, parsed_data):
    ...
    try:
        ...
        print("\nACTION REQUIRED: Please verify the internet connection and the \nPayer ID by searching for it at the expected endpoint's website or using Google.")
        ...
        user_decision = input("\nType 'FORCE' to force-continue with the Medisoft name, \nor press Enter to pause processing and make corrections: ").strip().lower()
