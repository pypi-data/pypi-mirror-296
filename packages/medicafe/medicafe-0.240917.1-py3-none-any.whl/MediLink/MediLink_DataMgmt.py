...
def build_command(winscp_path, winscp_log_path, endpoint_config, remote_directory, operation_type, files, local_storage_path):
    ...
    # Handle download operation
        ...
        # Integrate the local_storage_path for the download
        # BUG This is insufficient to get WinSCP to download to the right location. It's failing on this command.
        # command.append('get * {}'.format(os.path.normpath(local_storage_path)))
        command.append('get *')
    ...
    MediLink_ConfigLoader.log("[Build Command] WinSCP command to be executed: {}".format(command))
