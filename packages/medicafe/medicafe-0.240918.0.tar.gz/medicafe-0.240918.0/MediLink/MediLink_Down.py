# MediLink_Down.py
import os, shutil
from MediLink_Decoder import process_file, display_consolidated_records, write_records_to_csv
...
def translate_files(files, output_directory):
    ...
    for file in files:
        ...
        if file_type_selector.get(ext, False):  # Check if the file type is selected
            ...
            try:
                records = process_file(os.path.join(output_directory, file), output_directory, return_records=True) # Is this correct?
