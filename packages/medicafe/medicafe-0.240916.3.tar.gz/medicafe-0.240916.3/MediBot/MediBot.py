...
if __name__ == "__main__":
    ...
    try:
        ...
        identified_fields = MediBot_Preprocessor.intake_scan(headers, field_mapping, e_state.config)
        
        # Validate Insurance Policy Numbers
        MediLink_ConfigLoader.log("Validating Insurance Policy Numbers for alphanumeric characters...", level="INFO")
        policy_warnings = MediBot_Preprocessor.validate_insurance_policy_numbers(csv_data, identified_fields)
