...
def main():  # noqa: D103
  ...
  parser.add_argument(
    '--vectorstore-location', dest='vectorstore', default=None
  )
  parser.add_argument('--documents-location', dest='documents', default=None)
  ...
  vect_store = vectorstore.get_vector_store(
    vector_store_directory='/home/amarkin/projects/customers/welltech/trends/scripts/trends_db'
  )
