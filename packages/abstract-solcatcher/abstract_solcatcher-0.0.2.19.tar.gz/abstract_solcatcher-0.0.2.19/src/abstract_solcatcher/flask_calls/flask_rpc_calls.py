...
#def sendTransaction(txn=txn, payer_keypair, opts=None,skip_preflight=skip_preflight,preflightCommitment=preflightCommitment):
##  return get_async_response(get_solcatcher_endpoint,endpoint="sendTransaction",txn=txn, payer_keypair=payer_keypair, opts=opts,skip_preflight=skip_preflight)
...
def sendTransaction(txn: Transaction, payer_keypair, opts=None) -> dict:
