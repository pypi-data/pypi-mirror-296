...
def sendTransaction(txn_base64=None,txn=None, payer_keypair=None, opts=None,skip_preflight=None,preflightCommitment=None):
  if txn_base64 == None:
      if txn:
          if payer_keypair:
              txn.sign(payer_keypair)
          txn_base64 = base58.b58encode(txn.serialize()).decode('utf-8')
  return get_async_response(get_solcatcher_endpoint,endpoint="sendTransaction",txn_base64=txn_base64, opts=opts,skip_preflight=skip_preflight,preflightCommitment=preflightCommitment)
