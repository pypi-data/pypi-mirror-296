banner = """
 ...
 / __| | | | '_ \| | / __| __/ _ \ '__|
 \__ \ |_| | |_) | | \__ \ ||  __/ |   
 |___/\__,_|_.__/|_|_|___/\__\___|_|   
                     rebuilt by zen
"""
...
def main():
    ...
    parser = ArgumentParser(description="Subdomains Lister")
    ...
    # get the subdomains from sublister
    verbose = True if args.quiet == False else False
    sublister = SubLister(verbose=verbose, vt_api_key=vt_api_key, shodan_api_key=shodan_api_key)
    subdomains = sublister.get_subdomains(args.domain)
