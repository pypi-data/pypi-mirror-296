    ...
    * Handling teleop control datapoints
    ...
    def prepare_text(
        ...
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
        :return: The prepared text datapoint
        """
    ...
    def prepare_json(
        ...
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
        :return: The prepared JSON datapoint
        """
        validate_type(value, [str])
    ...
    def prepare_numeric(
        ...
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
        :return: The prepared numeric datapoint
        """
    ...
    def prepare_numericset(
        ...
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
        :return: The prepared numeric set datapoint
        """
    ...
    def prepare_image(
        ...
        :param stream: The name of the Formant stream for the datapoint
        :param value: The datapoint value: raw bytes of an encoded image or frame
        :param url: The datapoint url: path to a local file or valid remote URL for
            remote files
        :param content_type: The format of the encoded image or frame.
            Defaults to "image/jpg".
        :param tags: Tags for the datapoint
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
        :return: The prepared image datapoint
        """
    ...
    def prepare_bitset(
        ...
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
        :return: The prepared bitset datapoint
        """
    ...
    def prepare_geolocation(
        ...
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
        :param altitude: The altitude value (optional)
        :param orientation: The orientation value (optional)
    ...
    def prepare_battery(
        ...
        :param stream: The name of the Formant stream for the datapoint
        :param percentage: The battery charge percentage
        :param voltage: The battery voltage (optional)
        :param current: The battery current (optional)
        :param charge: The battery charge (optional)
        :param tags: Tags for the datapoint
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
    ...
    def prepare_file(
        ...
        :param stream: The name of the Formant stream for the datapoint
        :param url: The file url: path to a local file or valid remote URL for remote files
        :param filename: The file name: name displayed inside Formant module
        :param tags: Tags for the datapoint
        :param timestamp: Unix timestamp in milliseconds for the datapoint.
            Uses the current time by default
