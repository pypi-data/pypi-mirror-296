...
__all__ = [
    ...
    "ApplicationVariantV0ResponseConfiguration",
...
class ApplicationVariantV0ResponseConfiguration(BaseModel):
...
class ApplicationVariantV0Response(BaseModel):
    ...
    configuration: ApplicationVariantV0ResponseConfiguration
