...
__all__ = [
    ...
    "ItemApplicationVariantV0ResponseConfiguration",
...
class ItemApplicationVariantV0ResponseConfiguration(BaseModel):
...
class ItemApplicationVariantV0Response(BaseModel):
    ...
    configuration: ItemApplicationVariantV0ResponseConfiguration
