...
class ApplicationBuilder:
    ...
    def create_completion_application(self, *, account_id: str, application_name: str, completion_model_id: str) -> ApplicationTemplate:
        """
        ### Description
    ...
    def process(self, *, query: str) -> str:
        if not self.application:
            raise ValueError("Application not created - you need to create the app with one of the create_ methods on this class before processing.")
