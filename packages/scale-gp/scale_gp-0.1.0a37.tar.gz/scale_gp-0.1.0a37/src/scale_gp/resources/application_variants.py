...
class ApplicationVariantsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        account_id: str,
        configuration: application_variant_create_params.ApplicationVariantV0RequestConfiguration,
        name: str,
        version: Literal["V0"],
    ...
    def create(
        ...
        *,
        ...
        application_spec_id: str | NotGiven = NOT_GIVEN,
        configuration: object | NotGiven = NOT_GIVEN,
        description: str | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
    ...
    @required_args(["account_id", "configuration", "name", "version"], ["account_id", "name", "version"])
    def create(
        self,
        *,
        account_id: str,
