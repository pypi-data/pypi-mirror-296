...
def assign_with_validation(retrieve_from: dict, assign_to: dict, key, type: BaseModel, raise_exception=False):
    """
    Input:  
...
def separate_params(params: dict, remove_none=True, raise_exception=False):
    ...
    assign_with_validation(params, keywordsai_params, "keywordsai_api_controls", KeywordsAIAPIControlParams, raise_exception)
