...
from iikoserver_api.schemas.implementation_act import ImplementationActItemTypeEnum
...
class IikoServerApi:
    ...
    def export_conceptions(self, from_date: datetime = datetime.now() - timedelta(days=365), to_date: datetime = datetime.now()):
        params = {
            'key': self.token,
            'reportType': 'TRANSACTIONS'
        }
