...
class app:
    ...
    def add_source(self, source_name: str, source_type: str, auto_save: bool = False):
        return source(app = self, source_name = source_name, source_type = source_type)
    ...
    def __create_or_alter(self, script: str):
        try:
            ...
            try:
                ...
                print(f'{Colored.FAIL}Object exists.{Colored.ENDC}')
