...
class Domain:
    ...
    * Attributes are created dynamically,
    ...
    def _doOptionalFields(
        ...
        if "registrant" in data:
            if "registrant_organization" in data:
                self.registrant = data["registrant_organization"].strip()
              #  self.registrant = data["registrant_organization"][0].strip() XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
            else:
              #  self.registrant = data["registrant"][0].strip() XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
                self.registrant = data["registrant"].strip()
    ...
    def _parseData(
        ...
        self.registrar = dc.data["registrar"].strip()
        self.registrant_country = dc.data["registrant_country"].strip()
       # self.registrar = dc.data["registrar"][0].strip() XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
       # self.registrant_country = dc.data["registrant_country"][0].strip() XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
