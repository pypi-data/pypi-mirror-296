...
class Dataset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "parse_config", "index_config", "resource_count", "success_resource_count", "create_time", "update_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "parse_config": ParseConfig.from_dict(obj["parse_config"]) if obj.get("parse_config") is not None else None,
