...
class ListResourcesRequest(BaseModel):
    ...
    dataset_id: Optional[StrictStr] = 'default'
    page: Optional[StrictInt] = 1
    size: Optional[Annotated[int, Field(strict=True, ge=-1)]] = 10
    table_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["resource_ids", "dataset_id", "page", "size", "table_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataset_id": obj.get("dataset_id") if obj.get("dataset_id") is not None else 'default',
