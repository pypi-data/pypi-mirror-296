# Making a new release of bscheduler
...
Configure the following secrets in the [GitHub repository](https://github.com/b-scheduler/bscheduler/settings/secrets/actions/new):
