...
class BlurpartialApi:
    ...
    @validate_call
    def blurpartial_async_get(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
        y0: Annotated[StrictInt, Field(description="defines the y coordinate of the first point of the rectangle to blur")],
        y1: Annotated[StrictInt, Field(description="defines the y coordinate of the second point of the rectangle to blur.")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        ...
        :type y1: int
        :param sigma: controls the strength of the blur
        :type sigma: float
        ...
        _param = self._blurpartial_async_get_serialize(
            url=url,
            x0=x0,
            x1=x1,
            y0=y0,
    ...
    @validate_call
    def blurpartial_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
    ...
    @validate_call
    def blurpartial_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
    ...
    def _blurpartial_async_get_serialize(
        self,
        url,
        x0,
        x1,
        ...
        if sigma is not None:
            ...
            _query_params.append(('sigma', sigma))
            
        if x0 is not None:
            
            _query_params.append(('x0', x0))
            
        if x1 is not None:
            
            _query_params.append(('x1', x1))
            
        if y0 is not None:
            
            _query_params.append(('y0', y0))
            
        if y1 is not None:
            
            _query_params.append(('y1', y1))
    ...
    @validate_call
    def blurpartial_async_post(
        self,
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
        y0: Annotated[StrictInt, Field(description="defines the y coordinate of the first point of the rectangle to blur")],
        y1: Annotated[StrictInt, Field(description="defines the y coordinate of the second point of the rectangle to blur.")],
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._blurpartial_async_post_serialize(
            x0=x0,
            x1=x1,
            y0=y0,
            y1=y1,
    ...
    @validate_call
    def blurpartial_async_post_with_http_info(
        self,
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
        y0: Annotated[StrictInt, Field(description="defines the y coordinate of the first point of the rectangle to blur")],
    ...
    @validate_call
    def blurpartial_async_post_without_preload_content(
        self,
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
        y0: Annotated[StrictInt, Field(description="defines the y coordinate of the first point of the rectangle to blur")],
    ...
    def _blurpartial_async_post_serialize(
        self,
        x0,
        x1,
        y0,
    ...
    def blurpartial_sync_get(
        ...
        _param = self._blurpartial_sync_get_serialize(
            url=url,
            x0=x0,
            x1=x1,
            y0=y0,
    ...
    @validate_call
    def blurpartial_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
    ...
    @validate_call
    def blurpartial_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
    ...
    def _blurpartial_sync_get_serialize(
        self,
        url,
        x0,
        x1,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/blurpartial/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def blurpartial_sync_post(
        ...
        _param = self._blurpartial_sync_post_serialize(
            x0=x0,
            x1=x1,
            y0=y0,
            y1=y1,
    ...
    @validate_call
    def blurpartial_sync_post_with_http_info(
        self,
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
        y0: Annotated[StrictInt, Field(description="defines the y coordinate of the first point of the rectangle to blur")],
    ...
    @validate_call
    def blurpartial_sync_post_without_preload_content(
        self,
        x0: Annotated[StrictInt, Field(description="defines the x coordinate of the first point of the rectangle to blur")],
        x1: Annotated[StrictInt, Field(description="defines the x coordinate of the second point of the rectangle to blur")],
        y0: Annotated[StrictInt, Field(description="defines the y coordinate of the first point of the rectangle to blur")],
    ...
    def _blurpartial_sync_post_serialize(
        self,
        x0,
        x1,
        y0,
