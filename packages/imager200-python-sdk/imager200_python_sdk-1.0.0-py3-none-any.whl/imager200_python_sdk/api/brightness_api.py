...
class BrightnessApi:
    ...
    @validate_call
    def brightness_async_get(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        ...
        _param = self._brightness_async_get_serialize(
            url=url,
    ...
    @validate_call
    def brightness_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def brightness_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    def _brightness_async_get_serialize(
        self,
        url,
        percentage,
        _request_auth,
        ...
        if percentage is not None:
            ...
            _query_params.append(('percentage', percentage))
    ...
    def brightness_async_post(
        ...
        _param = self._brightness_async_post_serialize(
            body=body,
            percentage=percentage,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def brightness_async_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def brightness_async_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    def _brightness_async_post_serialize(
        self,
        body,
        percentage,
        _request_auth,
    ...
    def brightness_sync_get(
        ...
        _param = self._brightness_sync_get_serialize(
            url=url,
            percentage=percentage,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def brightness_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def brightness_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    def _brightness_sync_get_serialize(
        self,
        url,
        percentage,
        _request_auth,
    ...
    def brightness_sync_post(
        ...
        _param = self._brightness_sync_post_serialize(
            body=body,
            percentage=percentage,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def brightness_sync_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def brightness_sync_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        percentage: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=-100)], Annotated[int, Field(le=100, strict=True, ge=-100)]]], Field(description="controls the brightness level")] = None,
        _request_timeout: Union[
    ...
    def _brightness_sync_post_serialize(
        self,
        body,
        percentage,
        _request_auth,
