...
class BlurhashApi:
    ...
    def blurhash_async_get(
        ...
        _param = self._blurhash_async_get_serialize(
            url=url,
    ...
    @validate_call
    def blurhash_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def blurhash_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    def _blurhash_async_get_serialize(
        self,
        url,
        _request_auth,
        _content_type,
    ...
    def blurhash_async_post(
        ...
        _param = self._blurhash_async_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def blurhash_async_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def blurhash_async_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    def _blurhash_async_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def blurhash_sync_get(
        ...
        _param = self._blurhash_sync_get_serialize(
            url=url,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def blurhash_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def blurhash_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    def _blurhash_sync_get_serialize(
        self,
        url,
        _request_auth,
        _content_type,
    ...
    def blurhash_sync_post(
        ...
        _param = self._blurhash_sync_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def blurhash_sync_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def blurhash_sync_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        _request_timeout: Union[
            None,
    ...
    def _blurhash_sync_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
