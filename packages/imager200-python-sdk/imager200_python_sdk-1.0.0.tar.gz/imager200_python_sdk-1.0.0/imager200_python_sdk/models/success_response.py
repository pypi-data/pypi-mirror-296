...
class SuccessResponse(BaseModel):
    ...
    SuccessResponse
    """ # noqa: E501
    execution_id: Optional[StrictStr] = Field(default=None, description="this is important for the tracking of the execution of the pipeline, it can be used with the /pipeline/{execution_id}/status", alias="executionId")
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["executionId", "message"]
