...
class ImageMetadata(BaseModel):
    ...
    compose: Optional[StrictStr] = None
    compression: Optional[StrictStr] = None
    depth_in_bits: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="depthInBits")
    dispose: Optional[StrictStr] = None
    endianness: Optional[StrictStr] = None
    format: Optional[StrictStr] = None
    gamma: Optional[Union[StrictFloat, StrictInt]] = None
    geometry: Optional[StrictStr] = None
    intensity: Optional[StrictStr] = None
    interlace: Optional[StrictStr] = None
    iterations: Optional[Union[StrictFloat, StrictInt]] = None
    matte_color: Optional[StrictStr] = Field(default=None, alias="matteColor")
    number_of_pixels: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="numberOfPixels")
    orientation: Optional[StrictStr] = None
    page_geometry: Optional[StrictStr] = Field(default=None, alias="pageGeometry")
    rendering_intent: Optional[StrictStr] = Field(default=None, alias="renderingIntent")
    size_in_bytes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="sizeInBytes")
    tainted: Optional[StrictStr] = None
    transparent_color: Optional[StrictStr] = Field(default=None, alias="transparentColor")
    type: Optional[StrictStr] = None
    units: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["backgroundColor", "borderColor", "class", "colorspace", "compose", "compression", "depthInBits", "dispose", "endianness", "format", "gamma", "geometry", "intensity", "interlace", "iterations", "matteColor", "numberOfPixels", "orientation", "pageGeometry", "renderingIntent", "sizeInBytes", "tainted", "transparentColor", "type", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "depthInBits": obj.get("depthInBits"),
            "dispose": obj.get("dispose"),
            "endianness": obj.get("endianness"),
            "format": obj.get("format"),
            "gamma": obj.get("gamma"),
            "geometry": obj.get("geometry"),
            "intensity": obj.get("intensity"),
            "interlace": obj.get("interlace"),
            "iterations": obj.get("iterations"),
            "matteColor": obj.get("matteColor"),
            "numberOfPixels": obj.get("numberOfPixels"),
            "orientation": obj.get("orientation"),
            "pageGeometry": obj.get("pageGeometry"),
            "renderingIntent": obj.get("renderingIntent"),
            "sizeInBytes": obj.get("sizeInBytes"),
            "tainted": obj.get("tainted"),
            "transparentColor": obj.get("transparentColor"),
            "type": obj.get("type"),
            "units": obj.get("units")
        })
        return _obj
