...
class BlendApi:
    ...
    @validate_call
    def blend_async_post(
        self,
        payload: Annotated[BlendRequest, Field(description="request")],
        ...
        _param = self._blend_async_post_serialize(
            payload=payload,
    ...
    @validate_call
    def blend_async_post_with_http_info(
        self,
        payload: Annotated[BlendRequest, Field(description="request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def blend_async_post_without_preload_content(
        self,
        payload: Annotated[BlendRequest, Field(description="request")],
        _request_timeout: Union[
            None,
    ...
    def _blend_async_post_serialize(
        self,
        payload,
        _request_auth,
        _content_type,
    ...
    def blend_sync_post(
        ...
        _param = self._blend_sync_post_serialize(
            payload=payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def blend_sync_post_with_http_info(
        self,
        payload: Annotated[BlendRequest, Field(description="request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def blend_sync_post_without_preload_content(
        self,
        payload: Annotated[BlendRequest, Field(description="request")],
        _request_timeout: Union[
            None,
    ...
    def _blend_sync_post_serialize(
        self,
        payload,
        _request_auth,
        _content_type,
