...
class BlurApi:
    ...
    def blur_async_get(
        ...
        _param = self._blur_async_get_serialize(
            url=url,
            sigma=sigma,
    ...
    @validate_call
    def blur_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def blur_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
    ...
    def blur_async_post(
        ...
        _param = self._blur_async_post_serialize(
            body=body,
            sigma=sigma,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def blur_async_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def blur_async_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
    ...
    def _blur_async_post_serialize(
        self,
        body,
        sigma,
        _request_auth,
    ...
    def blur_sync_get(
        ...
        _param = self._blur_sync_get_serialize(
            url=url,
            sigma=sigma,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def blur_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def blur_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
    ...
    def blur_sync_post(
        ...
        _param = self._blur_sync_post_serialize(
            body=body,
            sigma=sigma,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def blur_sync_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def blur_sync_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp")],
        sigma: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0.1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="controls the strength of the blur")] = None,
        _request_timeout: Union[
