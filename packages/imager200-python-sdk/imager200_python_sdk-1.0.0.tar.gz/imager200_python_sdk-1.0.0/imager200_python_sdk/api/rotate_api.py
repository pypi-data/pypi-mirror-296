...
class RotateApi:
    ...
    @validate_call
    def rotate_async_get(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
        ...
        :type angle: float
        :param background_color: the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.
        ...
        _param = self._rotate_async_get_serialize(
            url=url,
            angle=angle,
    ...
    @validate_call
    def rotate_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    @validate_call
    def rotate_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    def _rotate_async_get_serialize(
        self,
        url,
        angle,
        background_color,
        ...
        if angle is not None:
            ...
            _query_params.append(('angle', angle))
    ...
    def rotate_async_post(
        ...
        _param = self._rotate_async_post_serialize(
            body=body,
            angle=angle,
            background_color=background_color,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rotate_async_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    @validate_call
    def rotate_async_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    def _rotate_async_post_serialize(
        self,
        body,
        angle,
        background_color,
    ...
    def rotate_sync_get(
        ...
        _param = self._rotate_sync_get_serialize(
            url=url,
            angle=angle,
            background_color=background_color,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rotate_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    @validate_call
    def rotate_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    def _rotate_sync_get_serialize(
        self,
        url,
        angle,
        background_color,
    ...
    def rotate_sync_post(
        ...
        _param = self._rotate_sync_post_serialize(
            body=body,
            angle=angle,
            background_color=background_color,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rotate_sync_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    @validate_call
    def rotate_sync_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        angle: Annotated[Optional[Union[Annotated[float, Field(le=360, strict=True, ge=0)], Annotated[int, Field(le=360, strict=True, ge=0)]]], Field(description="rotation angle in degrees")] = None,
        background_color: Annotated[Optional[StrictStr], Field(description="the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.")] = None,
    ...
    def _rotate_sync_post_serialize(
        self,
        body,
        angle,
        background_color,
