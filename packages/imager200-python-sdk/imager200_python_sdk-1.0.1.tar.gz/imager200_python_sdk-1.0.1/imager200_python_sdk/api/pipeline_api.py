...
class PipelineApi:
    ...
    def pipeline_get(
        ...
        name: Annotated[StrictStr, Field(description="the name of the pipeline")],
    ...
    @validate_call
    def pipeline_get_status(
        self,
        execution_id: Annotated[StrictStr, Field(description="the execution id obtained from the pipeline creation response")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param execution_id: the execution id obtained from the pipeline creation response (required)
        ...
        _param = self._pipeline_get_status_serialize(
    ...
    @validate_call
    def pipeline_get_status_with_http_info(
        self,
        execution_id: Annotated[StrictStr, Field(description="the execution id obtained from the pipeline creation response")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PipelineExecutionResult]:
        """pipeline_get_status
    ...
    @validate_call
    def pipeline_get_status_without_preload_content(
        self,
        execution_id: Annotated[StrictStr, Field(description="the execution id obtained from the pipeline creation response")],
        _request_timeout: Union[
            None,
    ...
    def _pipeline_get_status_serialize(
        self,
        execution_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pipeline/{execution_id}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def pipeline_post(
        self,
        name: Annotated[StrictStr, Field(description="the name of the pipeline")],
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif (depending on operations)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._pipeline_post_serialize(
            name=name,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def pipeline_post_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="the name of the pipeline")],
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif (depending on operations)")],
        _request_timeout: Union[
    ...
    @validate_call
    def pipeline_post_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="the name of the pipeline")],
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif (depending on operations)")],
        _request_timeout: Union[
