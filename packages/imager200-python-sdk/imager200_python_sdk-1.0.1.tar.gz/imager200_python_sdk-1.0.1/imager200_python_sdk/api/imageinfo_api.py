...
class ImageinfoApi:
    ...
    def imageinfo_sync_get(
        ...
        _param = self._imageinfo_sync_get_serialize(
            url=url,
    ...
    @validate_call
    def imageinfo_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def imageinfo_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        _request_timeout: Union[
            None,
    ...
    def _imageinfo_sync_get_serialize(
        self,
        url,
        _request_auth,
        _content_type,
    ...
    def imageinfo_sync_post(
        ...
        _param = self._imageinfo_sync_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def imageinfo_sync_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def imageinfo_sync_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
        _request_timeout: Union[
            None,
    ...
    def _imageinfo_sync_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
