...
class PipelineExecutionResult(BaseModel):
    ...
    failure_step: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    size_in_megabytes: Optional[Union[StrictFloat, StrictInt]] = None
    status: Optional[PipelineStatus] = None
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["created", "failure_step", "name", "size_in_megabytes", "status", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failure_step": obj.get("failure_step"),
            "name": obj.get("name"),
            "size_in_megabytes": obj.get("size_in_megabytes"),
