...
class CompressApi:
    ...
    @validate_call
    def compress_async_get(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
        progressive_jpeg: Annotated[Optional[StrictBool], Field(description="It toggles the generation of a progressive JPEG. A \"false\" value generates a baseline JPEG")] = None,
        ...
        :type url: str
        :param jpeg_quality: defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)
        :type jpeg_quality: int
        :param png_optimization_level: defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.
        :type png_optimization_level: int
        :param progressive_jpeg: It toggles the generation of a progressive JPEG. A \"false\" value generates a baseline JPEG
        :type progressive_jpeg: bool
        ...
        _param = self._compress_async_get_serialize(
            url=url,
    ...
    @validate_call
    def compress_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    @validate_call
    def compress_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    def _compress_async_get_serialize(
        self,
        url,
        jpeg_quality,
        ...
        if png_optimization_level is not None:
            
            _query_params.append(('pngOptimizationLevel', png_optimization_level))
            
        if progressive_jpeg is not None:
            
            _query_params.append(('progressiveJpeg', progressive_jpeg))
    ...
    @validate_call
    def compress_async_post(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
        progressive_jpeg: Annotated[Optional[StrictBool], Field(description="It toggles the generation of a progressive JPEG. A \"false\" value generates a baseline JPEG")] = None,
        _request_timeout: Union[
        ...
        _param = self._compress_async_post_serialize(
            body=body,
            jpeg_quality=jpeg_quality,
            png_optimization_level=png_optimization_level,
            progressive_jpeg=progressive_jpeg,
    ...
    @validate_call
    def compress_async_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    @validate_call
    def compress_async_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    def _compress_async_post_serialize(
        self,
        body,
        jpeg_quality,
        png_optimization_level,
    ...
    def compress_sync_get(
        ...
        _param = self._compress_sync_get_serialize(
            url=url,
            jpeg_quality=jpeg_quality,
            png_optimization_level=png_optimization_level,
            progressive_jpeg=progressive_jpeg,
    ...
    @validate_call
    def compress_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    @validate_call
    def compress_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    def _compress_sync_get_serialize(
        self,
        url,
        jpeg_quality,
        png_optimization_level,
    ...
    def compress_sync_post(
        ...
        _param = self._compress_sync_post_serialize(
            body=body,
            jpeg_quality=jpeg_quality,
            png_optimization_level=png_optimization_level,
            progressive_jpeg=progressive_jpeg,
    ...
    @validate_call
    def compress_sync_post_with_http_info(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    @validate_call
    def compress_sync_post_without_preload_content(
        self,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png")],
        jpeg_quality: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)")] = None,
        png_optimization_level: Annotated[Optional[Annotated[int, Field(le=7, strict=True, ge=0)]], Field(description="defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.")] = None,
    ...
    def _compress_sync_post_serialize(
        self,
        body,
        jpeg_quality,
        png_optimization_level,
