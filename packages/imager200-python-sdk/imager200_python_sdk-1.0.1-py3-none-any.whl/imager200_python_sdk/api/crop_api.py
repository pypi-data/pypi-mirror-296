...
class CropApi:
    ...
    def crop_async_get(
        ...
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
        y0: Annotated[StrictInt, Field(description="the y coordinate of the first point of the rectangle to crop.")],
        y1: Annotated[StrictInt, Field(description="the y coordinate of the second point of the rectangle to crop.")],
        ...
        _param = self._crop_async_get_serialize(
            url=url,
            x0=x0,
            x1=x1,
            y0=y0,
    ...
    @validate_call
    def crop_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
    ...
    @validate_call
    def crop_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
    ...
    def crop_async_post(
        ...
        _param = self._crop_async_post_serialize(
            x0=x0,
            x1=x1,
            y0=y0,
            y1=y1,
    ...
    @validate_call
    def crop_async_post_with_http_info(
        self,
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
        y0: Annotated[StrictInt, Field(description="the y coordinate of the first point of the rectangle to crop.")],
    ...
    @validate_call
    def crop_async_post_without_preload_content(
        self,
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
        y0: Annotated[StrictInt, Field(description="the y coordinate of the first point of the rectangle to crop.")],
    ...
    def _crop_async_post_serialize(
        self,
        x0,
        x1,
        y0,
    ...
    def crop_sync_get(
        ...
        _param = self._crop_sync_get_serialize(
            url=url,
            x0=x0,
            x1=x1,
            y0=y0,
    ...
    @validate_call
    def crop_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
    ...
    @validate_call
    def crop_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
    ...
    def crop_sync_post(
        ...
        _param = self._crop_sync_post_serialize(
            x0=x0,
            x1=x1,
            y0=y0,
            y1=y1,
    ...
    @validate_call
    def crop_sync_post_with_http_info(
        self,
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
        y0: Annotated[StrictInt, Field(description="the y coordinate of the first point of the rectangle to crop.")],
    ...
    @validate_call
    def crop_sync_post_without_preload_content(
        self,
        x0: Annotated[StrictInt, Field(description="the x coordinate of the first point of the rectangle to crop.")],
        x1: Annotated[StrictInt, Field(description="the x coordinate of the second point of the rectangle to crop.")],
        y0: Annotated[StrictInt, Field(description="the y coordinate of the first point of the rectangle to crop.")],
