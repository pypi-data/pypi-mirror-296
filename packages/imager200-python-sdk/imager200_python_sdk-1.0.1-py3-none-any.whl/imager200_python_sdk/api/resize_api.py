...
class ResizeApi:
    ...
    @validate_call
    def resize_async_get(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        height: StrictInt,
        width: StrictInt,
        resampling_algorithm: Annotated[Optional[StrictStr], Field(description="It allows changing the resampling algorithm used when resizing (resampling) the image.")] = None,
        ...
        :type width: int
        :param resampling_algorithm: It allows changing the resampling algorithm used when resizing (resampling) the image.
        :type resampling_algorithm: str
        ...
        _param = self._resize_async_get_serialize(
            url=url,
            height=height,
            width=width,
    ...
    @validate_call
    def resize_async_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        height: StrictInt,
        width: StrictInt,
    ...
    @validate_call
    def resize_async_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        height: StrictInt,
        width: StrictInt,
    ...
    def _resize_async_get_serialize(
        self,
        url,
        height,
        width,
        ...
        if resampling_algorithm is not None:
            
            _query_params.append(('resamplingAlgorithm', resampling_algorithm))
    ...
    def resize_async_post(
        ...
        _param = self._resize_async_post_serialize(
            height=height,
            width=width,
            body=body,
            resampling_algorithm=resampling_algorithm,
    ...
    @validate_call
    def resize_async_post_with_http_info(
        self,
        height: StrictInt,
        width: StrictInt,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
    ...
    @validate_call
    def resize_async_post_without_preload_content(
        self,
        height: StrictInt,
        width: StrictInt,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
    ...
    def _resize_async_post_serialize(
        self,
        height,
        width,
        body,
    ...
    def resize_sync_get(
        ...
        _param = self._resize_sync_get_serialize(
            url=url,
            height=height,
            width=width,
            resampling_algorithm=resampling_algorithm,
    ...
    @validate_call
    def resize_sync_get_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        height: StrictInt,
        width: StrictInt,
    ...
    @validate_call
    def resize_sync_get_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="image url, supported formats jpeg,png,bmp,gif")],
        height: StrictInt,
        width: StrictInt,
    ...
    def _resize_sync_get_serialize(
        self,
        url,
        height,
        width,
    ...
    def resize_sync_post(
        ...
        _param = self._resize_sync_post_serialize(
            height=height,
            width=width,
            body=body,
            resampling_algorithm=resampling_algorithm,
    ...
    @validate_call
    def resize_sync_post_with_http_info(
        self,
        height: StrictInt,
        width: StrictInt,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
    ...
    @validate_call
    def resize_sync_post_without_preload_content(
        self,
        height: StrictInt,
        width: StrictInt,
        body: Annotated[Union[StrictBytes, StrictStr], Field(description="image binary data, acceptable formats: jpeg,png,bmp,gif")],
    ...
    def _resize_sync_post_serialize(
        self,
        height,
        width,
        body,
