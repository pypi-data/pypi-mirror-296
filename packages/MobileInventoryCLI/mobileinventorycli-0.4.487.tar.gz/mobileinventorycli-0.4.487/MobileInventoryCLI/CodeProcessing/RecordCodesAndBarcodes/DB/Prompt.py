...
'''
            ...
            postFilterMsg=f"{Style.underline}{Back.deep_sky_blue_4a}{Fore.light_yellow}Post_Filtering_Final_Cmd('{Style.bold}{Style.res_underline}{Back.spring_green_4}{Fore.white}{cmd}{Style.dim}{Back.deep_sky_blue_4a}{Fore.white}{Style.underline}{Style.res_bold}{Back.deep_sky_blue_4a}{Fore.light_yellow}'){Style.reset}"
            print(postFilterMsg)
