...
'''
            ...
            postFilterMsg=f"{Style.italic}{Back.deep_sky_blue_4a}{Fore.white}Post_Filtering_Final_Cmd('{Style.italic}{Back.spring_green_4}{Fore.white}{cmd}{Style.bold}{Back.deep_sky_blue_4a}'{Fore.white}){Style.reset}"
            print(postFilterMsg)
