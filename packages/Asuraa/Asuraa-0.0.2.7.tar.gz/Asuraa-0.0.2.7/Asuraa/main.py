...
class Asuraa:
    ...
    Support group : https://t.me/AsuraaSupports
    Owner : @itzAsuraa
        """
        pass
    ...
    def datagpt(args:str):
        ...
        try:
            ...
            return {"results":data["text"],"join": "@AsuraaSupports", "success": True
                    }
    ...
    def blackbox(args: str) -> requests.Response:
        ...
        try:
            ...
            if response.status_code == 200:
                return {"results": response.text, "join": "@AsuraaSupports", "success": True}
        except Exception as e:
            return e  
    ...
    def gemini(args: str) -> dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"results":generated_text,"join": "@AsuraaSupports", "success": True}
        except Exception as e:
            return e
    ...
    @staticmethod
    def bingimage(self, imgname: str, limit: int = 20) -> List[str]:
        """
        Fetch Bing image links based on the photo name and limit.

        Args:
            imgname (str): The search query for the image.
