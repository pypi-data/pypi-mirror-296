...
class FilteringResult:
    """
    Represents the result of an input or output filtering operation.

    Attributes:
        message: A message or description of the filtering outcome.
        data: Additional data relevant to the filtering process.
    """
...
class ModuleResults:
    ...
    llm: LLMResult
    input_filtering: Optional[FilteringResult] = None
    output_filtering: Optional[FilteringResult] = None
