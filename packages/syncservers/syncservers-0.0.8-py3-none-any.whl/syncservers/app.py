...
class SyncServersApp:
    ...
    def run(self):
        ...
        if self._config.get_path_mappings(LiveSync.PATH_TYPE):
            ...
            live_sync.add_retry_task_to_schedule(self._schedule_jobs)
        ...
        if self._config.get_path_mappings(CronSync.PATH_TYPE):
            ...
            cron_sync.add_retry_task_to_schedule(self._schedule_jobs)
...
async def run():
    ...
    # schedule
    schedule = LightweightCron(schedule_jobs)
