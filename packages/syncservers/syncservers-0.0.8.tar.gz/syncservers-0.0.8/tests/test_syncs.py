...
class Test(IsolatedAsyncioTestCase):
    ...
    def test_add_retry_task_to_schedule(self):
        ...
        sync.add_retry_task_to_schedule(schedule_jobs)
        ...
        self.assertEqual(schedule_jobs[0].cron, "my_retry_cron")
        mocked_get_config.close()
    ...
    def test_cron_add_to_schedule(self):
        ...
        self.assertEqual(schedule_jobs[0].cron, "*/4 * * * *")
        self.assertDictEqual(schedule_jobs[0].kwargs, {
            "base_sync_path": "/tmp/d1",
            "sync_path": "/tmp/d1",
            "is_folder": True,
        })
        self.assertEqual(schedule_jobs[1].cron, "*/5 * * * *")
        self.assertDictEqual(schedule_jobs[1].kwargs, {
            "base_sync_path": "/tmp/d2",
            "sync_path": "/tmp/d2",
            "is_folder": True,
        })
