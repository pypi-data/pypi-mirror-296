...
class Test(IsolatedAsyncioTestCase):
    ...
    def test_config(self, mocked_sync_server, mocked_getmtime):
        ...
        # verify config
        # servers
        self.assertEqual(len(config._servers), 2)
        self.assertTrue("server1" in config._servers)
        self.assertTrue("server2" in config._servers)
        ...
        # live paths
        paths = config._path_type_mappings["live"]
        ...
        # cron paths
        paths = config._path_type_mappings["cron"]
