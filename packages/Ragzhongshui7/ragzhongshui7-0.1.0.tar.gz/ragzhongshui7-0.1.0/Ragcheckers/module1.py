...
# 解析命令行参数
    def parse_arguments():
        ...
        parser.add_argument('openai_api_key', type=str, help='Name of the sheet to process')
    ...
    def main():
        ...
        print("FFFF"+args.openai_api_key)

        # 读取Excel文件中的特定Sheet
        df = pd.read_excel(args.excel_file_path, sheet_name=args.sheet_name)
        openai_api_key.append(args.openai_api_key)
    ...
    print("DDDD"+str(openai_api_key))
       # set-up the evaluator
    evaluator = RAGChecker(
        extractor_name="openai/gpt-4o-2024-08-06",
        checker_name="openai/gpt-4o-2024-08-06",
        extractor_api_base='https://openkey.cloud/v1',
        checker_api_base='https://openkey.cloud/v1',
        openai_api_key=str(openai_api_key[0]),
        # openai_api_key='sk-UpQy2ElxV7S6OH1V57Dc0429F6Ec410d92Ce9696Aa856f87',
