...
class AssistantModel:
    ...
    def chat_completions(
        ...
        :param model: If this flag is set to 'claude-3-5-sonnet', then the model used is Claude 3.5 Sonnet. If this flag is set to 'gpt-4o', then the model used is OpenAI's GPT-4o.
        :type model: str (default 'gpt-4o')
        ...
        """
        if model != 'gpt-4o' and model != 'claude-3-5-sonnet':
