...
def create_837_file():
    ...
    # If you're missing file id's make sure this you're commiting
    db.commit()
...
class ISA(object):
    ...
    def write_segments(self, writer):
        ...
        writer.write_segment([
            ...
            '', '', '', '', '', '', # NM103-NM107 Blank
            'FI',               # NM108: Identification Code Qualifier (FEIN)
            '746000119'         # NM109: Identification Code 
        ])
        ## POSTAL CODE
        writer.write_segment([
            'N4',
            '', '',             # N401-N402: Blank
            '787441609'         # N403: Postal Code
        ])
...
class ServiceItem(object):
    ...
    def write_segments(self, writer, parent_hlevel):
        ...
        ## REFERENCE IDENTIFICATION writer.write_segment([
        writer.write_segment([
            'REF',
            '0B',               # 01:       Qualifier
