...
class X12File(object):
    ...
    @property
    def path(self):
        return dpath("sr/tx837", self.name)
    ...
    def name(self):
        return (
           'tx' +
           '631040950' +    # Sender FEIN 
           '359021950' +    # Sender Zip Code
           '741956695' +    # Insurance Carrier FEIN
           '837' +          # Record Type
           self.usage_indicator.lower() +
           self._timestamp + '.txt')
...
class ISA(object):
    ...
    def write_segments(self, writer):
        ...
        writer.write_segment([
            ...
            'ZZ',               # Interchange ID Qualifier
            '746000119      ',  # Interchange Receiver ID
        ...
        writer.write_segment([
            ...
            '746000119',        # Application Receiver's Code
...
class Carrier(object):
    ...
    def st_control_number_fmt_9n(self):
        #return "%05d" % self._xfile.st_control_number
...
class ServiceItem(object):
    ...
    def write_segments(self, writer, parent_hlevel):
        ...
        if pharmacy.address_1: 
            pharmacy_address_1 = pharmacy.address_1

        if pharmacy.address_2:
            if pharmacy_address_1 == '':
                pharmacy_address_1 =  pharmacy.address_2
            else:
                pharmacy_address_2 = pharmacy.address_2

        writer.write_segment([
            'N3',
            pharmacy_address_1, #NM301 ADDRESS 1
            pharmacy_address_2  #NM302 ADDRESS 2
        ])
