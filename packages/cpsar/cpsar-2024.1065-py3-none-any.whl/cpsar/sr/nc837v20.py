"""
Produces an 837 file to send to North Carolina Remote Server
...
def create_837_file(max_records):
    db.setup()
    data = DataService(db, 'NC')

    items = data.unreported_items(max_records)
...
class Program(Program):
    def setup_options(self):
        ...
        self.add_option('-m', '--max-records', dest="max_records",
            default=50,
            help='Limit the amount of records generated in the 837 file'
                 'the default is 50')

    def main(self):
        if self.opts.max_records:
            self.max_records = int(self.opts.max_records)
        create_837_file(self.max_records)
...
class X12File(object):
    ...
    @property
    def path(self):
        return dpath("sr/nc837", self.name)
...
class ISA(object):
    ...
    def write_segments(self, writer):
        ...
        writer.write_segment([
            ...
            'ZZ',               # Interchange ID Qualifier
            '561611847      ',  # Interchange Receiver ID
        ...
        writer.write_segment([
            ...
            '561611847',        # Application Receiver's Code
...
class Carrier(object):
    ...
    def write_segments(self, writer, xfile):
        ...
        writer.write_segment([
            ...
            '', '', '', '', '', # NM103-NM107 Blank
            '46',               # NM108: Identification Code Qualifier (FEIN)
            '561611847'         # NM109: Identification Code 
        ])
