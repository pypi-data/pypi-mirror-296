...
def get_tickets_all(api_baseurl, api_key):
    ...
    while True:
        ...
        log_request_to_db(REQUEST_LOG_URL, "get_tickets_all", url, "todo_status_code")
...
def get_tickets_recently_updated(api_baseurl, api_key, days):
    ...
    while True:
        ...
        log_request_to_db(REQUEST_LOG_URL, "get_tickets_recently_updated", url, "todo_status_code")
