...
def get_contacts_by_customer(api_baseurl, api_key, customer_id):
    ...
    while True:
        ...
        try:
            ...
            log_request_to_db(REQUEST_LOG_URL, "get_contacts_by_customer", url, "todo_status_code")
...
def get_contacts_all_customers(api_baseurl, api_key):
    ...
    while True:
        ...
        try:
            response = requests.get(url, headers=headers, params=params)
            log_request_to_db(REQUEST_LOG_URL, "get_contacts_all_customers", url, "todo_status_code")
