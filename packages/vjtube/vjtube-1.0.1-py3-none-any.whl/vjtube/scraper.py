...
class YouTubeScraper:
    def __init__(self, termo_pesquisa: str, limite_videos: int = 200, max_tentativas: int = 50):
        self.termo_pesquisa = termo_pesquisa
        self.limite_videos = limite_videos
        ...
        with sync_playwright() as playwright:
            ...
            for tipo_video in TIPOS_VIDEOS:
                for filtro_nome, filtro_valor in FILTROS.items():
                    ...
                    total_videos = self._carregar_todos_videos(page)
    ...
    def _carregar_todos_videos(self, page) -> int:
        """
        ...
        while total_videos < self.limite_videos and tentativas < self.max_tentativas:
