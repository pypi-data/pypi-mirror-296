...
class EmbeddingClientError(Exception):
    """
    Custom exception class for EmbeddingClient errors.

    This exception class represents errors within the EmbeddingClient, including detailed
    ...
    def __init__(self, header: ZmqMessageHeader, additional_info: str = ""):
        """
        Initializes a new instance of the EmbeddingClientError.
    ...
    def _format_message(self) -> str:
        ...
        message_parts = ["EmbeddingClient Error: {}".format(error_info)]
