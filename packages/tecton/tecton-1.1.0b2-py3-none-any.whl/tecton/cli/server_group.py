...
def _display_server_group_info(group: ServerGroupInfo):
    ...
    scaling_config = [
        ("Min Nodes", group.desired_config.min_nodes, group.current_config.min_nodes),
        ("Max Nodes", group.desired_config.max_nodes, group.current_config.max_nodes),
        ("Desired Nodes", group.desired_config.desired_nodes, group.current_config.desired_nodes),
        ("Autoscaling Enabled", group.desired_config.autoscaling_enabled, group.current_config.autoscaling_enabled),
        (
            "Last Updated At",
    ...
    _display_table(["Field", "Desired Configuration", "Current Configuration"], scaling_config)
