...
class DataSource(base_tecton_object.BaseTectonObject):
    ...
    def select_range(
        self,
        start_time: Union[datetime.datetime, FilterDateTime, TectonTimeConstant] = TectonTimeConstant.UNBOUNDED_PAST,
        end_time: Union[datetime.datetime, FilterDateTime, TectonTimeConstant] = TectonTimeConstant.UNBOUNDED_FUTURE,
    ) -> FilteredSource:
        """
