...
class WaveSurfer:
    def __init__(self):
        self.idx = 0
        dirname = f"{os.path.dirname(__file__)}/js"
        wavesurfer_script = open(f"{dirname}/wavesurfer.min.js", encoding="utf-8")
        hover_script = open(f"{dirname}/hover.min.js", encoding="utf-8")
        minimap_script = open(f"{dirname}/minimap.min.js", encoding="utf-8")
        regions_script = open(f"{dirname}/regions.min.js", encoding="utf-8")
        spectrogram_script = open(f"{dirname}/spectrogram.min.js", encoding="utf-8")
        timeline_script = open(f"{dirname}/timeline.min.js", encoding="utf-8")
        zoom_script = open(f"{dirname}/zoom.min.js", encoding="utf-8")
        plugins_script = open(f"{dirname}/plugins.js", encoding="utf-8")
